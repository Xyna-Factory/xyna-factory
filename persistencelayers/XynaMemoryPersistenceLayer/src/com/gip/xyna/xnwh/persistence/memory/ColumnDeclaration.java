...
public class ColumnDeclaration {
  ...
  public ColumnDeclaration(Column col, Class<?> backingClass, boolean isPk, Class<?> fieldType) {
    ...
    //Suche nach Getter: 1. kein �bergabeParameter; 2. passender Name; 3. passender ReturnType
  ...
  private boolean checkReturnType(Class<?> returnType, Class<?> fieldType) {
    ...
    //returnType ist von fieldType zuweisbar: Beispiel: Zur�ckgegeben wird ein Interface returnType, das von fieldType implementiert wird
  ...
  /**
   * @return javagetter f�r diese spalte auf dem basierenden java objekt
   */
