...
public abstract class AtomicBulkUpdateBase<E extends Comparable<E>, F> implements AtomicBulkUpdate<E, F> {
  ...
  protected abstract class AtomicBulkAction implements Comparable<AtomicBulkAction> {
    ...
    /*
     * adds gehen immer auf den darauffolgenden knoten => reihenfolge muss immer so sein, dass adds bei gleichen keys sp�ter kommen.
     * das gleiche gilt f�r update-adds.
     * => reihenfolge:
  ...
  //TODO F-Finder anstatt f direkt? ggfs kann man f nicht �ber die object-identity finden?
