...
public class LocalTableObject<T extends Storable> extends TableObject<T, LocalRowData<T>>
  ...
  public LocalTableObject(Class<T> storableClass) throws PersistenceLayerException {
    super(storableClass);
    //TODO auf concurrenthashmap umstellen und damit einiges an lockingnotwendigkeit in tableobject-klasse unn�tig machen -> ben�tigt aber noch anpassungen und zb verwendung von CAS operations auf der map...
