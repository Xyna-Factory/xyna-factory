 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
package xdev.xtestfactory.infrastructure.selector.impl;
...
import xdev.xtestfactory.infrastructure.selector.SelectorHandlingSuperProxy;
import xdev.xtestfactory.infrastructure.selector.SelectorHandling;


public class SelectorHandlingInstanceOperationImpl extends SelectorHandlingSuperProxy {

  private static final long serialVersionUID = 1L;

  public SelectorHandlingInstanceOperationImpl(SelectorHandling instanceVar) {
    super(instanceVar);
  }
