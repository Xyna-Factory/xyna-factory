 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
package xdev.xtestfactory.infrastructure.storables.impl;
...
import xdev.xtestfactory.infrastructure.gui.datatypes.InitialTestCaseEntry;
import xnwh.persistence.Storable;
import xdev.xtestfactory.infrastructure.storables.TestObjectSuperProxy;
import xdev.xtestfactory.infrastructure.storables.TestObjectInstanceOperation;
import xdev.xtestfactory.infrastructure.storables.TestObject;


public abstract class TestObjectInstanceOperationImpl extends TestObjectSuperProxy implements TestObjectInstanceOperation {

  private static final long serialVersionUID = 1L;

  public TestObjectInstanceOperationImpl(TestObject instanceVar) {
    super(instanceVar);
  }

  public List<? extends InitialTestCaseEntry> getFollowupTestCases() {
    //TODO implementation
    //TODO update dependency XML
    return new ArrayList<InitialTestCaseEntry>();
  }

  public List<? extends InitialTestCaseEntry> getInitialTestCases() {
