...
import xdev.xtestfactory.util.persistence.PersistenceUtilsSuperProxy;
import xdev.xtestfactory.util.persistence.PersistenceUtils;


public class PersistenceUtilsInstanceOperationImpl extends PersistenceUtilsSuperProxy {

  private static final long serialVersionUID = 1L;

  public PersistenceUtilsInstanceOperationImpl(PersistenceUtils instanceVar) {
    super(instanceVar);
  }
