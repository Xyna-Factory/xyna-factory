...
public class DHCPPoolsParser {
  ...
  /**
   * gibt true zur�ck, falls eine weitere zeile gelesen werden konnte
   */
  ...
  //aktuelle zeile ist die erste, die �berpr�ft wird
  private SharedNetwork parseSharedNetwork() throws IOException, DHCPPoolsFormatException, DHCPPoolsIgnoreLineException {
    ...
    //cursor ist auf der ersten zeile, die nicht mehr zum shared network geh�rt.
  }
  ...
  /**
   * liest solange zeilen aus bis das ende des streams oder eine nicht leere zeile gefunden wurde. gibt true zur�ck,
   * falls die zuletzt ausgelesene zeile eine nicht leere zeile war. gibt false zur�ck, falls ende des streams erreicht.
   */
