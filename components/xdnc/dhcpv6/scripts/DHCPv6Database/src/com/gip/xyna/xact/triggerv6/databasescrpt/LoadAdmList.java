...
public class LoadAdmList {
  ...
  public void setUp() {
    ...
    try {
      ods.registerStorable(DHCPv6EncodingAdm.class);
    }
    catch (Exception e) {
  ...
  public void createListOfDHCPEncodingEntry(List<DHCPv6EncodingAdm> liste) throws PersistenceLayerException {
    ...
    try {
      connection.deleteAll(DHCPv6EncodingAdm.class);
  ...
  public Collection<DHCPv6EncodingAdm> loadDHCPEntries() throws PersistenceLayerException {
    ODSConnection connection = ods.openConnection(ODSConnectionType.HISTORY);
    try {
      return connection.loadCollection(DHCPv6EncodingAdm.class);
    }
    finally {
      connection.closeConnection();
    }
