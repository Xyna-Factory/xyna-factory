...
public class SQLUtilsNdcLogger implements SQLUtilsLogger {
  ...
  public SQLUtilsNdcLogger(Logger ndcLogger) {
    this.logger = ndcLogger;
  }
  ...
  public void logSQL(String sql) {
    internalLog( Level.TRACE, sql, null );
  }
