...
/**
 * �ber dieses Interface k�nnen der DemonPersistency-Instanz alle m�gliche Objekte �bergeben werden,
...
public interface Persistable {
  ...
  /**
   * DemonPersistency intialisiert hier�ber den persistierten Wert.
   ...
   * R�ckgabe darf nicht null sein, ansonsten wird der Wert nicht aktualisiert
   * @return
   */
