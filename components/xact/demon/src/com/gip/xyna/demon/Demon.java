...
public class Demon {
  ...
  /**
   * Starts the Demon.
   * In einer Endlosschleife wird versucht, den Demon zu starten. Die Bem�hungen werden alle
  ...
  private boolean startDemonWorkerThread() {
    if( demonWorker != null ) {
      ...
      t.setDaemon( false ); //demonWorker darf kein Daemon-Thread sein, damit das Programm weiterl�uft
      t.start();
