...
/**
 * Vollst�ndige Implementierung eines Masters, der auf dem angegebenen Socket lauscht und
 * die erhaltenen Pakete �ber den {@link SlaveWorkBuilder.buildWork} in Arbeitspakete f�r den {@link SlavePool}
 * verwandelt und diese dann dem SlavePool �bergibt.
 *
 * @param <Tool>
 */
public class SocketMaster<Tool> implements Master<Tool,Socket>  {
  ...
  /**
   * Interface, um den SocketMaster zu bef�higen, Arbeitspakete SlaveWork<Tool,Socket> aus den Socket-Daten zu bauen.
   *
   * @param <Tool>
   */
