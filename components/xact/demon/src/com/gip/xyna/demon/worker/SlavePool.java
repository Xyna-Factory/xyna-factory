 ...
 * Pool 
 *
 * @param <Tool> Werkzeug, das jeder Slave zum Arbeiten ben�tigt (z.B. DB-Connection)
...
public class SlavePool<Tool,Work> {
  ...
  public void startThreadPoolExecutor() {
    threadPoolExecutor = new ThreadPoolExecutor( 
        ...
        1000L, TimeUnit.MILLISECONDS,        //�berz�hlige Threads werden nach 1 s wieder beendet
        new SynchronousQueue<Runnable>(),    //direkte �bergabe an Thread, kein Queueing
    ...
    public void run() {
      ...
      if( ct instanceof SlaveThread ) {
        ...
        try {
          ...
          //Sch�tzt dem Thread vor dem Abbruch durch ungefangene RuntimeExceptions
