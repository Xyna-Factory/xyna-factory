...
public class Failover {
  ...
  /* Soll ein Connect zur Prim�ren Instanz (R�ckgabewert==false) oder zur
   * Failover-Instanz (R�ckgabewert=true) durchgef�hrt werden.
   */
  ...
  /* Diese Funktion sollte an einer strategisch g�nstigen Stelle eingabut werden. Its der R�ckgabewert true,
   * sollte ein Reconnect  durchgef�hrt werden . IsFailover gibt dann zur�ck, zu welcher Instanz das Connect
