...
public class SipLayer implements SipListener {
  ...
  /**
   * �ffnet an localip:localPort ein socket. ausgehende verbindungen gehen �ber den angegebenen proxy (falls nicht null)
   */
  public SipLayer(String localip, int localPort, String proxy) throws PeerUnavailableException,
    ...
    sipStack = (SipStackExt) sipFactory.createSipStack(properties); //einmal pro local IP, gibt ggfs den bestehenden stack zur�ck
  ...
  private class AccountManagerImpl implements AccountManager {
    ...
    public UserCredentials getCredentials(ClientTransaction challengedTransaction, String realm) {
      ...
      //TODO nullpointerexception verhindern? accountmanager interface stellt leider keine exception zur verf�gung => runtimeexception werfen?
      return uc;
    }
  ...
  /**
   * wartet bis response zur�ckgekommen ist. f�hrt einen retry bei 401 fehler durch, bei dem authentifizierungsdetails
   * angeh�ngt werden ({@link #addCredentials})
   * @param r
   ...
   * @throws SipException falls response fehlerhaft ist, oder ein fehler w�hrend der responseverarbeitung aufgetreten
   *           ist
  ...
  public void sendRequestSynchronously(String hostName, Request r, long timeout) throws SipNotifySendException,
    ...
    addResponseListener(r, new SipResponseListener() {
      ...
      //durchf�hrung des retries mit authentifizierung
  ...
  private void terminateTransaction(ClientTransaction tx) {
    if (tx != null) {
      ...
      //beim notify nicht unbedingt n�tig, weil das automatisch passiert
    }
  }


  /**
   * passwort f�r authentifizierung registrieren. f�gt dem internen accountmanager das password hinzu. es ist gebundenen
