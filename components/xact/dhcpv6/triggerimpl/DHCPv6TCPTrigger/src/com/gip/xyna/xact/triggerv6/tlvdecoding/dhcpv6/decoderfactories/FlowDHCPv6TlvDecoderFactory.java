 ...
 */
public final class FlowDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "Flow";

    public FlowDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    public FlowDHCPv6TlvDecoderFactory(final String dataTypeName) {
        super(dataTypeName);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new FlowDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
