 ...
 */
public final class DUIDLLDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {

    private final Map<Long, DHCPv6TlvDecoder> subTlvDecoders;
    private final Set<Long> paddingTypeEncodings;

    public DUIDLLDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        try {
            ...
            tlv = reader.read(2,value.length-2);
            sb.append("\n");
