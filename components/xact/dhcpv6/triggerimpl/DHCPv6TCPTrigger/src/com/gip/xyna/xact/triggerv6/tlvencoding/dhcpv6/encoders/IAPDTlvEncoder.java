 ...
 */
public final class IAPDTlvEncoder extends AbstractTypeOnlyTlvEncoder {

    final int typeEncoding;
    final Map<String, TlvEncoder> subNodeEncodings;

    public IAPDTlvEncoder(final int typeEncoding, final Map<String, TlvEncoder> subNodeEncodings) {
        super(typeEncoding);
