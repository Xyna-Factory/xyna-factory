...
public final class LeaseQueryDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {
    ...
    public LeaseQueryDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        DHCPv6TlvReader tlvreader = new DHCPv6TlvReader(new ByteArrayInputStream(value,17,value.length-17), this.paddingTypeEncodings);
