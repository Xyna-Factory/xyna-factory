 ...
 */
public final class ContainerDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {

    private final Map<Long, DHCPv6TlvDecoder> subTlvDecoders;
    private final Set<Long> paddingTypeEncodings;

    public ContainerDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        DHCPv6TlvReader reader = new DHCPv6TlvReader(new ByteArrayInputStream(value), this.paddingTypeEncodings);
