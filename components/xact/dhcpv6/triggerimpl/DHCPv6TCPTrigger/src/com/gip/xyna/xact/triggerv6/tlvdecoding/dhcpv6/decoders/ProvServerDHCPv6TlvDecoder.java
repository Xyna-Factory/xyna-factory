...
public final class ProvServerDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {
    ...
    public ProvServerDHCPv6TlvDecoder(final long typeEncoding, final String typeName) {
    ...
    protected String decodeTlvValue(byte[] value) {
        ...
        if(value[0]!=0)
        {
          throw new IllegalArgumentException("Expected 0 at beginning of ProvServerValue but got: <" + value[0] + ">.");
        }
        if(value[value.length-1]!=0)
        {
          throw new IllegalArgumentException("Expected 0 at end of ProvServerValue but got: <" + value[value.length-1] + ">.");
        }
        ...
        try {
          ...
          while(!fertig) // solange End 00 nicht erreicht
          {
            ...
            if(length==-1) throw new IllegalArgumentException("Reached end of Stream earlier than expected!");
            ...
            if(!fertig)
            {
              ...
              for(int z=0;z<length;z++)
              {
                ...
                if(substring[z]<96) throw new IllegalArgumentException("Character may only be lowercase in ProvServer Option");
              }
              result = result + ".";
            }
