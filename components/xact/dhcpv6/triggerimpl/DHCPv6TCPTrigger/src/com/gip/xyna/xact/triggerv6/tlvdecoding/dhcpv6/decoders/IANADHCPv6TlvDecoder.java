 ...
 */
public final class IANADHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {
    ...
    public IANADHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        DHCPv6TlvReader tlvreader = new DHCPv6TlvReader(new ByteArrayInputStream(value,12,value.length-12), this.paddingTypeEncodings);
