 ...
 */
public final class FQDNDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "FQDN";

    public FQDNDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    public FQDNDHCPv6TlvDecoderFactory(final String dataTypeName) {
        super(dataTypeName);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new FQDNDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
