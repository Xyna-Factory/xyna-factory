 ...
 */
public final class IANADHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "IANA";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new IANADHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders, multipleEncodingsAllowed);
    }
}
