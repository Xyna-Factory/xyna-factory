 ...
 */
public final class IpV6AddressDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "IpV6Address";

    public IpV6AddressDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new IpV6AddressDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
