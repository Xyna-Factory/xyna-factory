 ...
 */
public final class EOctetStringDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "EOctetString";

    public EOctetStringDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    public EOctetStringDHCPv6TlvDecoderFactory(final String dataTypeName) {
        super(dataTypeName);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new EOctetStringDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
