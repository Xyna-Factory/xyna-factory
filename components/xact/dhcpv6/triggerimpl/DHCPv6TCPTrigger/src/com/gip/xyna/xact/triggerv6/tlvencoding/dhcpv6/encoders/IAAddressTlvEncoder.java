 ...
 */
public final class IAAddressTlvEncoder extends AbstractTypeOnlyTlvEncoder {

    final int typeEncoding;
    final Map<String, TlvEncoder> subNodeEncodings;

    public IAAddressTlvEncoder(final int typeEncoding, final Map<String, TlvEncoder> subNodeEncodings) {
        super(typeEncoding);
