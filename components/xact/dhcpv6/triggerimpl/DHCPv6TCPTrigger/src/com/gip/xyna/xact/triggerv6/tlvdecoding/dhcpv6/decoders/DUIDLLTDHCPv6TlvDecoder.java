 ...
 */
public final class DUIDLLTDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {

    private final Map<Long, DHCPv6TlvDecoder> subTlvDecoders;
    private final Set<Long> paddingTypeEncodings;

    public DUIDLLTDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        try {
            ...
            tlv = reader.read(3,value.length-6);
            sb.append("\n");
            decoder = subTlvDecoders.get(tlv.getTypeEncoding());
            if (decoder == null) 
            {
