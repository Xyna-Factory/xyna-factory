...
public class DHCPv6Encoding extends Storable<DHCPv6Encoding> {
...
public void setTypeEncoding(long typeEncoding) {
   this.typeEncoding = typeEncoding;
}


public void setEnterpriseNr(Integer enterpriseNr) {
   this.enterpriseNr = enterpriseNr;
}


public void setValueDataTypeName(String valueDataTypeName) {
   this.valueDataTypeName = valueDataTypeName;
}


public void setValueDataTypeArguments(Map<String, String> valueDataTypeArguments) {
   this.valueDataTypeArguments = valueDataTypeArguments;
}


public void setValueDataTypeArgumentsString(String valueDataTypeArgumentsString) {
   this.valueDataTypeArgumentsString = valueDataTypeArgumentsString;
}
...
@Column(name = COL_ID, size = 50)
  ...
  @Override
  public <U extends DHCPv6Encoding> void setAllFieldsFromData(U data) {
    id = data.getId();
    parentId = data.getParentId();
    typeName = data.getTypeName();
    typeEncoding = data.getTypeEncoding();
    enterpriseNr = data.getEnterpriseNr();
    valueDataTypeName = data.getValueDataTypeName();
    // valueDataTypeArguments = data.valueDataTypeArguments;
    valueDataTypeArgumentsString = data.getValueDataTypeArgumentsString();
  }
}
