 ...
 */
public final class DHCPv6DUIDReader implements TlvReader {

  private static Logger logger = Logger.getLogger(DHCPv6DUIDReader.class);
  ...
  public DHCPv6DUIDReader(final InputStream inputStream, final Set<Long> paddingTypeEncodings) {
    if (inputStream == null) {
...
//                                           "Padding type encodings contains an invalid type encoding: <" + typeEncoding + ">.");
  ...
  public Tlv read() throws TlvReaderException // muss wegen Oberklasse implmentiert werden
  {
    return null;
  }
  ...
  public int readTypeEncoding() throws TlvReaderException {
    try {
