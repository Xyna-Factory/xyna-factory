...
public final class IpV4AddressListDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory  {
    ...
    public static final String DATA_TYPE_NAME = "IpV4AddressList";

    public IpV4AddressListDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new IpV4AddressListDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
