 ...
 */
public final class IAPDOptionDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "IAPDOption";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new IAPDOptionDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders);
    }
}
