 ...
 */
public final class DUIDDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "DUID";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new DUIDDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders);
    }
}
