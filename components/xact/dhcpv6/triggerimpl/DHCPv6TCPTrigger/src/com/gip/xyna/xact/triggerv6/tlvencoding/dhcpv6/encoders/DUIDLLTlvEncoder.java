 ...
 */
public final class DUIDLLTlvEncoder extends AbstractTypeOnlyTlvEncoder {

    final int typeEncoding;
    final Map<String, TlvEncoder> subNodeEncodings;

    public DUIDLLTlvEncoder(final int typeEncoding, final Map<String, TlvEncoder> subNodeEncodings) {
        super(typeEncoding);
