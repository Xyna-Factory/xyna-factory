 ...
 */
public final class EContainerDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new EContainerDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders);
    }
}
