...
/**
 * MAC address DOCSIS TLV decoder factory.
 *
 * @author Fredrik Lindberg / GIP Exyr GmbH
 */
public final class MacAddressDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {
    
    public static final String DATA_TYPE_NAME = "MacAddress";

    public MacAddressDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new MacAddressDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
