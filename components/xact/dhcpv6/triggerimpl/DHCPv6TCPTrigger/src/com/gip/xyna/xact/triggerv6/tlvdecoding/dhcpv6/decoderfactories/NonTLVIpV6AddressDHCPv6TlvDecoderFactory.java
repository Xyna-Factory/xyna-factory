...
public final class NonTLVIpV6AddressDHCPv6TlvDecoderFactory extends AbstractDHCPv6TlvDecoderFactory {
    ...
    public static final String DATA_TYPE_NAME = "NonTLVIpV6Address";

    public NonTLVIpV6AddressDHCPv6TlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }

    @Override
    protected DHCPv6TlvDecoder createTlvDecoder(final long typeEncoding, final String typeName) {
        return new NonTLVIpV6AddressDHCPv6TlvDecoder(typeEncoding, typeName);
    }
}
