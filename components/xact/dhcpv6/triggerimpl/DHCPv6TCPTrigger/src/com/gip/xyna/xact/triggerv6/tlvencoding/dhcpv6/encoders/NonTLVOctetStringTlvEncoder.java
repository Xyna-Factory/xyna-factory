 ...
 */
public final class NonTLVOctetStringTlvEncoder extends AbstractTypeWithValueTlvEncoder{
  ...
  private static final Pattern VALUE_MATCHER_PATTERN = Pattern.compile("0x([0-9A-F]{2})+");
    ...
    public NonTLVOctetStringTlvEncoder(final int typeEncoding, final int minLength, final int maxLength) {
        super(typeEncoding);
        if (minLength < 1) {
