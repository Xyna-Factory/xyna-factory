 ...
 */
public final class NonTLVOctetStringTlvEncoderFactory extends AbstractTypeWithValueTlvEncoderFactory {
    ...
    protected TlvEncoder createTypeWithValueTlvEncoder(final int typeEncoding, final Map<String, String> arguments) {
        ...
        return new NonTLVOctetStringTlvEncoder(typeEncoding, minLength, maxLength);
    }
