...
public interface DHCPv6TlvDecoderFactory {
    ...
    DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
                            final List<DHCPv6TlvDecoder> subTlvDecoders, final Set<Integer> multipleEncodingsAllowed);
