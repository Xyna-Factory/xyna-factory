 ...
 */
public final class RelayMessageTlvEncoderFactory extends AbstractTypeOnlyTlvEncoderFactory {
    ...
    protected TlvEncoder createTypeOnlyTlvEncoder(final int typeEncoding, final Map<String, String> arguments,
        ...
        return new RelayMessageTlvEncoder(typeEncoding, subNodeEncodings);
    }
}
