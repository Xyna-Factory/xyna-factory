...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.decoders.RelayMessageDHCPv6TlvDecoder;
 ...
 */
public final class RelayMessageDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "RelayMessage";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new RelayMessageDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders, multipleEncodingsAllowed);
    }
}
