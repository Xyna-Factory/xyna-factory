...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.VendorTlvReader;



public final class EContainerDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {

  private final Map<Long, DHCPv6TlvDecoder> subTlvDecoders;
  private final Set<Long> paddingTypeEncodings;
  

  public EContainerDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    for (DHCPv6TlvDecoder decoder : subTlvDecoders) {
      ...
      if (decoders.put(decoder.getTypeEncoding(), decoder) != null) {
        throw new IllegalArgumentException(
                                           "Decoder for TLV <" + decoder.getTypeEncoding() + "> defined more than once.");
      }
    }
  ...
  protected String decodeTlvValue(final byte[] value) {
    VendorTlvReader tlvreader = new VendorTlvReader(new ByteArrayInputStream(value),this.paddingTypeEncodings);
