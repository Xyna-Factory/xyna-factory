 ...
 */
public final class IATADHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "IATA";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new IATADHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders, multipleEncodingsAllowed);
    }
}
