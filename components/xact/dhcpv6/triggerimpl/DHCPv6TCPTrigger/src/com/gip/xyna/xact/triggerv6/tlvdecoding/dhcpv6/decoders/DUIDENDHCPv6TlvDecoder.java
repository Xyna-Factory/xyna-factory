 ...
 */
public final class DUIDENDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {

    private final Map<Long, DHCPv6TlvDecoder> subTlvDecoders;
    private final Set<Long> paddingTypeEncodings;

    public DUIDENDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        try {
            ...
            tlv = reader.read(2,value.length-4);
            sb.append("\n");
