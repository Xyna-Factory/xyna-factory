 ...
 */
public final class IAAddressDHCPv6TlvDecoder extends AbstractDHCPv6TlvDecoder {
    ...
    public IAAddressDHCPv6TlvDecoder(final long typeEncoding, final String typeName,
    ...
    protected String decodeTlvValue(final byte[] value) {
        ...
        DHCPv6TlvReader tlvreader = new DHCPv6TlvReader(new ByteArrayInputStream(value,24,value.length-24), this.paddingTypeEncodings);
