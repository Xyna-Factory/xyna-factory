 ...
 */
public final class DUIDLLDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "DUIDLL";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new DUIDLLDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders);
    }
}
