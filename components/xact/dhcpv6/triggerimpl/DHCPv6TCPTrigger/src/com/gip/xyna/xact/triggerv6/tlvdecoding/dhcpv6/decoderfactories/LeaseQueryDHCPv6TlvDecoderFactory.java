...
public final class LeaseQueryDHCPv6TlvDecoderFactory implements DHCPv6TlvDecoderFactory {
    ...
    public static final String DATA_TYPE_NAME = "LeaseQuery";
    ...
    public DHCPv6TlvDecoder create(final long typeEncoding, final String typeName,
        ...
        return new LeaseQueryDHCPv6TlvDecoder(typeEncoding, typeName, subTlvDecoders, multipleEncodingsAllowed);
    }
}
