 ...
 */
public final class DUIDLLTTlvEncoder extends AbstractTypeOnlyTlvEncoder {

    final int typeEncoding;
    final Map<String, TlvEncoder> subNodeEncodings;

    public DUIDLLTTlvEncoder(final int typeEncoding, final Map<String, TlvEncoder> subNodeEncodings) {
        super(typeEncoding);
    ...
    protected void writeTypeOnlyNode(final TypeOnlyNode node, final OutputStream target) throws IOException {
        ...
        //target.write(subNodesData.size());  // Kein TLV bei DHCPv6
