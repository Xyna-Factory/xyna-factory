...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.decoders.NonTLVUnsignedIntegerDHCPv6TlvDecoder;
...
public final class NonTLVUnsignedIntegerDHCPTlvDecoderFactoryTest {
    ...
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new NonTLVUnsignedIntegerDHCPv6TlvDecoderFactory();
        assertEquals("NonTLVUnsignedInteger", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), NonTLVUnsignedIntegerDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof NonTLVUnsignedIntegerDHCPv6TlvDecoder);
