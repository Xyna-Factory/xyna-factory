...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.DUIDLLTTlvEncoder;
 ...
 */
public final class DUIDLLTTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        DUIDLLTTlvEncoder encoder = new DUIDLLTTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new DUIDLLTTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new DUIDLLTTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        DUIDLLTTlvEncoder encoder = new DUIDLLTTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new DUIDLLTTlvEncoder(234, null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new DUIDLLTTlvEncoder(255, subNodeEncodings);
    }
