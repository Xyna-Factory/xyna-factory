...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.IAPDTlvEncoder;
 ...
 */
public final class IAPDTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IAPDTlvEncoder encoder = new IAPDTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new IAPDTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new IAPDTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        IAPDTlvEncoder encoder = new IAPDTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new IAPDTlvEncoder(255, subNodeEncodings);
    }
