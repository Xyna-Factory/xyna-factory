...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.IAPDOptionTlvEncoder;
 ...
 */
public final class IAPDOptionTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IAPDOptionTlvEncoder encoder = new IAPDOptionTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new IAPDOptionTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new IAPDOptionTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        IAPDOptionTlvEncoder encoder = new IAPDOptionTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new IAPDOptionTlvEncoder(234, null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new IAPDOptionTlvEncoder(255, subNodeEncodings);
    }
