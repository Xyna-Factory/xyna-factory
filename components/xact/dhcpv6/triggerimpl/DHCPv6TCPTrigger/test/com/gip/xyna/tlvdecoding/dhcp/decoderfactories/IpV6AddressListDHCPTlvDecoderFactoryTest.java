...
public final class IpV6AddressListDHCPTlvDecoderFactoryTest {
    ...
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new IpV6AddressListDHCPv6TlvDecoderFactory();
        assertEquals("IpV6AddressList", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IpV6AddressListDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IpV6AddressListDHCPv6TlvDecoder);
