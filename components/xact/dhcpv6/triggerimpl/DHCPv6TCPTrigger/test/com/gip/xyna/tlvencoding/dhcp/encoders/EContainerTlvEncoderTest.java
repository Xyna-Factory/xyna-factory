 ...
 */
public final class EContainerTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        EContainerTlvEncoder encoder = new EContainerTlvEncoder(234,"118b", new HashMap<String, TlvEncoder>());
        ...
        encoder = new EContainerTlvEncoder(255, "118b",subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new EContainerTlvEncoder(0,"118b", subNodeEncodings);
        ...
        expectedResult.write(0);
        expectedResult.write(0);
        expectedResult.write(12); // length
        expectedResult.write(0); // 4491
        expectedResult.write(0);
        expectedResult.write(17);
        expectedResult.write(139);
        ...
        expectedResult.write(42); // 42
        expectedResult.write(2); //  2
        expectedResult.write(4); //  4
        expectedResult.write(2); //  2
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        EContainerTlvEncoder encoder = new EContainerTlvEncoder(0, "118b",subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new EContainerTlvEncoder(234,"", null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new EContainerTlvEncoder(255,"", subNodeEncodings);
    }
    ...
    public void testEncodeWithUnknownSubType() throws IOException {
        EContainerTlvEncoder encoder = new EContainerTlvEncoder(234,"", new HashMap<String, TlvEncoder>());
        List<Node> subNodes = new ArrayList<Node>();
    ...
    public void testEncodeWithTooMuchSubNodeData() throws IOException {
        ...
        subNodeEncodings.put("Bar", new MockTlvEncoderImpl());
        subNodeEncodings.put("Pad", new MockTlvEncoderImpl(true));
        EContainerTlvEncoder encoder = new EContainerTlvEncoder(0, "",subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
