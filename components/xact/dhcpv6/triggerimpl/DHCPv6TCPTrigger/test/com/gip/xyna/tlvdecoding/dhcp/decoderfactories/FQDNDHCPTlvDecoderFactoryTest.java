...
public final class FQDNDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new FQDNDHCPv6TlvDecoderFactory();
        assertEquals("FQDN", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), FQDNDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof FQDNDHCPv6TlvDecoder);
        ...
        decoderFactory = new FQDNDHCPv6TlvDecoderFactory("Baz");
