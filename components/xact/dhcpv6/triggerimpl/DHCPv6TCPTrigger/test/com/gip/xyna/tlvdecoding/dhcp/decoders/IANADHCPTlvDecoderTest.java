 ...
 */
public class IANADHCPTlvDecoderTest {
    ...
    public void testSuccessfulDecodeWithoutSubTlvDecoders() {
        ...
        AbstractDHCPv6TlvDecoder decoder = new IANADHCPv6TlvDecoder(0, "IANA", subTlvDecoders,new HashSet<Integer>());

        StringBuilder expectedResult = new StringBuilder();
        expectedResult.append("IANA\n");
    ...
    public void testFailsConstructorWithSubTlvDecodersNull() {
        new IANADHCPv6TlvDecoder(0, "IANA", null,new HashSet<Integer>());
    }
