...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.NonTLVOctetStringTlvEncoder;
...
public final class NonTLVOctetStringTlvEncoderFactoryTest {
    ...
    public void testNormalUse() throws IOException {
        TlvEncoderFactory factory = new NonTLVOctetStringTlvEncoderFactory();
        ...
        assertTrue(encoder instanceof NonTLVOctetStringTlvEncoder);
        assertEquals(1, ((NonTLVOctetStringTlvEncoder) encoder).getMinLength());
        assertEquals(254, ((NonTLVOctetStringTlvEncoder) encoder).getMaxLength());
        ...
        assertEquals(5, ((NonTLVOctetStringTlvEncoder) encoder).getMinLength());
        assertEquals(30, ((NonTLVOctetStringTlvEncoder) encoder).getMaxLength());
    ...
    public void testCreateWithMinLengthMissing() {
        ...
        NonTLVOctetStringTlvEncoder encoder = (NonTLVOctetStringTlvEncoder) factory.create(29, arguments,
