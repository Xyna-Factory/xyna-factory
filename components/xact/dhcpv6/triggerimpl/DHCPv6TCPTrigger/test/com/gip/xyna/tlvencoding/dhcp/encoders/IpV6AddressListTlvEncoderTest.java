 ...
 */
public final class IpV6AddressListTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IpV6AddressListTlvEncoder encoder = new IpV6AddressListTlvEncoder(234);
        assertTrue(encoder instanceof AbstractTypeWithValueTlvEncoder);
        TypeWithValueNode node = new TypeWithValueNode("Ip addresses", "1:2:3:4:5:6:7:1,1:2:3:4:5:6:7:2,1:2:3:4:5:6:7:3");
    ...
    public void testFailsWriteWithInvalidValue() throws IOException {
        IpV6AddressListTlvEncoder encoder = new IpV6AddressListTlvEncoder(42);
