 ...
 */
public final class IpV6AddressTlvEncoderFactoryTest {

    @Test
    public void testNormalUse() throws IOException {
        IpV6AddressTlvEncoderFactory factory = new IpV6AddressTlvEncoderFactory();
        ...
        assertTrue(encoder instanceof IpV6AddressTlvEncoder);
    ...
    public void testCreateWithArgumentsNotEmpty() {
        ...
        new IpV6AddressTlvEncoderFactory().create(123, arguments, new HashMap<String, TlvEncoder>());       
    }
}
