...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.decoders.IANADHCPv6TlvDecoder;




/**
 * Tests DHCP IANA TLV decoder factory.
 */
public final class IANADHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        DHCPv6TlvDecoderFactory decoderFactory = new IANADHCPv6TlvDecoderFactory();
        assertEquals("IANA", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IANADHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(0, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IANADHCPv6TlvDecoder);
        ...
        subTlvDecoders.add(new IANADHCPv6TlvDecoder(56, "Qux", new ArrayList<DHCPv6TlvDecoder>(),null));
    ...
    public void testFailsCreateWithTypeEncodingTooLow() {
        new IANADHCPv6TlvDecoderFactory().create(-1, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
    }

//    @Test (expected = IllegalArgumentException.class)
//    public void testFailsCreateWithTypeEncodingTooHigh() {
//        new IANADHCPv6TlvDecoderFactory().create(70000, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
//    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithTypeNameNull() {
        new IANADHCPv6TlvDecoderFactory().create(123, null, new ArrayList<DHCPv6TlvDecoder>(),null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithSubTlvDecodersNull() {
        new IANADHCPv6TlvDecoderFactory().create(123, "Foo", null,null);
    }
}
