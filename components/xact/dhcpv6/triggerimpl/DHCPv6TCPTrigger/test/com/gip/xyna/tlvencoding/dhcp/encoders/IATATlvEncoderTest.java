...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.IATATlvEncoder;
 ...
 */
public final class IATATlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IATATlvEncoder encoder = new IATATlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new IATATlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new IATATlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        IATATlvEncoder encoder = new IATATlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new IATATlvEncoder(255, subNodeEncodings);
    }
