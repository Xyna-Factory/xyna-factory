...
public final class DUIDLLTDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        DHCPv6TlvDecoderFactory decoderFactory = new DUIDLLTDHCPv6TlvDecoderFactory();
        assertEquals("DUIDLLT", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), DUIDLLTDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(0, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof DUIDLLTDHCPv6TlvDecoder);
        ...
        subTlvDecoders.add(new DUIDLLTDHCPv6TlvDecoder(56, "Qux", new ArrayList<DHCPv6TlvDecoder>()));
    ...
    public void testFailsCreateWithTypeEncodingTooLow() {
        new DUIDLLTDHCPv6TlvDecoderFactory().create(-1, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
    }

//    @Test (expected = IllegalArgumentException.class)
//    public void testFailsCreateWithTypeEncodingTooHigh() {
//        new DUIDLLTDHCPv6TlvDecoderFactory().create(70000, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
//    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithTypeNameNull() {
        new DUIDLLTDHCPv6TlvDecoderFactory().create(123, null, new ArrayList<DHCPv6TlvDecoder>(),null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithSubTlvDecodersNull() {
        new DUIDLLTDHCPv6TlvDecoderFactory().create(123, "Foo", null,null);
    }
}
