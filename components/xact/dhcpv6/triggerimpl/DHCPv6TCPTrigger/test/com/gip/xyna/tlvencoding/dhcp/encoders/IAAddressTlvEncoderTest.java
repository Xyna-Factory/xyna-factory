...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.IAAddressTlvEncoder;
 ...
 */
public final class IAAddressTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IAAddressTlvEncoder encoder = new IAAddressTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new IAAddressTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new IAAddressTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        IAAddressTlvEncoder encoder = new IAAddressTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new IAAddressTlvEncoder(234, null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new IAAddressTlvEncoder(255, subNodeEncodings);
    }
