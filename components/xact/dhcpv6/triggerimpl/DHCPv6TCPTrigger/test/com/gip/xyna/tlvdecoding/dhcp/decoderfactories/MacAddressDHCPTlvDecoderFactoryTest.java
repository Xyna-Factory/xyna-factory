...
/**
 * Tests MAC address DHCP TLV decoder factory.
 *
 * @author Fredrik Lindberg / GIP Exyr GmbH
 */
public final class MacAddressDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new MacAddressDHCPv6TlvDecoderFactory();
        assertEquals("MacAddress", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), MacAddressDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof MacAddressDHCPv6TlvDecoder);
