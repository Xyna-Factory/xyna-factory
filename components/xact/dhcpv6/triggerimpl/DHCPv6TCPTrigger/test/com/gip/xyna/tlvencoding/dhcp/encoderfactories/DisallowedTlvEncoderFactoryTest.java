...
/**
 * Tests disallowed TLV encoder factory.
 */
public final class DisallowedTlvEncoderFactoryTest {

    @Test
    public void testCreate() throws IOException {
        DisallowedTlvEncoderFactory factory = new DisallowedTlvEncoderFactory();
        assertTrue(factory instanceof DisallowedTlvEncoderFactory);
        TlvEncoder encoder = factory.create(67, new HashMap<String, String>(), new HashMap<String, TlvEncoder>());
        assertTrue(encoder instanceof DisallowedTlvEncoder);
        assertEquals(67, encoder.getTypeEncoding());
        encoder = factory.create(89, new HashMap<String, String>(), new HashMap<String, TlvEncoder>());
        assertEquals(89, encoder.getTypeEncoding());
    }
    ...
    public void testCrateWithSubNodeEncodings() {
        ...
        encoders.put("foo", new DisallowedTlvEncoder(123));
