 ...
 */
public final class FlowDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new FlowDHCPv6TlvDecoderFactory();
        assertEquals("Flow", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), FlowDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof FlowDHCPv6TlvDecoder);
        ...
        decoderFactory = new FlowDHCPv6TlvDecoderFactory("Baz");
