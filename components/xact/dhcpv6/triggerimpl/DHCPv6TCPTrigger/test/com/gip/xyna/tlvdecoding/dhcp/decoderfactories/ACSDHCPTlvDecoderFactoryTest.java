 ...
 */
public final class ACSDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new ACSDHCPv6TlvDecoderFactory();
        assertEquals("ACS", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), ACSDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof ACSDHCPv6TlvDecoder);
        ...
        decoderFactory = new ACSDHCPv6TlvDecoderFactory("Baz");
