...
public final class NonTLVOctetStringTlvEncoderTest {
    ...
    public void testEncodeOfHexadecimalValue() throws IOException {
        NonTLVOctetStringTlvEncoder encoder = new NonTLVOctetStringTlvEncoder(12, 8, 8);
        ...
        encoder = new NonTLVOctetStringTlvEncoder(56, 1, 254);
    ...
    public void testEncodeOfStringValue() throws IOException {
        NonTLVOctetStringTlvEncoder encoder = new NonTLVOctetStringTlvEncoder(12, 1, 10);
        assertEquals(1, encoder.getMinLength());
        ...
        ByteArrayOutputStream target = new ByteArrayOutputStream();
        encoder.write(node, target);
        assertEquals(TestHelper.createIntegerList(34,102, 111, 111,34), TestHelper.toUnsignedIntList(target));
        ...
        node = new TypeWithValueNode("StringValue", "\"ц€ед\"");
        target = new ByteArrayOutputStream();
        encoder.write(node, target);
    ...
    public void testConstructorWithMinLengthTooLow() {
        new NonTLVOctetStringTlvEncoder(12, 0, 8);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testConstructorWithMaxLengthTooLarge() {
        new NonTLVOctetStringTlvEncoder(12, 8, 70000);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testConstructorWithMinLengthLargerThanMaxLength() {
        new NonTLVOctetStringTlvEncoder(12, 9, 8);
    }
