...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.ContainerTlvEncoder;
 ...
 */
public final class ContainerTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        ContainerTlvEncoder encoder = new ContainerTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new ContainerTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new ContainerTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        ContainerTlvEncoder encoder = new ContainerTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new ContainerTlvEncoder(234, null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new ContainerTlvEncoder(255, subNodeEncodings);
    }
