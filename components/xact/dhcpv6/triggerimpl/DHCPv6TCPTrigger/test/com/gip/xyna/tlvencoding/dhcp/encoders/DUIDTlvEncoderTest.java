 ...
 */
public final class DUIDTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        DUIDTlvEncoder encoder = new DUIDTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new DUIDTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new DUIDTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        DUIDTlvEncoder encoder = new DUIDTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new DUIDTlvEncoder(255, subNodeEncodings);
    }
