 ...
 */
public final class OctetStringDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new OctetStringDHCPv6TlvDecoderFactory();
        assertEquals("OctetString", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), OctetStringDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof OctetStringDHCPv6TlvDecoder);
        ...
        decoderFactory = new OctetStringDHCPv6TlvDecoderFactory("Baz");
