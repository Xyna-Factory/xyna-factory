...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.LeaseQueryTlvEncoder;
 ...
 */
public final class LeaseQueryTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        LeaseQueryTlvEncoder encoder = new LeaseQueryTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new LeaseQueryTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new LeaseQueryTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        LeaseQueryTlvEncoder encoder = new LeaseQueryTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsNull() {
        new LeaseQueryTlvEncoder(234, null);
    }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new LeaseQueryTlvEncoder(255, subNodeEncodings);
    }
