...
public class DUIDLLDHCPTlvDecoderTest {
    ...
    public void testSuccessfulDecodeWithSubTlvDecoders() {
        ...
        AbstractDHCPv6TlvDecoder decoder = new DUIDLLDHCPv6TlvDecoder(0, "DUIDLL", subTlvDecoders);

        StringBuilder expectedResult = new StringBuilder();
        expectedResult.append("DUIDLL\n");
    ...
    public void testFailsConstructorWithSubTlvDecodersNull() {
        new DUIDLLDHCPv6TlvDecoder(0, "DUIDLL", null);
    }
