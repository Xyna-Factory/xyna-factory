...
public final class IAPDDHCPTlvDecoderFactoryTest {
    ...
    public void testSuccessfulNormalUse() {
        DHCPv6TlvDecoderFactory decoderFactory = new IAPDDHCPv6TlvDecoderFactory();
        assertEquals("IAPD", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IAPDDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(0, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IAPDDHCPv6TlvDecoder);
        ...
        subTlvDecoders.add(new IAPDDHCPv6TlvDecoder(56, "Qux", new ArrayList<DHCPv6TlvDecoder>(),null));
    ...
    public void testFailsCreateWithTypeEncodingTooLow() {
        new IAPDDHCPv6TlvDecoderFactory().create(-1, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
    }

//    @Test (expected = IllegalArgumentException.class)
//    public void testFailsCreateWithTypeEncodingTooHigh() {
//        new IAPDDHCPv6TlvDecoderFactory().create(70000, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
//    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithTypeNameNull() {
        new IAPDDHCPv6TlvDecoderFactory().create(123, null, new ArrayList<DHCPv6TlvDecoder>(),null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithSubTlvDecodersNull() {
        new IAPDDHCPv6TlvDecoderFactory().create(123, "Foo", null,null);
    }
}
