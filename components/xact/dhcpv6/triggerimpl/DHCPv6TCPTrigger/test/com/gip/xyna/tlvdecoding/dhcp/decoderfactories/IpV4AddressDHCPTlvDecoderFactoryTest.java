 ...
 */
public final class IpV4AddressDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new IpV4AddressDHCPv6TlvDecoderFactory();
        assertEquals("IpV4Address", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IpV4AddressDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IpV4AddressDHCPv6TlvDecoder);
