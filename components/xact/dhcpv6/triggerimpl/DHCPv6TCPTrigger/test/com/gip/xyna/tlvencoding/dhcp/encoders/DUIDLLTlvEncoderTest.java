...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.DUIDLLTlvEncoder;
...
public final class DUIDLLTlvEncoderTest {
    ...
    public void testNormalUse() throws IOException {
        DUIDLLTlvEncoder encoder = new DUIDLLTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new DUIDLLTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new DUIDLLTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        DUIDLLTlvEncoder encoder = new DUIDLLTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new DUIDLLTlvEncoder(255, subNodeEncodings);
    }
