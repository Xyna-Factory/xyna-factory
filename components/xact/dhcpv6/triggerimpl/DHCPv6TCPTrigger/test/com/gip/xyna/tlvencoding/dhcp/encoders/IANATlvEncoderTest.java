...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.IANATlvEncoder;
 ...
 */
public final class IANATlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        IANATlvEncoder encoder = new IANATlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new IANATlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new IANATlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        IANATlvEncoder encoder = new IANATlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new IANATlvEncoder(255, subNodeEncodings);
    }
