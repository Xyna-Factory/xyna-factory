 ...
 */
public final class ProvServerDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new ProvServerDHCPv6TlvDecoderFactory();
        assertEquals("ProvServer", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), ProvServerDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof ProvServerDHCPv6TlvDecoder);
        ...
        decoderFactory = new ProvServerDHCPv6TlvDecoderFactory("Baz");
