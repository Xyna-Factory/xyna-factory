 ...
 */
public final class IpV6AddressDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoderFactory decoderFactory = new IpV6AddressDHCPv6TlvDecoderFactory();
        assertEquals("IpV6Address", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IpV6AddressDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(123, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IpV6AddressDHCPv6TlvDecoder);
