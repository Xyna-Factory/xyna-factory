...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.decoders.IATADHCPv6TlvDecoder;
...
public final class IATADHCPTlvDecoderFactoryTest {
    ...
    public void testSuccessfulNormalUse() {
        DHCPv6TlvDecoderFactory decoderFactory = new IATADHCPv6TlvDecoderFactory();
        assertEquals("IATA", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), IATADHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(0, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof IATADHCPv6TlvDecoder);
        ...
        subTlvDecoders.add(new IATADHCPv6TlvDecoder(56, "Qux", new ArrayList<DHCPv6TlvDecoder>(),null));
    ...
    public void testFailsCreateWithTypeEncodingTooLow() {
        new IATADHCPv6TlvDecoderFactory().create(-1, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
    }

//    @Test (expected = IllegalArgumentException.class)
//    public void testFailsCreateWithTypeEncodingTooHigh() {
//        new IATADHCPv6TlvDecoderFactory().create(70000, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
//    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithTypeNameNull() {
        new IATADHCPv6TlvDecoderFactory().create(123, null, new ArrayList<DHCPv6TlvDecoder>(),null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithSubTlvDecodersNull() {
        new IATADHCPv6TlvDecoderFactory().create(123, "Foo", null,null);
    }
}
