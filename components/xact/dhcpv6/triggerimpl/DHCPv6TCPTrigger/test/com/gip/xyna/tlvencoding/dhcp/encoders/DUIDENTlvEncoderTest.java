...
import com.gip.xyna.xact.triggerv6.tlvencoding.dhcpv6.encoders.DUIDENTlvEncoder;
 ...
 */
public final class DUIDENTlvEncoderTest {

    @Test
    public void testNormalUse() throws IOException {
        DUIDENTlvEncoder encoder = new DUIDENTlvEncoder(234, new HashMap<String, TlvEncoder>());
        ...
        encoder = new DUIDENTlvEncoder(255, subNodeEncodings);
        ...
        subNodeEncodings.put("Bar", tlvEncoder);
        encoder = new DUIDENTlvEncoder(0, subNodeEncodings);
    ...
    public void testEncodeWithMaxContent() throws IOException {
        ...
        DUIDENTlvEncoder encoder = new DUIDENTlvEncoder(0, subNodeEncodings);
        List<Node> subNodes = new ArrayList<Node>();
        for (int i = 0; i < 63; ++i) {
            subNodes.add(subNode);
        }
    ...
    public void testCreateWithSubNodeEncodingsContainingNullDataTypeName() {
        ...
        new DUIDENTlvEncoder(255, subNodeEncodings);
    }
