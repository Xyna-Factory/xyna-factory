...
/**
 * Tests DHCP DUID TLV decoder factory.
 */
public final class DUIDDHCPTlvDecoderFactoryTest {

    @Test
    public void testSuccessfulNormalUse() {
        DHCPv6TlvDecoderFactory decoderFactory = new DUIDDHCPv6TlvDecoderFactory();
        assertEquals("DUID", decoderFactory.getDataTypeName());
        assertEquals(decoderFactory.getDataTypeName(), DUIDDHCPv6TlvDecoderFactory.DATA_TYPE_NAME);
        DHCPv6TlvDecoder decoder = decoderFactory.create(0, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
        assertTrue(decoder instanceof DUIDDHCPv6TlvDecoder);
        ...
        subTlvDecoders.add(new DUIDDHCPv6TlvDecoder(56, "Qux", new ArrayList<DHCPv6TlvDecoder>()));
    ...
    public void testFailsCreateWithTypeEncodingTooLow() {
        new DUIDDHCPv6TlvDecoderFactory().create(-1, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
    }

//    @Test (expected = IllegalArgumentException.class)
//    public void testFailsCreateWithTypeEncodingTooHigh() {
//        new DUIDDHCPv6TlvDecoderFactory().create(70000, "Foo", new ArrayList<DHCPv6TlvDecoder>(),null);
//    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithTypeNameNull() {
        new DUIDDHCPv6TlvDecoderFactory().create(123, null, new ArrayList<DHCPv6TlvDecoder>(),null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsCreateWithSubTlvDecodersNull() {
        new DUIDDHCPv6TlvDecoderFactory().create(123, "Foo", null,null);
    }
}
