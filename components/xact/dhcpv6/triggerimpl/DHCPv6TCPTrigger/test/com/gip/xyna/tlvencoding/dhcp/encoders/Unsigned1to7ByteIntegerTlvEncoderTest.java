...
public final class Unsigned1to7ByteIntegerTlvEncoderTest {
    ...
    public void test4ByteUnsignedInteger() throws IOException {
        Unsigned1to7ByteIntegerTlvEncoder encoder = new Unsigned1to7ByteIntegerTlvEncoder(16, 4, null, null, null);
        ...
        encoder = new Unsigned1to7ByteIntegerTlvEncoder(0, 4, 1L, 20L, 2L);
        ...
        encoder = new Unsigned1to7ByteIntegerTlvEncoder(255, 4, 0L, 0L, 1L);
        ...
        encoder = new Unsigned1to7ByteIntegerTlvEncoder(123, 4, 0xFFFFFFFFL, 0xFFFFFFFFL, 0xFFFFFFFFL);
    ...
    public void test1ByteUnsignedInteger() throws IOException {
        Unsigned1to7ByteIntegerTlvEncoder encoder = new Unsigned1to7ByteIntegerTlvEncoder(123, 1, null, null, null);
        assertEquals(123, encoder.getTypeEncoding());
    ...
    public void test7ByteUnsignedInteger() throws IOException {
        Unsigned1to7ByteIntegerTlvEncoder encoder = new Unsigned1to7ByteIntegerTlvEncoder(145, 7, null, null, null);
    ...
    public void testCreateWithNrBytesTooLow() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 0, null, null, null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithNrBytesTooHigh() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 8, null, null, null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMinValueTooHigh() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, (0xFFFFFFFFL + 1L), null, null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMinValueTooLow() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, -1L, null, null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMaxValueTooHigh() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, null, (0xFFFFFFFFL + 1L), null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMaxValueTooLow() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, null, -1L, null);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMultipleOfTooHigh() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, null, null, (0xFFFFFFFFL + 1L));
    }

    @Test (expected = IllegalArgumentException.class)
    public void testCreateWithMultipleOfTooLow() {
        new Unsigned1to7ByteIntegerTlvEncoder(16, 4, null, null, 0L);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testParseOfNonIntegerValue() throws IOException {
        Unsigned1to7ByteIntegerTlvEncoder encoder = new Unsigned1to7ByteIntegerTlvEncoder(0, 4, 1L, 20L, 2L);
