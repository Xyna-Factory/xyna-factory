...
public final class UnknownDHCPTlvDecoderTest {
    ...
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new UnknownDHCPv6TlvDecoder(234);
        assertEquals("Tlv:234:OctetString:0xABCDEF0123456789", decoder.decode(new Tlv(234,
                TestHelper.toByteList("0xABCDEF0123456789"))));
        assertEquals("Tlv:234:OctetString:testing", decoder.decode(new Tlv(234,
                TestHelper.toByteList("0x74657374696E67"))));
        assertEquals("Tlv:234:OctetString", decoder.decode(new Tlv(234, new ArrayList<Byte>())));
    }
}
