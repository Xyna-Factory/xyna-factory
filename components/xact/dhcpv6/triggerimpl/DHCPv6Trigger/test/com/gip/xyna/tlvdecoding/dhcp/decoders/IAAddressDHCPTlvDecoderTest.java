 ...
 */
public class IAAddressDHCPTlvDecoderTest {
    ...
    public void testSuccessfulDecodeWithoutSubTlvDecoders() {
        ...
        AbstractDHCPv6TlvDecoder decoder = new IAAddressDHCPv6TlvDecoder(0, "IAAddress", subTlvDecoders,new HashSet<Integer>());

        StringBuilder expectedResult = new StringBuilder();
        expectedResult.append("IAAddress\n");
        expectedResult.append("  Foo:16\n");
        ...
        assertEquals(expectedResult.toString(), decoder.decode(new Tlv(0, TestHelper.toByteList(
                "0x000000000000000000000000000000010000000200000003"))));
    }
    ...
    public void testSuccessfulDecodeWithSubTlvDecoders() {
        ...
        //expectedResult.append("  Ban:4\n");
        assertEquals(expectedResult.toString(), decoder.decode(new Tlv(0, TestHelper.toByteList(
                "0x000000000000000000000000000000010000000200000003007D00050001000103"))));
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsConstructorWithSubTlvDecodersNull() {
        new IAAddressDHCPv6TlvDecoder(0, "IAAddress", null,new HashSet<Integer>());
    }
