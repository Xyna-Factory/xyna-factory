 ...
 */
public final class IpV4AddressDHCPTlvDecoderTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new IpV4AddressDHCPv6TlvDecoder(234, "Foo");
    ...
    public void testDecodeFailsWithTooFewBytes() {
        new IpV4AddressDHCPv6TlvDecoder(234, "Foo").decode(new Tlv(234, TestHelper.toByteList("0x000000")));
    }

    @Test (expected = IllegalArgumentException.class)
    public void testDecodeFailsWithTooManyBytes() {
        new IpV4AddressDHCPv6TlvDecoder(234, "Foo").decode(new Tlv(234, TestHelper.toByteList("0x0000000000")));
    }
}
