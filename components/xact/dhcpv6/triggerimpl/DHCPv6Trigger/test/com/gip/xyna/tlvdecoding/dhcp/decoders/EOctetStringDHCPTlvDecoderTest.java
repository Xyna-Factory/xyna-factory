 ...
 */
public final class EOctetStringDHCPTlvDecoderTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new EOctetStringDHCPv6TlvDecoder(123, "Test");
        assertEquals("Test:0x0123456789ABCDEF", decoder.decode(new Tlv(123,
                TestHelper.toByteList("0x000000000123456789ABCDEF"))));
        assertEquals("Test:foobar", decoder.decode(new Tlv(123, TestHelper.toByteList("0x00000000666F6F626172"))));
