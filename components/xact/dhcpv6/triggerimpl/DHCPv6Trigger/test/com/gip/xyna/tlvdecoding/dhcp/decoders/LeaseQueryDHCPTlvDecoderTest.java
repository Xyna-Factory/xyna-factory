 ...
 */
public class LeaseQueryDHCPTlvDecoderTest {
    ...
    public void testSuccessfulDecodeWithoutSubTlvDecoders() {
        ...
        AbstractDHCPv6TlvDecoder decoder = new LeaseQueryDHCPv6TlvDecoder(0, "LeaseQuery", subTlvDecoders,new HashSet<Integer>());

        StringBuilder expectedResult = new StringBuilder();
        expectedResult.append("LeaseQuery\n");
        expectedResult.append("  Foo:1\n");
        expectedResult.append("  Bar:16");
    ...
    public void testSuccessfulDecodeWithSubTlvDecoders() {
        ...
        //expectedResult.append("  Ban:4\n");
        assertEquals(expectedResult.toString(), decoder.decode(new Tlv(0, TestHelper.toByteList(
                "0x0000000000000000000000000000000000007D00050001000103"))));
    }

    @Test (expected = IllegalArgumentException.class)
    public void testFailsConstructorWithSubTlvDecodersNull() {
        new LeaseQueryDHCPv6TlvDecoder(0, "LeaseQuery", null,new HashSet<Integer>());
    }
