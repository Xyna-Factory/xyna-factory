...
import com.gip.xyna.xact.triggerv6.tlvdecoding.dhcpv6.decoders.IpV6AddressListDHCPv6TlvDecoder;
 ...
 */
public final class IpV6AddressListDHCPTlvDecoderTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new IpV6AddressListDHCPv6TlvDecoder(234, "Foo");
        ...
        assertEquals("Foo:ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff,0:0:0:0:0:0:0:0,a:a:a:a:a:a:a:a", decoder.decode(new Tlv(234,
                TestHelper.toByteList("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000000000000000000000000000000A000A000A000A000A000A000A000A"))));
        assertEquals("Foo", decoder.decode(new Tlv(234, new ArrayList<Byte>())));        
    }

    @Test (expected = IllegalArgumentException.class)
    public void testDecodeFailsWithMoreThanZeroAndLessThanFourBytes() {
        new IpV6AddressListDHCPv6TlvDecoder(234, "Foo").decode(new Tlv(234, TestHelper.toByteList("0x000000")));
    }

    @Test (expected = IllegalArgumentException.class)
    public void testDecodeFailsWithIncorrectNumberOfBytesOverFour() {
        new IpV6AddressListDHCPv6TlvDecoder(234, "Foo").decode(new Tlv(234,
