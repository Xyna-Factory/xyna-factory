 ...
 */
public final class ACSDHCPTlvDecoderTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new ACSDHCPv6TlvDecoder(123, "Test");
        assertEquals("Test:http://acs.me.com", decoder.decode(new Tlv(123,
                TestHelper.toByteList("0x687474703A2F2F6163732E6D652E636F6D"))));
    }
}
