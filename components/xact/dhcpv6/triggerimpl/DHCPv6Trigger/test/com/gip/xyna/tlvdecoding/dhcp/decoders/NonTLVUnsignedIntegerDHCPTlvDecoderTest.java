 ...
 */
public final class NonTLVUnsignedIntegerDHCPTlvDecoderTest {

    @Test
    public void testSuccessfulNormalUse() {
        AbstractDHCPv6TlvDecoder decoder = new NonTLVUnsignedIntegerDHCPv6TlvDecoder(234, "Foo");
    ...
    public void testFailsDecodeFailsWithValueWithTooManyBytes() {
        new NonTLVUnsignedIntegerDHCPv6TlvDecoder(234, "Foo").decode(new Tlv(234,
