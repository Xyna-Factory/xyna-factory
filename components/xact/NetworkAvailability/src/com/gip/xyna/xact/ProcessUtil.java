...
//FIXME duplicate code, ist auch im scriptexecutorservice so �hnlich
public class ProcessUtil {
  ...
  private boolean waitForProcessToDie(Process process, int maxCnt) {
    ...
    while (processRunning && cnt++ < maxCnt) {
      ...
      try {
        Thread.sleep(200 / maxCnt * cnt); //durchschnittlich 100ms warten, am anfang weniger, sp�ter mehr
