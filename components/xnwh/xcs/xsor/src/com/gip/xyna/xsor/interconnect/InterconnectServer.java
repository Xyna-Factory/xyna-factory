...
public class InterconnectServer extends InterconnectableStore implements Runnable, Replyable {
  ...
  /**
   * bestimmt die l�nge aus dem 8 byte langen buffer, mit gleichzeitigem check, ob die l�nge korrekt kodiert wurde.
   * damit man sicher sein kann, dass man nicht als l�nge das ende einer alten nachricht ausliest.
   * 
   * L(i) gleich das i-te byte des ints, der die l�nge bestimmt.
   * 
   * 0. 42
   * 1. L(0)
   * 2. L(1)
  ...
  public void offer(byte[] reply, int corrId) {
    ...
    //den index, der die aktuelle corrId enth�lt.
