...
public interface XynaScalableObjectRepositoryInterface {
  ...
  /**
   * Sucht nach den Suchkriterien unter Ber�cksichtigung.
   * 
   * @param searchRequest beschreibt die unparametrisierte Suche in DisjunktiverNormaleForm.
   * @param searchParameter enth�lt die Parameter der Suchanfrage.
   * @param maxResults maximale Menge an gefundenen Objekten, die zur�ckgegeben werden. Es werden nur dann weniger als maxResults
   *                   Objekte zur�ckgegeben, wenn nicht mehr Objekte gefunden wurden.
   * @param lockResults falls true, werden alle zur�ckgegebenen Objekte gelockt
  ...
  /**
   * initialisierung f�r diesen objekt-typ und laden der vorhandenen daten aus dem backingstore
   */
