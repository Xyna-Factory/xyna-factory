 ...
 * �ber die beiden im konstruktor anzugebenden objectIds.<br>
 ...
 */
/*
 * TODO: andere implementierung, die f�r readlocks keinen netzwerkzugriff ben�tigt
 *  - zb, indem man beim holen des writelocks die anzahl der readlocks �bers netzwerk holt und sie ansosnten nur lokal h�lt.
 */
public class ClusteredReadWriteLock implements ReadWriteLock {
  ...
  private boolean waitForSharedLocksToVanish(boolean tryLock, long nanos) throws InterruptedException {
    //TODO eigene sharedlocks abziehen, f�r den fall, dass lock upgrade funktionieren soll.
    if (tryLock) {
      ...
      try {
        ...
        while (true) {
          ...
          if (n.get() == 0) {
            ...
            //hier w�rde man sich gerne benachrichtigen lassen, wenn das objekt geupdated wird.
            ...
            //inkrementell immer l�nger werdend warten, ob das lock inzwischen freigeworden ist.
