  ...
  private static class LockSessionRunnable implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        exception = e;
        //TODO in diesem fall wirklich noch auf unlockbarrier warten? unittests f�r die exceptionf�lle schreiben. dabei kann man cachecontroller ja entsprechend implementieren.
      }
