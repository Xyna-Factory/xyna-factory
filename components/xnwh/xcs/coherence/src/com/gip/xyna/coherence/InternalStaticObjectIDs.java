...
interface InternalStaticObjectIDs {
  ...
  /**
   * shared objekt, dass die liste aller knoten im cluster h�lt.
   */
  ...
  /**
   * shared object mit payload {@link GlobalLockPayload}, �ber dessen update-trigger an andere knoten die information
  ...
  /**
   * shared object, welches gelockt wird, wenn ein objekt mit einer von au�en vorgegebenen ID erstellt werden soll.
   */
