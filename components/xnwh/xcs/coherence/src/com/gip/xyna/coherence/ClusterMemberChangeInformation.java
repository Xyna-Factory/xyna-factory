...
public class ClusterMemberChangeInformation {
  ...
  //FIXME prio3: im auge behalten, dass das ausschliesslich w�chst! irgendwann mal leeren und alle directorydaten updaten.
  ...
  public void update(ClusterMember[] members) {
    ...
    //clusterIds enth�lt nur noch entfernte ids;
