...
public class WaitForActiveThreadsRequest extends SynchronousRequest {

  private ThreadType type;
  
  public WaitForActiveThreadsRequest(InterconnectProtocol nodeConnection, CountDownLatch latch, ThreadType type) {
  ...
  public void exec() {
    nodeConnection.waitForActiveThreads(type);
  }
