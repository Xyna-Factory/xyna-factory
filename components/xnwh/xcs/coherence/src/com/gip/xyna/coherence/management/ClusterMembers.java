...
public class ClusterMembers extends CoherencePayload {
  ...
  /**
   * sollte immer einer zweierpotenz sein (aus performancegr�nden - naja nicht wirklich tragisch, aber kostet nix, dass
   * so zu machen). die zahl dynamisch anzupassen ist gef�hrlich, weil man kollisionen von priorit�ten bekommen k�nnte.
   * (alter request wartet mit einer priorit�t die nach der �nderung von {@link #STATIC_MOD_NUMBER} auch von einem
   * anderen knoten als priorit�t angegeben werden k�nnte).
   */
