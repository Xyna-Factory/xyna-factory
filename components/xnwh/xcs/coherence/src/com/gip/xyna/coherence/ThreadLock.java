...
/**
 * z�hlt anzahl threads die {@link #checkLock()} aufgerufen haben aber noch nicht {@link #decrementThreadCount()). 
...
public class ThreadLock implements ThreadLockInterface {
  ...
  private CacheControllerImpl controller; //TODO interface nehmen, wenn push ver�ffentlicht wird
  ...
  public void checkLock() {
    ...
    if (locked) {
      ...
      while (lockCnt != oldCnt) {
        ...
        //wenn der thread hier h�ngt, wird er nicht mitgez�hlt. das ist nur dann schlimm, falls das global lock ein zweites mal vergeben wurde
  ...
  public void lockAll() {
    //auf alle knoten "locked" versenden. realisierung �ber push von boolean innerhalb von payload von objectId
