...
public class InterconnectRMIClassLoader extends URLClassLoader {
   ...
   * beispielsweise von persistencelayerclassloadern, die eine abh�ngigkeit auf storables erkennen, die in einem service
   * (mdmclassloader) definiert sind. diese abh�ngigkeit kann irgendwann aufh�ren, weil z.b. der service undeployed
