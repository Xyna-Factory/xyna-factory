 ...
 * <p>
 * diente haupts�chlich zum vergleich der performance.
 * <p>
 * ergebnis: dieser threadpool ist ca 10-20% schneller, hat aber auch weniger features. <br>
 * TODO prio4: threads auch beenden, wenn sie noch in der ausf�hrung befindlich sind? z.b. ein flag im pool setzen, was
 * dann zur�ckkehrende objekte auch shutdowned.
 */
public class ThreadPool {
  ...
  public ThreadPool(int size) {
    pool = new ObjectPool<ExecutorThread>(new ObjectFactory<ExecutorThread>() {
      ...
      public ExecutorThread create() {
        ...
        //nach ausf�hrung des runnables den thread wieder zum pool zur�ckgeben.
  ...
  /**
   * beendet alle threads, die sich im pool befinden, und die sich nicht gerade in der ausf�hrung befinden.
   */
