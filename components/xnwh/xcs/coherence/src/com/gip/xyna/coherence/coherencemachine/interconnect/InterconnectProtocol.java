...
/**
 * Schnittstelle zu anderen Knoten der Koh�renz. Es gibt in einem Koh�renz Knoten normalerweise zwei Implementierungen.
...
public interface InterconnectProtocol {
   ...
   * remote locks.
   */
  public static final int RESPONSE_REENTRANT_LOCAL_LOCK = -2; //weil nur f�r lokale requests gedacht, steht es hier nur der vollst�ndigkeit halber, damit nicht einer auf die idee kommt, dass -2 nicht vergeben ist
   ...
   * gibt SUCCESSFUL_LOCK_NO_COMPARISON_REQ zur�ck, falls Lock erfolgreich erlangt wurde, ohne dass mit der angefragten
   * verglichen werden musste bzw. ohne dass der Knoten lockend/gelockt ist. Ansonsten wird die Priorit�t des
   * vorhandenen Locks auf der anderen Seite zur�ckgegeben. Gibt SUCCESSFUL_LOCK_BY_COMPARISON zur�ck, falls es andere
  ...
  /**
   * f�hrt die angegebenen Actions remote aus.
   */
  ...
  /**
   * nimmt den vorher geschickten lockrequest wieder zur�ck. �hnlich wie {@link #releaseLock(long)}, aber kann auch
   * ausgef�hrt werden, wenn das lock nicht erfolgreich geholt wurde.
   */
  ...
  /**
   * wartet, bis das remote lock erlangt und freigegeben wurde, welches die �bergebene Priorit�t hatte.
   */
