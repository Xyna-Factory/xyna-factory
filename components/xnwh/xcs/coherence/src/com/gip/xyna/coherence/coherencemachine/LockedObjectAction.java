...
public class LockedObjectAction extends CoherenceAction {

  private static final long serialVersionUID = -5637261540819109669L;


  public LockedObjectAction(long objectId, int requestingClusterID) {
  ...
  public final CoherenceActionType getActionType() {
    return CoherenceActionType.LOCKED;
  }
