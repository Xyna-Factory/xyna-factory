...
public class XynaPropertyHandler extends AbstractOidSingleHandler {
  ...
  public final static OID base = new OID("1.3.6.1.4.1.28747.1.11.4.1"); //TODO aus konstanten zusammenbauen - konstanten f�r departments etc anlegen.
  ...
  /**
   * bei unterschiedlichlangen strings ist der k�rzere string "vor" dem l�ngeren string.
