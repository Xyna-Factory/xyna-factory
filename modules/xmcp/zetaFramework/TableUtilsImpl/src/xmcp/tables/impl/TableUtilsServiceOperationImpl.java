...
// import xmcp.tables.datatypes.transformation.TableCell;
...
import xmcp.tables.TableUtilsServiceOperation;


public class TableUtilsServiceOperationImpl implements ExtendedDeploymentTask, TableUtilsServiceOperation {
  ...
  public FilterCondition buildFilterCondition(List<? extends TableColumn> tableColumn4) {
    // TODO use and refactor code from xmcp.tables.TableServiceGroup
    return new FilterCondition.Builder().instance();
  }

  public Container buildQueryParameters(TableInfo tableInfo9) {
    // TODO use and refactor code from xmcp.tables.TableServiceGroup
    return new Container(new SelectionMask(), new FilterCondition(), new QueryParameter());
  }

  public List<GeneralXynaObject> transformRows(List<? extends TableColumn> tableColumn12, /*rows*/List<GeneralXynaObject> anyType10) {
