...
//........................................................................................................................
    ...
    //     return finalType(typeName, isList);
    // }


    // /**
    //  * Resolves the fqn and surrounds it with "List< [resolved]>" if isList
    //  * is true.
    //  *
    //  * @param fqn
    //  * @param isList
    //  * @return
    //  */
    // public String finalType(String fqn, boolean isList) {
    //     return conditionalListWrap(resolveType(fqn), isList);
    // }


    // /**
    //  * Will wrap the SimpleName of vars type with "List<" and ">" if it's a list
    //  * @param var
    //  * @return
    //  */
    // public String conditionalListWrap(AVariable var) {
    //     String typeName = var.isJavaBaseType()
    //         ? var.getJavaTypeEnum().getJavaTypeName()
    //         : var.getDomOrExceptionObject().getOriginalSimpleName();

    //     return conditionalListWrap(typeName, var.isList());
    // }


    // /**
    //  * Will wrap typeName with "List<" and ">" if isList is true.
    //  * Else will return typeName
    //  * @param typeName
    //  * @param isList
    //  * @return
    //  */
    // public String conditionalListWrap(String typeName, boolean isList) {
    //     if (isList) {
