...
public class FactoryItemDifference<T> {
  ...
  public FactoryItemDifference() {

  }


  public FactoryItemDifference(Class<? extends WorkspaceContentDifferenceType> type, T from, T to) {
    this.type = type;
    this.from = from;
    this.to = to;
  }
