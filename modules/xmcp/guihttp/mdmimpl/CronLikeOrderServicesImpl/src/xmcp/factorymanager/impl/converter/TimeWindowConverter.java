...
public class TimeWindowConverter {
  ...
  public static String convertTimeWindow(TimeWindow timeWindow, String timezoneId, boolean considerDst) {
    if(timeWindow == null)
      return null;
    if(timeWindow instanceof RestrictionBasedTimeWindow) {
      return createRestrictionBasedTimeWindow((RestrictionBasedTimeWindow) timeWindow, timezoneId, considerDst).getRuleAndDuration();
    } else {
