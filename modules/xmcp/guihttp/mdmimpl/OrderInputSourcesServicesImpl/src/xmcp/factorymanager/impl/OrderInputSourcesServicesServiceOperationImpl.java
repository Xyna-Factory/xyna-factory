...
public class OrderInputSourcesServicesServiceOperationImpl implements ExtendedDeploymentTask, OrderInputSourcesServicesServiceOperation {
  ...
  /**
   * �berpr�ft, ob die Output Parameter des erzeugenden Workflow zu den Inputparameter des aufzurufenden Workflow passen.
  ...
  /**
   * �berpr�ft, ob das aufzurufende OperationInterface zu dem aufrufenden OperationInterface passt.
   * @param caller
   * @param interfaceToCall
   * @return
   */
  private boolean mayCall(OperationInterface caller, OperationInterface interfaceToCall) {
    //nun kann der caller noch den zus�tzlichen xprc.xpce.OrderCreationParameter parameter haben, den man beim vergleich ignorieren muss
