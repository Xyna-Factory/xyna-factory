 ...
 *
 */
public class DatatypesPathNameObjectsIdInsertAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameObjectsIdInsertAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Insert, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Objects-Id-Insert";
  }
