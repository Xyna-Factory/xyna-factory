 ...
 *
 */
public class WorkflowsPathNameObjectsIdConstant extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdConstant(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.ConstantChange, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-Constant";
  }
