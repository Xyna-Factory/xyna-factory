 ...
 *
 */
public class ExceptionsPathNameUndoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameUndoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Undo, Type.exceptionType, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Exception-TypePath-TypeName-Undo";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/h5.data/Simple/undo", "h5.data.Simple");
  }
