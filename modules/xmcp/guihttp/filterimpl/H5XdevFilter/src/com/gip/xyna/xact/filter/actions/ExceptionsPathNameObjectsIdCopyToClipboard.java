 ...
 *
 */
public class ExceptionsPathNameObjectsIdCopyToClipboard extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameObjectsIdCopyToClipboard(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.CopyToClipboard, Type.exceptionType, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.COPY_TO_CLIPBOARD)
        && method == Method.POST;
  }

  @Override
  public String getTitle() {
    return "XMOM-Exceptiontypes-TypePath-TypeName-Objects-Id-CopyToClipboard";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/h5/TestSerial/objects/copyToClipboard", "h5.TestSerial"); //FIXME
  }
