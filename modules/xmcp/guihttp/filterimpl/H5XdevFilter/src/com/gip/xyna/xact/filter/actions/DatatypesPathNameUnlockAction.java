 ...
 *
 */
public class DatatypesPathNameUnlockAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameUnlockAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Unlock, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Unlock";
  }
