 ...
 *
 */
public class WorkflowsPathNameObjectsIdDelete extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdDelete(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Delete, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-Change";
  }
