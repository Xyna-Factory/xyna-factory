 ...
 *
 */
public class ObjectsPathNameUndoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.OBJECTS;
  
  public ObjectsPathNameUndoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Undo, null, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Objects-TypePath-TypeName-Redo";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/lw/TestJsonWFCall", "lw.testJsonWFCall"); //FIXME
  }
