...
public class StepFunctionJson extends XMOMGuiJson implements HasXoRepresentation {
   ...
   * Diese wird von der GUI ben�tigt, um in den Formeln mit dem Datentyp arbeiten zu k�nnen.
   * @return
   */
  ...
  private FormulaArea createQueryFilterCriteria(SelectionMask selectionMask) {
    ...
    try {
      ...
      // kann eigentlich nicht vorkommen, da die Pr�fung isQueryWithHelperMapping() dann vorher schon nicht erfolgreich gewesen war
      Utils.logError(e);
      return null;
    }
