 ...
 *
 */
public class WorkflowsPathNameObjectsIdCopyToClipboard extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdCopyToClipboard(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.CopyToClipboard, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-CopyToClipboard";
  }
