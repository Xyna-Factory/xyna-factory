...
public class ImportedAuditsAction extends H5xFilterAction {

  private static final String BASE_PATH = "/" + PathElements.IMPORTED_AUDITS;
  ...
  public String getTitle() {
    return "Imported-Audits-FileIdId";
  }
  ...
  public FilterActionInstance act(URLPath url, HTTPTriggerConnection tc) throws XynaException {
    ...
    GetAuditResponse gar = getAuditRequestProcessor.processGetAuditRequestFromUpload(MonitorSession.getSessionInstance(tc), url.getPathElement(1));
