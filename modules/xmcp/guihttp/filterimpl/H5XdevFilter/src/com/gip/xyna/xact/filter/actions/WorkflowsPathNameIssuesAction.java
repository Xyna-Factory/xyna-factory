...
public class WorkflowsPathNameIssuesAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;


  public WorkflowsPathNameIssuesAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Issues, Type.workflow, true);
  }


  @Override
  protected boolean matchRuntimeContextIndependent(URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) && url.getPathLength() == 5 && url.getPathElement(4).equals(PathElements.ISSUES)
        && methodIn(method, Method.GET);
  }


  @Override
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Issues";
  }
  ...
  public void appendIndexPage(HTMLPart body) {
    ...
    paragraphDef.link(BASE_PATH + "/h5/TestSerial" + "/issues", "h5.TestSerial");
  }
