 ...
 *
 */
public class ExceptionsPathNameObjectsIdDeleteAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameObjectsIdDeleteAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Delete, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exceptiontypes-TypePath-TypeName-Objects-Id-Delete";
  }
