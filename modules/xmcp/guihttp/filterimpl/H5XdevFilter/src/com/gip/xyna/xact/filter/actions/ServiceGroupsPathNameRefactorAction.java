...
public class ServiceGroupsPathNameRefactorAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameRefactorAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Refactor, Type.serviceGroup, true);
  }
