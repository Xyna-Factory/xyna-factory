 ...
 *
 */
public class ClipboardAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.CLIPBOARD;
  
  public ClipboardAction(XMOMGui xmomGui) {
    super(xmomGui, Operation.ShowClipboard, null, false);
  }
  ...
  public void appendIndexPage(HTMLPart body) {
    ...
    paragraphDef.link(BASE_PATH, "Clipboard"); //FIXME
  }
