 ...
 *
 */
public class WorkflowsPathNameObjectsIdDecouple extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdDecouple(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Decouple, Type.workflow, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.DECOUPLE)
        && method == Method.PUT;
  }

  @Override
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-Decouple";
  }
