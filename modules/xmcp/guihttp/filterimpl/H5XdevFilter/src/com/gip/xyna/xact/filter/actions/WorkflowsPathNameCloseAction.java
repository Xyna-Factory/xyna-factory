 ...
 *
 */
public class WorkflowsPathNameCloseAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameCloseAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Close, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Close";
  }
