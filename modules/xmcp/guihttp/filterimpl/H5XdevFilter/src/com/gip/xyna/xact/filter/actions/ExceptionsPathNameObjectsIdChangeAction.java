 ...
 *
 */
public class ExceptionsPathNameObjectsIdChangeAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameObjectsIdChangeAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Change, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exceptiontypes-TypePath-TypeName-Objects-Id-Change";
  }
