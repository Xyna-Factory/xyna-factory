...
public class ServiceGroupsPathNameDeployAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameDeployAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Deploy, Type.serviceGroup, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Deploy";
  }
