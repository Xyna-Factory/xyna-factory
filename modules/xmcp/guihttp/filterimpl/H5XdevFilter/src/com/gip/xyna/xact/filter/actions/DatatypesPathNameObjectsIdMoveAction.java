 ...
 *
 */
public class DatatypesPathNameObjectsIdMoveAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameObjectsIdMoveAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Move, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Objects-Id-Move";
  }
