 ...
 *
 */
public class ExceptionsPathNameCloseAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameCloseAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Close, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exception-TypePath-TypeName-Close";
  }
