 ...
 *
 */
public class DatatypesPathNameCloseAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameCloseAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Close, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Close";
  }
