 ...
 *
 */
public class DatatypesPathNameRedoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameRedoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Redo, Type.dataType, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Redo";
  }
