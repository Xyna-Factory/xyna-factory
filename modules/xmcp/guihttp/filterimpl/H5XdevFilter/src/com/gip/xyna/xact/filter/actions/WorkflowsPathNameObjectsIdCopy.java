 ...
 *
 */
public class WorkflowsPathNameObjectsIdCopy extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdCopy(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Copy, Type.workflow, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.COPY)
        && method == Method.POST;
  }

  @Override
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-Copy";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/h5/TestSerial/objects/copy", "h5.TestSerial"); //FIXME
  }
