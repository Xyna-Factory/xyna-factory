 ...
 *
 */
public class EventsUUIDAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.EVENTS;
  
  public EventsUUIDAction(XMOMGui xmomGui) {
    super(xmomGui, 1, Operation.GetPollEvents, null, false);
  }
  ...
  public void appendIndexPage(HTMLPart body) {
    ...
    paragraphDef.link(BASE_PATH, "GetEvents"); //FIXME
  }
