...
public class DatatypesPathNameDeployAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameDeployAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Deploy, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Deploy";
  }
