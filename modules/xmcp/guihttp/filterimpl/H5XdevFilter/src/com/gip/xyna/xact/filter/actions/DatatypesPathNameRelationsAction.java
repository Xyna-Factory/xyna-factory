...
public class DatatypesPathNameRelationsAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameRelationsAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Relations, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Relations";
  }
