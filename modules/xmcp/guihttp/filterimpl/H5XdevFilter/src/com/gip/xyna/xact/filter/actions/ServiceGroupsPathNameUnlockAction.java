 ...
 *
 */
public class ServiceGroupsPathNameUnlockAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameUnlockAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Unlock, Type.serviceGroup, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Unlock";
  }
  ...
  @Override
  protected boolean isEditAction(Method tc) {
    return false;
  }
