...
public class DatatypesPathNameRefactorAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameRefactorAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Refactor, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Refactor";
  }
