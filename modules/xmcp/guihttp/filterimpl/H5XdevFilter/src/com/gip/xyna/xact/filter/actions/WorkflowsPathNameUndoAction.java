 ...
 *
 */
public class WorkflowsPathNameUndoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameUndoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Undo, Type.workflow, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Undo";
  }
