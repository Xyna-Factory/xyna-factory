 ...
 *
 */
public class DatatypesPathNameObjectsIdReferenceCandidatesAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  // runtimeContext/<rtc>/xmom/datatypes/<path>/<name>/objects/<Member Function ID>/referenceCandidates
  public DatatypesPathNameObjectsIdReferenceCandidatesAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.ReferenceCandidates, Type.dataType, false);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.REFERENCE_CANDIDATES)
        && method == Method.GET;
  }

  @Override
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Objects-Id-Reference-Candidates";
  }
