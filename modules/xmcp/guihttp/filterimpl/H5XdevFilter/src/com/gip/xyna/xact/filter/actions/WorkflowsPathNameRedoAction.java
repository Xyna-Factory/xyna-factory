 ...
 *
 */
public class WorkflowsPathNameRedoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameRedoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Redo, Type.workflow, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Redo";
  }
