 ...
 *
 */
public class DatatypesPathAction extends RuntimeContextDependendAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  private final XMOMGui xmomGui;
  
  public DatatypesPathAction(XMOMGui xmomGui) {
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath";
  }
  ...
  private FilterActionInstance listPath(RuntimeContext rc, Long revision, URLPath url, HTTPTriggerConnection tc) throws SocketNotAvailableException {
    ...
    try {
      ...
      XmomObjectsPath xmomObjectsPath = new XmomObjectsPath(xmomGui.getXmomLoader(), "datatypes");
      xmomObjectsPath.filterTypes(ObjectIdentifierJson.Type.dataType, ObjectIdentifierJson.Type.exceptionType);
