 ...
 *
 */
public class WorkflowsPathNameRelationsAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameRelationsAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Relations, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Relations";
  }
