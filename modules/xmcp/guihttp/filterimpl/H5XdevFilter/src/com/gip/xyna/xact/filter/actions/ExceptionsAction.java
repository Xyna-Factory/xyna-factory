 ...
 *
 */
public class ExceptionsAction extends XmomGuiAction {
  ...
  public ExceptionsAction(XMOMGui xmomGui) {
    super(xmomGui, 0, 0, Operation.Create, Type.exceptionType, true);
  }
  ...
  private FilterActionInstance listPath(RuntimeContext rc, Long revision, URLPath url, HTTPTriggerConnection tc) throws SocketNotAvailableException {
    ...
    try {
      ...
      XmomObjectsPath xmomObjectsPath = new XmomObjectsPath(xmomGui.getXmomLoader(), "exceptionTypes");
      xmomObjectsPath.filterTypes(ObjectIdentifierJson.Type.exceptionType);
