 ...
 *
 */
public class DatatypesPathNameXmlAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameXmlAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.ViewXml, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Xml";
  }
