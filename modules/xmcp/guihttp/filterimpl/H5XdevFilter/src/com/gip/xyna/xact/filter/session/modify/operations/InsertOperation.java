...
public class InsertOperation extends ModifyOperationBase<InsertJson> {
  ...
  private void insert() throws UnknownObjectIdException, MissingObjectException, XynaException, InvalidJSONException, UnexpectedJSONContentException { 
    ...
    insertion.inferPossibleContent(); // �berlegen was im Content stehen k�nnte, dies ist leider nicht eindeutig
    Pair<PossibleContent, ? extends XMOMGuiJson> content = insertion.parseContent(insert); // Parsen der m�glichen Contents
