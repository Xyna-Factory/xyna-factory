...
/**
 * XMOMLoader l�dt XMOM-Objekte und Verwaltet die geparsten GenerationBase-Objekte, 
 * so dass diese nicht mehrfach geparst werden m�ssen.
 *
 */
public class XMOMLoader {
  ...
  public GenerationBaseObject load(FQName fqName, String xml) throws XynaException {
    /*
     * falls das objekt im commoncache bereits existiert, k�nnen auch andere xmomobjekte referenzen darauf haben.
     * alle referenzen sollen auch geupdated werden.
     * 
     * => auf das bestehende gb objekt erneut parsexml aufrufen mit dem �bergebenen xml
     */
    ...
    //f�r dieses objekt das gegebene xml verwenden, andere objekte falls notwendig aus saved laden
