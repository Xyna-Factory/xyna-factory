 ...
 *
 */
public class WorkflowsPathNameXmlAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameXmlAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.ViewXml, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Xml";
  }
