 ...
 *
 */
public class SubscribeProjectEventsAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.PROJECT_EVENTS_SUBSCRIBE;
  
  public SubscribeProjectEventsAction(XMOMGui xmomGui) {
    super(xmomGui, 1, Operation.SubscribeProjectPollEvents, null, true);
  }
