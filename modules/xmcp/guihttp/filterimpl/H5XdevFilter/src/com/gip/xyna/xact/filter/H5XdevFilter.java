...
public class H5XdevFilter extends ConnectionFilter<HTTPTriggerConnection> {
  ...
  public static final XynaPropertyString VALIDATION_WORKFLOW = new XynaPropertyString("xmcp.guihttp.startorder.preprocess_workflow", "")
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE,
                               "Wenn gesetzt, werden alle startrorder Requests außerhalb von guihttp zurerst vom angegebenen Workflow verarbeitet. Inputs sind Document und Ordertype, Output ist Document. Format: <fqn>@<rtc>. <rtc> ist entweder workspaceName oder applicationName/versionName");
