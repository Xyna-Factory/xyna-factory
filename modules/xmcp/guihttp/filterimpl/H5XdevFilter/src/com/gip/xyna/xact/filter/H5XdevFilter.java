...
public class H5XdevFilter extends ConnectionFilter<HTTPTriggerConnection> {
  ...
  public static final XynaPropertyBoolean USE_CACHE = new XynaPropertyBoolean("xmcp.guihttp.use_cache", true)
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Verwende einen Cache um auf zuletzt verwendete Objekte schneller zugreifen zu k�nnen. Gr��e des Caches is bestimmt durch " + cache_size_property_name);
