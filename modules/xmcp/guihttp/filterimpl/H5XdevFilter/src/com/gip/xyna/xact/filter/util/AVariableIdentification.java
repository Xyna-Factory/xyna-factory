 ...
 * - stepchoice: die outputs sind berechnet (mindestens teilweise) und nur �ber die assigns sichtbar
 * - etc. 
 */
public abstract class AVariableIdentification {
  ...
  //gibt die id der outputvariable im step-/generationbasecontext zur�ck
  ...
  //default, wird dann �berschrieben. das ist die id, die von der gui/im json benutzt wird
  ...
  /**
   * das setzen des labels kann nicht immer direkt auf der "AVariable" durchgef�hrt werden, weil AVariable manchmal nur eine referenz eines anderen objektes ist.
   * beispiel: stepfunction.inputvariablen referenzieren die inputvariablen des referenzierten services.
   *           wenn das label am aufruf ge�ndert werden soll, ist das nicht gleichbedeutend mit einer �nderung in der service(-definition)
   */
