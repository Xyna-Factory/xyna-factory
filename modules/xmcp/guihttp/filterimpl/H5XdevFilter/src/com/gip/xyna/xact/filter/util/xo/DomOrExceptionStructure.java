...
//    };
    ...
    switch (type) {
      case DATATYPE :
        return DOM.getOrCreateInstance(fqName, new GenerationBaseCache(), -100L /* gibts nicht, wird nicht ben�tigt */, inputSource);
      case EXCEPTION :
        return ExceptionGeneration.getOrCreateInstance(fqName, new GenerationBaseCache(), -100L /* gibts nicht, wird nicht ben�tigt */, inputSource);
      default :
  ...
  private DomOrExceptionGenerationBase getGenerationBaseFromRepository(final Map<String, RuntimeContext> runtimeContextMap,
    ...
    switch (type) {
      case DATATYPE :
        return DOM.getOrCreateInstance(fqName, cache, -100L /* gibts nicht, wird nicht ben�tigt */, inputSource);
      case EXCEPTION :
        return ExceptionGeneration.getOrCreateInstance(fqName, cache, -100L /* gibts nicht, wird nicht ben�tigt */, inputSource);
      default :
        throw new RuntimeException("unsupported type: " + type);
    }
  }
