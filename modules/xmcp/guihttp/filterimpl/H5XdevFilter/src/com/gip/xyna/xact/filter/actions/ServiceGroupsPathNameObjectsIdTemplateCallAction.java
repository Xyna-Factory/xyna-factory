 ...
 *
 */
public class ServiceGroupsPathNameObjectsIdTemplateCallAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameObjectsIdTemplateCallAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.TemplateCall, Type.serviceGroup, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.TEMPLATE_CALL)
        && method == Method.PUT;
  }

  @Override
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Objects-Id-TemplateCall";
  }
