 ...
 *
 */
public class DatatypesPathNameUndoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameUndoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Undo, Type.dataType, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Undo";
  }
