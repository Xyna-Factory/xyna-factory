 ...
 *
 */
public class ExceptionsPathNameRedoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameRedoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Redo, Type.exceptionType, false);
  }
  ...
  public String getTitle() {
    return "XMOM-Exception-TypePath-TypeName-Redo";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/h5.data/Simple/redo", "h5.data.Simple");
  }
