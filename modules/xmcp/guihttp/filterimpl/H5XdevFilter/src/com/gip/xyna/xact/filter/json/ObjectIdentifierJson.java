...
public class ObjectIdentifierJson implements JsonSerializable {
  ...
  public enum Type {
    ...
    // Reihenfolge ist relevant f�r die compareTo-Methode. Verwendet von ObjectIdentifierJsonFQNSorter.
  ...
  public static class ObjectIdentifierJsonFQNSorter implements Comparator<ObjectIdentifierJson> {
     ...
     * Stimmt genau einer der beiden mit "searchString" �berein, so wird 1 bzw. -1 zur�ckgegeben.
     * Stimmen beide oder keiner mit "searchString" �berein, so wird 0 zur�ckgegeben. (Die beiden String sind gleichwertig hinsichtlich exaktem Match.)
