...
public class DatatypesPathNameSaveAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameSaveAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Save, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Save";
  }
