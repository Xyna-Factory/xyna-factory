 ...
 *
 */
public class ExceptionsPathNameSaveAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameSaveAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Save, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exception-TypePath-TypeName-Save";
  }
