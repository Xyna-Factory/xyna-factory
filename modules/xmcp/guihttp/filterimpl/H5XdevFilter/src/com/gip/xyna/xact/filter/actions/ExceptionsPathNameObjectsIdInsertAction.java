 ...
 *
 */
public class ExceptionsPathNameObjectsIdInsertAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameObjectsIdInsertAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Insert, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exceptiontypes-TypePath-TypeName-Objects-Id-Insert";
  }
