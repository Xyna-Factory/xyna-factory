 ...
 *
 */
public class DatatypesPathNameObjectsIdCopyAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameObjectsIdCopyAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Copy, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Objects-Id-Copy";
  }
