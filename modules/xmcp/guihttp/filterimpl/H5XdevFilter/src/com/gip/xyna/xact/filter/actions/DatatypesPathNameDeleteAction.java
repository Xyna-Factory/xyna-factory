...
public class DatatypesPathNameDeleteAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameDeleteAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.DeleteDocument, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Delete";
  }
