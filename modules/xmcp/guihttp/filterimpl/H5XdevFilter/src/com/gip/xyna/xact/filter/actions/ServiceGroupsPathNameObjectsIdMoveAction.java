 ...
 *
 */
public class ServiceGroupsPathNameObjectsIdMoveAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameObjectsIdMoveAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Move, Type.serviceGroup, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Objects-Id-Move";
  }
