 ...
 *
 */
public class WorkflowsPathNameUnlockAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameUnlockAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Unlock, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Unlock";
  }
