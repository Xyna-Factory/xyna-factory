 ...
 *
 */
public class ServiceGroupsPathNameObjectsIdDeleteAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameObjectsIdDeleteAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Delete, Type.serviceGroup, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.DELETE)
        && method == Method.POST;
  }

  @Override
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Objects-Id-Delete";
  }
