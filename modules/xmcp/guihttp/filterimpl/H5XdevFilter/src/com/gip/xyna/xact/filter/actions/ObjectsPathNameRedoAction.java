 ...
 *
 */
public class ObjectsPathNameRedoAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.OBJECTS;
  
  public ObjectsPathNameRedoAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Redo, null, false);
  }
