 ...
 *
 */
public class ExceptionsPathNameXmlAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.EXCEPTION_TYPES;
  
  public ExceptionsPathNameXmlAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.ViewXml, Type.exceptionType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Exception-TypePath-TypeName-Xml";
  }
