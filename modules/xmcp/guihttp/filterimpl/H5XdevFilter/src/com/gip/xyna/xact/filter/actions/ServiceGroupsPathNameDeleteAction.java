...
public class ServiceGroupsPathNameDeleteAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameDeleteAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.DeleteDocument, Type.serviceGroup, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Delete";
  }
