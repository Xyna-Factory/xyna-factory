 ...
 *
 */
public class CodedservicesPathAction extends RuntimeContextDependendAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.CODED_SERVICES;
  private final XMOMGui xmomGui;
  
  public CodedservicesPathAction(XMOMGui xmomGui) {
  ...
  public String getTitle() {
    return "XMOM-CodedServices-TypePath";
  }
