 ...
 *
 */
public class WorkflowsPathNameObjectsIdConstantDelete extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsIdConstantDelete(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.ConstantDelete, Type.workflow, true);
  }
  ...
  protected boolean matchRuntimeContextIndependent( URLPath url, Method method) {
    return url.getPath().startsWith(BASE_PATH) 
        ...
        && url.getPathElement(6).equals(PathElements.CONSTANT)
        && url.getPathElement(7).equals(PathElements.DELETE)
        && method == Method.POST;
  }

  @Override
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id-Constant-delete";
  }
