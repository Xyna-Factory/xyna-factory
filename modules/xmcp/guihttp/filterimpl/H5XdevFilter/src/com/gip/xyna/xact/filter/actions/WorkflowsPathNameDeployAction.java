...
public class WorkflowsPathNameDeployAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameDeployAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Deploy, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Deploy";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/lw/TestJsonWFCall/deploy", "lw.testJsonWFCall"); //FIXME
  }
