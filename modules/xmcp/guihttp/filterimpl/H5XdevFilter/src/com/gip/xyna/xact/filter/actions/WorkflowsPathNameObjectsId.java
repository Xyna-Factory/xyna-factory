 ...
 *
 */
public class WorkflowsPathNameObjectsId extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameObjectsId(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.ViewSaved, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Objects-Id";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/lw/TestJsonWFCall/objects/W", "lw.testJsonWFCall"); //FIXME
  }
