...
public class ServiceGroupsPathNameRelationsAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.SERVICES_GROUPS;
  
  public ServiceGroupsPathNameRelationsAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Relations, Type.serviceGroup, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Servicegroups-TypePath-TypeName-Relations";
  }
