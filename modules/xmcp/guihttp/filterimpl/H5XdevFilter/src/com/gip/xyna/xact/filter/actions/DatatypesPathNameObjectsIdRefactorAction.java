...
public class DatatypesPathNameObjectsIdRefactorAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.DATA_TYPES;
  
  public DatatypesPathNameObjectsIdRefactorAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, 5, Operation.Refactor, Type.dataType, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Datatypes-TypePath-TypeName-Objects-Id-Refactor";
  }
