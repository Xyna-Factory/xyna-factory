...
public class WorkflowsPathNameRefactorAction extends XmomGuiAction {

  private static final String BASE_PATH = "/" + PathElements.XMOM + "/" + PathElements.WORKFLOWS;
  
  public WorkflowsPathNameRefactorAction(XMOMGui xmomGui) {
    super(xmomGui, 2, 3, Operation.Refactor, Type.workflow, true);
  }
  ...
  public String getTitle() {
    return "XMOM-Workflows-TypePath-TypeName-Refactor";
  }

  @Override
  public void appendIndexPage(HTMLPart body) {
    HTMLPart paragraphDef = body.paragraph();
    paragraphDef.link(BASE_PATH+"/lw/TestJsonWFCall/refactor", "lw.testJsonWFCall"); //FIXME
  }
