...
public class HTTPStartParameter extends EnhancedStartParameter {
  ...
  public static final StringParameter<KeyStoreParameter> HTTPS = 
      ...
      documentation( Documentation
                     .de("Wird HTTPS verwendet und wenn, wie wird der SSLContext bef�llt. NONE: http, FILE: https und Angabe eines gemeinsamen Key/Trust-Files, KEY_MGMT: https und Angabe eines KeyStores und TrustManagers")
  ...
  public static final StringParameter<Boolean> SUPPRESS_LOGGING = StringParameter.typeBoolean("suppressRequestLogging").
                  documentation(Documentation.de("Unterdr�cke requestabh�ngiges Logging").en("Suppress request dependent logging.").build()).
