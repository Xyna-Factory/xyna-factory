...
import xact.queue.WebSphereMQInstanceOperation;
import xact.queue.WebSphereMQSuperProxy;
import xact.queue.admin.WebSphereMQConfig;

import com.gip.xyna.xprc.XynaOrderServerExtension;


public class WebSphereMQInstanceOperationImpl extends WebSphereMQSuperProxy implements WebSphereMQInstanceOperation {

  private static final long serialVersionUID = 1L;

  private WebSphereMQConfig config;
    
  public WebSphereMQInstanceOperationImpl(WebSphereMQ instanceVar) {
    super(instanceVar);
    if( instanceVar.getQueueConfigType() instanceof WebSphereMQConfig) {
      config = (WebSphereMQConfig)instanceVar.getQueueConfigType();
    } else {
