...
public class OracleAQueue {
  ...
  public void close() {
    //derzeit nichts zu tun, da Connections immer sofort zur�ckgegeben werden
  }
  ...
  public void enqueue(CorrelationId correlationId, QueueMessage queueMessage, EnqueueOptions enqueueOptions) throws NoConnectionException, EnqueueFailedException {
    ...
    //enqueueOptionsBuilder.delay(enqueueOptions.getDelay()). //nur f�r Oracle, nicht bei anderen Queue-Implementierungen. Daher aktuell nicht unterst�tzt
