...
import com.gip.xyna.xact.trigger.tlvdecoding.radius.decoders.IgnoreValueRadiusTlvDecoder;
...
public final class IgnoreValueRadiusTlvDecoderFactory extends AbstractRadiusTlvDecoderFactory {
    ...
    public IgnoreValueRadiusTlvDecoderFactory(final String dataTypeName) {
        super(dataTypeName);
    }
    ...
    protected RadiusTlvDecoder createTlvDecoder(final int typeEncoding, final String typeName) {
        return new IgnoreValueRadiusTlvDecoder(typeEncoding, typeName);
    }
}
