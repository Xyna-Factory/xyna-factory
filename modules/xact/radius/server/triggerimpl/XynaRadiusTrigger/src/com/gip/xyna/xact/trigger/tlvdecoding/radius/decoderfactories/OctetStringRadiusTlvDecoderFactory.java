...
import com.gip.xyna.xact.trigger.tlvdecoding.radius.decoders.OctetStringRadiusTlvDecoder;
...
public final class OctetStringRadiusTlvDecoderFactory extends AbstractRadiusTlvDecoderFactory {
    ...
    public OctetStringRadiusTlvDecoderFactory() {
        super(DATA_TYPE_NAME);
    }


    public OctetStringRadiusTlvDecoderFactory(final String dataTypeName) {
        super(dataTypeName);
    }
    ...
    protected RadiusTlvDecoder createTlvDecoder(final int typeEncoding, final String typeName) {
        return new OctetStringRadiusTlvDecoder(typeEncoding, typeName);
    }
}
