...
import com.gip.xyna.xact.trigger.tlvdecoding.radius.decoders.UnsignedIntegerRadiusTlvDecoder;
 ...
 *
 */
public final class UnsignedIntegerRadiusTlvDecoderFactory extends AbstractRadiusTlvDecoderFactory {

    public static final String DATA_TYPE_NAME = "UnsignedInteger";


    public UnsignedIntegerRadiusTlvDecoderFactory() {
    ...
    protected RadiusTlvDecoder createTlvDecoder(final int typeEncoding, final String typeName) {
        return new UnsignedIntegerRadiusTlvDecoder(typeEncoding, typeName);
    }
}
