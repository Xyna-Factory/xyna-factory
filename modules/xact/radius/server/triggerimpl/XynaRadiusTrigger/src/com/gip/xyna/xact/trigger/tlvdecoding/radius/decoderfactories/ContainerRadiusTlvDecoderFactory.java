...
import com.gip.xyna.xact.trigger.tlvdecoding.radius.decoders.ContainerRadiusTlvDecoder;
...
public final class ContainerRadiusTlvDecoderFactory implements RadiusTlvDecoderFactory {
    ...
    public RadiusTlvDecoder create(final int typeEncoding, final String typeName, final List<RadiusTlvDecoder> subTlvDecoders) {
        ...
        return new ContainerRadiusTlvDecoder(typeEncoding, typeName, subTlvDecoders);
    }
}
