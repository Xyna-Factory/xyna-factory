...
public class SearchRowsRequest_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.Audit.WS.Leases.Messages.SearchRowsInput_ctype searchRowsInput;
    ...
    public SearchRowsRequest_ctype(
           ...
           com.gip.www.juno.Audit.WS.Leases.Messages.SearchRowsInput_ctype searchRowsInput) {
     ...
     */
    public com.gip.www.juno.Audit.WS.Leases.Messages.SearchRowsInput_ctype getSearchRowsInput() {
        return searchRowsInput;
    }
     ...
     */
    public void setSearchRowsInput(com.gip.www.juno.Audit.WS.Leases.Messages.SearchRowsInput_ctype searchRowsInput) {
        this.searchRowsInput = searchRowsInput;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Audit/WS/Leases/Messages", "SearchRowsRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/Audit/WS/Leases/Messages", "SearchRowsInput"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Audit/WS/Leases/Messages", "SearchRowsInput_ctype"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
