...
public class OneRowInput_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.SnmpTrap.WS.PoolUsageThreshold.Messages.Row_ctype content;
    ...
    public OneRowInput_ctype(
           ...
           com.gip.www.juno.SnmpTrap.WS.PoolUsageThreshold.Messages.Row_ctype content) {
     ...
     * @return content
     */
    public com.gip.www.juno.SnmpTrap.WS.PoolUsageThreshold.Messages.Row_ctype getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.gip.www.juno.SnmpTrap.WS.PoolUsageThreshold.Messages.Row_ctype content) {
        this.content = content;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/SnmpTrap/WS/PoolUsageThreshold/Messages", "OneRowInput_ctype"));
