...
public class NcsMta_ctype  implements java.io.Serializable {
    ...
    /**
     * Gets the mac value for this NcsMta_ctype.
     * 
     * @return mac
     */
    ...
    /**
     * Sets the mac value for this NcsMta_ctype.
     * 
     * @param mac
     */
    ...
    /**
     * Gets the softswitchType value for this NcsMta_ctype.
     * 
    ...
    /**
     * Sets the softswitchType value for this NcsMta_ctype.
     * 
    ...
    /**
     * Gets the softswitch value for this NcsMta_ctype.
     * 
     * @return softswitch
     */
    ...
    /**
     * Sets the softswitch value for this NcsMta_ctype.
     * 
     * @param softswitch
     */
    ...
    /**
     * Gets the portNumbers value for this NcsMta_ctype.
     * 
     * @return portNumbers
     */
    ...
    /**
     * Sets the portNumbers value for this NcsMta_ctype.
     * 
     * @param portNumbers
     */
    ...
    /**
     * Gets the xml value for this NcsMta_ctype.
     * 
     * @return xml
     */
    ...
    /**
     * Sets the xml value for this NcsMta_ctype.
     * 
     * @param xml
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NcsMta_ctype)) return false;
        NcsMta_ctype other = (NcsMta_ctype) obj;
        ...
        _equals = true && 
            ...
            ((this.portNumbers==null && other.getPortNumbers()==null) || 
             (this.portNumbers!=null &&
              java.util.Arrays.equals(this.portNumbers, other.getPortNumbers()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getPortNumbers() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPortNumbers());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPortNumbers(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NcsMta_ctype.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Gui/WS/Messages", "NcsMta_ctype"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("portNumbers");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/Gui/WS/Messages", "PortNumbers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.gip.com/juno/Gui/WS/Messages", "PortNumber"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
