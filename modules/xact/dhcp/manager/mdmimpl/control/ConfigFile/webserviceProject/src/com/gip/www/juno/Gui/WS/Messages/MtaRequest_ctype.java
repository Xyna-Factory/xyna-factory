...
public class MtaRequest_ctype  implements java.io.Serializable {
    ...
    private java.lang.String requestPktc;

    private java.lang.String version;

    private boolean isSendSnmpNotification;

    public MtaRequest_ctype() {
    }
    ...
    /**
     * Gets the macAddress value for this MtaRequest_ctype.
     * 
     * @return macAddress
     */
    ...
    /**
     * Sets the macAddress value for this MtaRequest_ctype.
     * 
     * @param macAddress
     */
    ...
    /**
     * Gets the ipAddress value for this MtaRequest_ctype.
     * 
     * @return ipAddress
     */
    ...
    /**
     * Sets the ipAddress value for this MtaRequest_ctype.
     * 
     * @param ipAddress
     */
    ...
    /**
     * Gets the fileName value for this MtaRequest_ctype.
     * 
     * @return fileName
     */
    ...
    /**
     * Sets the fileName value for this MtaRequest_ctype.
     * 
     * @param fileName
     */
    ...
    /**
     * Gets the deviceDetails value for this MtaRequest_ctype.
     * 
    ...
    /**
     * Sets the deviceDetails value for this MtaRequest_ctype.
     * 
     * @param deviceDetails
     */
    ...
    /**
     * Gets the requestPktc value for this MtaRequest_ctype.
     * 
     * @return requestPktc
     */
    public java.lang.String getRequestPktc() {
        return requestPktc;
    }


    /**
     * Sets the requestPktc value for this MtaRequest_ctype.
     * 
     * @param requestPktc
     */
    public void setRequestPktc(java.lang.String requestPktc) {
        this.requestPktc = requestPktc;
    }


    /**
     * Gets the version value for this MtaRequest_ctype.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this MtaRequest_ctype.
     * 
     * @param version
     */
    ...
    /**
     * Gets the isSendSnmpNotification value for this MtaRequest_ctype.
     * 
    ...
    /**
     * Sets the isSendSnmpNotification value for this MtaRequest_ctype.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MtaRequest_ctype)) return false;
        MtaRequest_ctype other = (MtaRequest_ctype) obj;
        ...
        _equals = true && 
            ...
            ((this.requestPktc==null && other.getRequestPktc()==null) || 
             (this.requestPktc!=null &&
              this.requestPktc.equals(other.getRequestPktc()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getRequestPktc() != null) {
            _hashCode += getRequestPktc().hashCode();
        }
        if (getVersion() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MtaRequest_ctype.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Gui/WS/Messages", "MtaRequest_ctype"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("requestPktc");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/Gui/WS/Messages", "requestPktc"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
