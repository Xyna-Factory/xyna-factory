...
public class PoolUsageBindingImpl implements com.gip.www.juno.SnmpTrap.WS.PoolUsage.PoolUsage_PortType{
  ...
  public com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.Response_ctype getMetaInfo(com.gip.www.juno.Gui.WS.Messages.GetMetaInfoRequest_ctype metaInfoRequest) throws java.rmi.RemoteException {
    try{
      ...
      payload.setMetaInfoOutput(new PoolUsageBindingReal().getMetaInfo(metaInfoRequest));
  ...
  public com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.Response_ctype getAllRows(com.gip.www.juno.Gui.WS.Messages.GetAllRowsRequest_ctype getAllRowsRequest) throws java.rmi.RemoteException {
    try{
      Payload_ctype payload=new Payload_ctype();   
      payload.setGetAllRowsOutput(new PoolUsageBindingReal().getAllRows(getAllRowsRequest));
      return createResponse(payload);
    } catch (Exception e){
      return createResponse("Error",e);
    }
  ...
  public com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.Response_ctype searchRows(com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.SearchRowsRequest_ctype searchRowsRequest) throws java.rmi.RemoteException {
    try{
      Payload_ctype payload=new Payload_ctype();   
      payload.setSearchRowsOutput(new PoolUsageBindingReal().searchRows(searchRowsRequest));
      return createResponse(payload);
    } catch (Exception e){
      return createResponse("Error",e);
    }
  ...
  public com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.Response_ctype insertRow(com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.InsertRowRequest_ctype insertRowRequest) throws java.rmi.RemoteException {
    try{
      Payload_ctype payload=new Payload_ctype();   
      payload.setInsertRowOutput(new PoolUsageBindingReal().insertRow(insertRowRequest));
      return createResponse(payload);
    } catch (Exception e){
      return createResponse("Error",e);
    }
  ...
  public com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.Response_ctype deleteRows(com.gip.www.juno.SnmpTrap.WS.PoolUsage.Messages.DeleteRowsRequest_ctype deleteRowsRequest) throws java.rmi.RemoteException {
    try{
      Payload_ctype payload=new Payload_ctype();   
      payload.setDeleteRowsOutput(new PoolUsageBindingReal().deleteRows(deleteRowsRequest));
      return createResponse(payload);
    } catch (Exception e){
      return createResponse("Error",e);
    }
