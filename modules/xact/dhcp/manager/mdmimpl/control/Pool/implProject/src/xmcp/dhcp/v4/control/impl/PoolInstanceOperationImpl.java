...
import xmcp.dhcp.v4.control.PoolSuperProxy;
import xmcp.dhcp.v4.control.Pool;


public class PoolInstanceOperationImpl extends PoolSuperProxy {

  private static final long serialVersionUID = 1L;

  public PoolInstanceOperationImpl(Pool instanceVar) {
    super(instanceVar);
  }
