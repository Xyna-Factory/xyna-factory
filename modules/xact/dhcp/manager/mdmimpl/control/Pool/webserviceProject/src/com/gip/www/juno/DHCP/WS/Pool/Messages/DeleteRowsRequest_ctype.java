...
public class DeleteRowsRequest_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype deleteRowsInput;
    ...
    public DeleteRowsRequest_ctype(
           ...
           com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype deleteRowsInput) {
     ...
     */
    public com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype getDeleteRowsInput() {
        return deleteRowsInput;
    }
     ...
     */
    public void setDeleteRowsInput(com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype deleteRowsInput) {
        this.deleteRowsInput = deleteRowsInput;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Pool/Messages", "DeleteRowsRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Pool/Messages", "DeleteRowsInput"));
