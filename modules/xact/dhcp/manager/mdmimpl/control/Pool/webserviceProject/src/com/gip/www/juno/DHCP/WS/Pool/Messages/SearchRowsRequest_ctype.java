...
public class SearchRowsRequest_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype searchRowsInput;
    ...
    public SearchRowsRequest_ctype(
           ...
           com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype searchRowsInput) {
     ...
     */
    public com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype getSearchRowsInput() {
        return searchRowsInput;
    }
     ...
     */
    public void setSearchRowsInput(com.gip.www.juno.DHCP.WS.Pool.Messages.Row_ctype searchRowsInput) {
        this.searchRowsInput = searchRowsInput;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Pool/Messages", "SearchRowsRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Pool/Messages", "SearchRowsInput"));
