...
public class PoolBindingReal{

  private static TableHandler _handler = new PoolHandler();
  ...
  public Row_ctype insertRow(InsertRowRequest_ctype insertRowRequest) throws java.rmi.RemoteException {
    ...
    try {
      ...
      ValidationHandler.validatePool(input.getRangeStart(), input.getRangeStop(), input.getSubnetID());
