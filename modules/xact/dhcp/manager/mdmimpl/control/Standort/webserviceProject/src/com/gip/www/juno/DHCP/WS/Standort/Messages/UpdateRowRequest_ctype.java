...
public class UpdateRowRequest_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.DHCP.WS.Standort.Messages.Row_ctype updateRowInput;
    ...
    public UpdateRowRequest_ctype(
           ...
           com.gip.www.juno.DHCP.WS.Standort.Messages.Row_ctype updateRowInput) {
     ...
     */
    public com.gip.www.juno.DHCP.WS.Standort.Messages.Row_ctype getUpdateRowInput() {
        return updateRowInput;
    }
     ...
     */
    public void setUpdateRowInput(com.gip.www.juno.DHCP.WS.Standort.Messages.Row_ctype updateRowInput) {
        this.updateRowInput = updateRowInput;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Standort/Messages", "UpdateRowRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Standort/Messages", "UpdateRowInput"));
