...
public class UpdateRowPkRequest_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.Deployments.WS.DeployActions.Messages.UpdateRowPkInput_ctype updateRowPkInput;
    ...
    public UpdateRowPkRequest_ctype(
           ...
           com.gip.www.juno.Deployments.WS.DeployActions.Messages.UpdateRowPkInput_ctype updateRowPkInput) {
     ...
     */
    public com.gip.www.juno.Deployments.WS.DeployActions.Messages.UpdateRowPkInput_ctype getUpdateRowPkInput() {
        return updateRowPkInput;
    }
     ...
     */
    public void setUpdateRowPkInput(com.gip.www.juno.Deployments.WS.DeployActions.Messages.UpdateRowPkInput_ctype updateRowPkInput) {
        this.updateRowPkInput = updateRowPkInput;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Deployments/WS/DeployActions/Messages", "UpdateRowPkRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/Deployments/WS/DeployActions/Messages", "UpdateRowPkInput"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/Deployments/WS/DeployActions/Messages", "UpdateRowPkInput_ctype"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
