...
public class CountAllRowsRequest_ctype  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Optionsv4/Messages", "CountAllRowsRequest_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/Optionsv4/Messages", "CountAllRowsInput"));
