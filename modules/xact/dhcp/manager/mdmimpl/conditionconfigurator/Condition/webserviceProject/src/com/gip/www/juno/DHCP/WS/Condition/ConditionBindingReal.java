...
import com.gip.www.juno.DHCP.WS.Condition.Messages.*;

import com.gip.www.juno.Gui.WS.Messages.*;

import java.util.List;

import com.gip.juno.ws.db.tables.dhcp.ConditionHandler;
...
public class ConditionBindingReal{

  private static TableHandler _handler = new ConditionHandler();
