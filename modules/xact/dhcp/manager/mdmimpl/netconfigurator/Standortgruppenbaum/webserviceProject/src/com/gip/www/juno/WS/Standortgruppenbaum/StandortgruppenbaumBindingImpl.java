...
import com.gip.www.juno.WS.Standortgruppenbaum.Messages.Payload_ctype;
import com.gip.www.juno.WS.Standortgruppenbaum.Messages.Response_ctype;


public class StandortgruppenbaumBindingImpl implements com.gip.www.juno.WS.Standortgruppenbaum.Standortgruppenbaum_PortType{
 ...
 private Response_ctype createResponse(Payload_ctype payload) {
  ...
  public com.gip.www.juno.WS.Standortgruppenbaum.Messages.Response_ctype getTreeString(com.gip.www.juno.WS.Standortgruppenbaum.Messages.GetTreeStringRequest_ctype getTreeStringRequest) throws java.rmi.RemoteException {
    try{
      ...
      payload.setGetTreeStringOutput(new StandortgruppenbaumBindingReal().getTreeString(getTreeStringRequest));
      return createResponse(payload);
    } catch (Throwable e) {
      StandortgruppenbaumBindingReal.logger.error(e);
