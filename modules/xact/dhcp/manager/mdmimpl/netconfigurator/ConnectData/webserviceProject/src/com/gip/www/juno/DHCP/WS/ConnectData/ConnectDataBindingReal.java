...
import com.gip.www.juno.DHCP.WS.ConnectData.Messages.*;

import com.gip.www.juno.Gui.WS.Messages.*;

import java.util.List;

import com.gip.juno.ws.db.tables.dhcp.ConnectDataHandler;
...
public class ConnectDataBindingReal{

  private static TableHandler _handler = new ConnectDataHandler();
