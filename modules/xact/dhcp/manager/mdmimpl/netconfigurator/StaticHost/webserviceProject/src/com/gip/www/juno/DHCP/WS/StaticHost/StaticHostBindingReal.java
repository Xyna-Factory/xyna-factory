...
public class StaticHostBindingReal{
  ...
  public Row_ctype[] getAllRows(GetAllRowsRequest_ctype getAllRowsRequest) throws java.rmi.RemoteException {
    return getAllRows(getAllRowsRequest, false);
  }
  
  
  public Row_ctype[] getAllRows(GetAllRowsRequest_ctype getAllRowsRequest, boolean useLegacyAuthentification) throws java.rmi.RemoteException {
    try {
      Row_ctype ref = new Row_ctype();
      InputHeaderContent_ctype header = getAllRowsRequest.getInputHeader();
      String username = header.getUsername();
      String password = header.getPassword();
      List<Row_ctype> ret = new WebserviceHandler<Row_ctype>().getAllRows(ref, _handler, username, password, useLegacyAuthentification);
  ...
  public Row_ctype insertRow(InsertRowRequest_ctype insertRowRequest) throws java.rmi.RemoteException {
    ...
    try {
      ...
      ValidationHandler.validateStatichost(input.getIp(), input.getAssignedPoolID(), input.getStaticHostID());
      Row_ctype ret = new WebserviceHandler<Row_ctype>().insertRowStaticHost(input, username, password);
  ...
  public Row_ctype updateRow(UpdateRowRequest_ctype updateRowRequest) throws java.rmi.RemoteException {
    ...
    try {
      ...
      ValidationHandler.validateStatichost(input.getIp(), input.getAssignedPoolID(), input.getStaticHostID());
      Row_ctype ret = new WebserviceHandler<Row_ctype>().updateRowStaticHost(input, username,
          password);
  ...
  public String deleteRows(DeleteRowsRequest_ctype deleteRowsRequest) throws java.rmi.RemoteException {
    ...
    try {
      ...
      String ret = new WebserviceHandler<Row_ctype>().deleteRowStaticHost(input, username,
          password);
      deployInfo.setLog(changelog);
      return ret;
    } catch (java.rmi.RemoteException e) {
