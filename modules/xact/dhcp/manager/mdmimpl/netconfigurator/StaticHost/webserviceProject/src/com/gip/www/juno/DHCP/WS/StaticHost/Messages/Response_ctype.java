...
public class Response_ctype  implements java.io.Serializable {
    ...
    private com.gip.www.juno.DHCP.WS.StaticHost.Messages.Payload_ctype payload;
    ...
    public Response_ctype(
           ...
           com.gip.www.juno.DHCP.WS.StaticHost.Messages.Payload_ctype payload) {
     ...
     * @return payload
     */
    public com.gip.www.juno.DHCP.WS.StaticHost.Messages.Payload_ctype getPayload() {
        return payload;
    }
     ...
     * @param payload
     */
    public void setPayload(com.gip.www.juno.DHCP.WS.StaticHost.Messages.Payload_ctype payload) {
        this.payload = payload;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/StaticHost/Messages", "Response_ctype"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/StaticHost/Messages", "Payload"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.gip.com/juno/DHCP/WS/StaticHost/Messages", "Payload_ctype"));
