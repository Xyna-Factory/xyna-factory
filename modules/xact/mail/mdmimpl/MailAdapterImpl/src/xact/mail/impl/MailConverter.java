 ...
 * FIXME Verdopplung: Auch in POP3Filter
 */
public class MailConverter {
  ...
  public static xact.mail.internal.Mail convertFromXmom(Mail mail) {
    ...
    ret.setEncoding(mail.getEncoding());
    ...
    ret.setBody( createContent( "body", null, ret.getEncoding(), mail.getBody() ) );
  ...
  private static Content createContent(String name, String mediaType, String encoding, Document document) {
    String completeMediaType = inferMediaType(mediaType, document);
    if (encoding != null) {
      completeMediaType += "; charset=" + encoding;
    }
    return new Content(name, completeMediaType, document.getText(), null);
  }
