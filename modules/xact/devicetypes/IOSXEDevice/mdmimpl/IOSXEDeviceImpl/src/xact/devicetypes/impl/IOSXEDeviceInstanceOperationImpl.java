...
import xact.devicetypes.IOSXEDevice;
import xact.devicetypes.IOSXEDeviceInstanceOperation;
import xact.devicetypes.IOSXEDeviceSuperProxy;
...
public class IOSXEDeviceInstanceOperationImpl extends IOSXEDeviceSuperProxy implements IOSXEDeviceInstanceOperation {

  private static final long serialVersionUID = 1L;
  private static String errorConditionsProperty = "xact.devicetypes.IOSXEDevice.errorConditions";
  private static ErrorConditions errorConditions = new ErrorConditions("");
  private static String errorIndicator = "%";
  
  private static Logger logger = Logger.getLogger(IOSXEDeviceInstanceOperationImpl.class);

  public IOSXEDeviceInstanceOperationImpl(IOSXEDevice instanceVar) {
    super(instanceVar);
  }
  ...
  public Boolean isResponseComplete(String response, DocumentType documentType, ManagedConnection managedConnection, Command command) {
      return super.isResponseComplete(response, documentType, managedConnection, command);
  }
