...
import xact.devicetypes.OneOSDevice;
import xact.devicetypes.OneOSDeviceInstanceOperation;
import xact.devicetypes.OneOSDeviceSuperProxy;
...
public class OneOSDeviceInstanceOperationImpl extends OneOSDeviceSuperProxy implements OneOSDeviceInstanceOperation {

  private static final long serialVersionUID = 1L;
  private static String errorConditionsProperty = "xact.devicetypes.OneOS.errorConditions";
  private static ErrorConditions errorConditions = null;
  private static String errorIndicator = "Error:";

  

  
  private static Logger logger = Logger.getLogger(OneOSDeviceInstanceOperationImpl.class);
  ...
  public OneOSDeviceInstanceOperationImpl(OneOSDevice instanceVar) {
    super(instanceVar);
  }
  ...
  public Boolean checkInteraction(CommandResponseTuple response, DocumentType documentType) {
    ...
    public Boolean isResponseComplete(String response, DocumentType documentType, ManagedConnection mannagedConnection, Command command) {
      logger.debug("### isResponseComplete: Command: " + command + ", Response: " + response);
