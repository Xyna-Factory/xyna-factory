...
import xact.devicetypes.IOSDevice;
import xact.devicetypes.IOSDeviceInstanceOperation;
import xact.devicetypes.IOSDeviceSuperProxy;
...
public class IOSDeviceInstanceOperationImpl extends IOSDeviceSuperProxy implements IOSDeviceInstanceOperation {

  private static final long serialVersionUID = 1L;
  private static String errorConditionsProperty = "xact.devicetypes.IOSDevice.errorConditions";
  private static ErrorConditions errorConditions = new ErrorConditions("");
  private static String errorIndicator = "%";
  
  private static Logger logger = Logger.getLogger(IOSDeviceInstanceOperationImpl.class);
  
  public IOSDeviceInstanceOperationImpl(IOSDevice instanceVar) {
    super(instanceVar);
  }
