...
import xact.devicetypes.IOSXRDevice;
import xact.devicetypes.IOSXRDeviceInstanceOperation;
import xact.devicetypes.IOSXRDeviceSuperProxy;
...
public class IOSXRDeviceInstanceOperationImpl extends IOSXRDeviceSuperProxy implements IOSXRDeviceInstanceOperation {

  private static final long serialVersionUID = 1L;
  private static String errorConditionsProperty = "xact.devicetypes.IOSXRDevice.errorConditions";
  private static ErrorConditions errorConditions = new ErrorConditions("");
  private static String errorIndicator = "%";
  
  private static Logger logger = Logger.getLogger(IOSXRDeviceInstanceOperationImpl.class);

  public IOSXRDeviceInstanceOperationImpl(IOSXRDevice instanceVar) {
    super(instanceVar);
  }
