...
public class NetConfNotificationReceiverConfigurationParameter extends FilterConfigurationParameter {
  ...
  public static final StringParameter<String> ORDER_TYPE =
      StringParameter.typeString("orderType").documentation(Documentation.de("OrderType als Beispiel einer Filter-Konfiguration")
          .en("Order type as an example for filter configuration").build()).optional().build();

  protected static final List<StringParameter<?>> ALL_PARAMETERS = StringParameter.asList(ORDER_TYPE);
  ...
  @Override
  public NetConfNotificationReceiverConfigurationParameter build(Map<String, Object> paramMap)
