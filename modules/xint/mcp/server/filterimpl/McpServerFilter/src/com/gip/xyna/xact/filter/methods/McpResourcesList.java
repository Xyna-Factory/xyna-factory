...
import com.gip.xyna.xact.filter.serialization.ResourceSerializer;
...
public class McpResourcesList implements McpMethodHandler {
  ...
  public void process(McpRequestData data) {
    ...
    jb.addListAttribute("resources");

    for (Resource resource : primitives.getResources()) {
      jb.addObjectListElement(new ResourceSerializer(resource));
    }
