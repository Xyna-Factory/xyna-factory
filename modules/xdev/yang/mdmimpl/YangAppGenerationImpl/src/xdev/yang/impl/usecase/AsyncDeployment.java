...
public class AsyncDeployment {
  ...
  public static final XynaPropertyBoolean PROP_ASYNC_DEPLOY = new XynaPropertyBoolean("xdev.yang.AsyncDeploy", true)
      .setDefaultDocumentation(DocumentationLanguage.EN, "Deploy UsecaseGroup asynchroniously when assigning values.")
      .setDefaultDocumentation(DocumentationLanguage.DE, "Asynchrones deploy der UsecaseGroup beim bearbeiten von Yang Zuweisungen");
