...
public class OperationMapping implements Comparable<OperationMapping> {
  ...
  public OperationMapping(String mappingYangPath, String namespace, String value, String keyword) {
  ...
  public static List<OperationMapping> loadMappings(Document document) {
    List<Element> mappingNodes = loadMappingElements(document);
    List<OperationMapping> result = new ArrayList<OperationMapping>();
    for(Element mappingNode : mappingNodes) {
      OperationMapping mapping = loadOperationMapping(mappingNode);
      result.add(mapping);
    }
    return result;
  }

  public static OperationMapping loadOperationMapping(Element e) {
    ...
    return new OperationMapping(yangPath, namespace, value, keyword);
  }
  ...
  @Override
  public int compareTo(OperationMapping o) {
