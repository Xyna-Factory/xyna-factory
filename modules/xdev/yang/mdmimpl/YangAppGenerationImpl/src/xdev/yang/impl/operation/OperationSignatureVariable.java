...
public class OperationSignatureVariable {

  private String fqn;
  private String varName;
  
  
  public OperationSignatureVariable(String fqn, String varName) {
    this.fqn = fqn;
  ...
  public static List<OperationSignatureVariable> loadSignatureEntries(Document document, String location) {
    List<Element> signatureEntryElements = loadSignatureEntryElements(document, location);
    List<OperationSignatureVariable> result = new ArrayList<OperationSignatureVariable>();
    for(Element signatureEntryElement : signatureEntryElements) {
      ...
      OperationSignatureVariable entry = new OperationSignatureVariable(fqn, varName);
      result.add(entry);
    }
    return result;
  }
  ...
  public static void overwriteSignatureEntryAtIndex(Document document, String location, int index, 
                                                    OperationSignatureVariable newValues) {
    List<Element> signatureEntryElements = loadSignatureEntryElements(document, location);
