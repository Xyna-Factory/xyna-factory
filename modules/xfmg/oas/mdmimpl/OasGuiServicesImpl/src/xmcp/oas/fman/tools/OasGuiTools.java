...
public class OasGuiTools {
  ...
  public List<ImplementedOasApiType> getAllImplementedOasApiTypesInRtc(GeneratedOasApiType goat) {
    return null;
  }
  
  public List<ImplementedOasApiType> getAllImplementedOasApiTypes(GeneratedOasApiType goat) {
    return null;
  }
