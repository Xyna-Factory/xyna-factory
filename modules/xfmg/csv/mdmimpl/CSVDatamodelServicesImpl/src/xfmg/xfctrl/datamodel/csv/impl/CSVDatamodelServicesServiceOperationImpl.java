...
public class CSVDatamodelServicesServiceOperationImpl implements ExtendedDeploymentTask, CSVDatamodelServicesServiceOperation {
  ...
  public List<GeneralXynaObject> readCSVDocumentWithOptions(Document doc, CSVParameter para, GeneralXynaObject templ,
    ...
    for (int i = 1; i < lines.size(); i++) {
      ...
      //beim create wird immer bereits die gesamte (teil-)baumstruktur erzeugt, die f�r die bef�llung notwendig ist.
      //damit spart man sich das lazy checken sp�ter
  ...
  private static class XynaObjectCreator {
    ...
    public void addMemberCreation(XmomField field) {
      ...
      for (int i = fields.size() - 1; i >= 0; i--) {
        ...
        //hier w�re eine map performanter, aber es ist nicht zu erwarten, dass man so viele verschiedene members hat, dass das eine rolle spielt
    ...
    //erzeugt zielobjekt mit leer initialisierten komplexwertigen members, falls diese f�r die bef�llung durch csv-spalten ben�tigt werden
