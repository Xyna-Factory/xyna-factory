...
public class WebSphereMQSOAPFilter extends ConnectionFilter<WebSphereMQTriggerConnection> {
  ...
  private static Logger _logger = CentralFactoryLogging.getLogger(WebSphereMQSOAPFilter.class);
  ...
  public FilterResponse createXynaOrder(WebSphereMQTriggerConnection tc) throws XynaException {
    ...
    try {
      ...
      String adapted = SoapBuilder.removeOptionalSoapEnvelope(msg);
      WebSphereMQMessage mqMsg = new WebSphereMQMessage();
      mqMsg.setMessage(adapted);
