...
import xact.jms.activemq.ActiveMQAdapterServiceOperation;


public class ActiveMQAdapterServiceOperationImpl implements ExtendedDeploymentTask, ActiveMQAdapterServiceOperation {
  ...
  public Container receiveFromActiveMQ(XynaQueueMgmtQueueName xynaQueueMgmtQueueName, CorrelationID correlationID, TimeoutInMillis timeoutInMillis) throws XynaException {
    // Implemented as code snippet!
    return null;
  }

  public void sendToActiveMQ(XynaQueueMgmtQueueName xynaQueueMgmtQueueName, ActiveMQMessage activeMQMessage, CorrelationID correlationID) throws XynaException {
    // Implemented as code snippet!
  }
