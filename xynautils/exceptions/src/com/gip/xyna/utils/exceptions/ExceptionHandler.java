...
/**
 * Klasse f�r das generische Exceptionhandling
 * <p>
 ...
 * String-Array separat mit�bergeben:<br>
 * <code>throw new
 ...
 * <p>
 * Features: Unterst�tzt unterschiedliche Sprachen, und eigene Filter zur Umwandlung von bestimmten Exceptions in
 * XynaFaults.
 * <p>
 * Anfangs wird versucht mittels {@link ExceptionStorage} FehlerCodes und Nachrichten aus zu initialisieren (aus XML
 * File oder �hnlichem, abh�ngig von der Implementierung)
 */
public class ExceptionHandler {
  ...
  /**
   * Fehlernachrichten k�nnen Parameter in der Form %zahl% haben, wobei die Zahl angibt, der wievielte Parameter hier
   * eingesetzt wird. Es wird mit 0 angefangen zu z�hlen.
   * 
  ...
  /**
   * Hier steht drin: Welche Fehlermeldung geh�rt zu welchem Code. F�r Mehrsprachlichkeit kann es f�r verschiedene
  ...
  private static final String LANG_ALL = "ALL"; // nur f�r internen Gebrauch, damit bei auch bei
  // falsch eingestellter sprache sicher eine fehlermeldung zur�ckkommt.
  ...
  /**
   * f�gt einen eigenen ExceptionFilter zum Fehlerhandling hinzu. ExceptionFilter-Klassen m�ssen die Methode
  ...
  /**
   * legt fest, in welcher Sprache Fehler standardm�ssig ausgegeben werden
   * 
   * @see #LANG_DE
   * @see #LANG_EN
   * @param lang
  ...
  /**
   * cacht die �bergebene Fehlernachricht zugeordnet zum Fehlercode f�r die aktuell eingestellte Sprache
   * 
   * @param code
   * @param message
  ...
  /**
   * cacht die �bergebene Fehlernachricht zugeordnet zum Fehlercode f�r die �bergebene Sprache
   * 
   * @param code
   * @param message
  ...
  /**
   * man kann zus�tzlich die Sprache angeben, in der die Fehlermeldung erzeugt wird.
   * 
