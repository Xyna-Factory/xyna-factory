...
/**
 * parse() aufrufen, ansonsten sind die membervariablen nicht gef�llt.
 */
public class ExceptionStorageParser_1_1 extends ExceptionStorageParserBase {
  ...
  /**
   * l�st strings der form ... ${key} ... ${key2} ... auf indem key und key2 mit system-properties
  ...
  protected ExceptionStorageInstance parseInternal(boolean resolveIncludes, int depth) throws InvalidXMLException,
    ...
    //imports = referenzierte xmls, die nur zur aufl�sung von abh�ngigkeiten benutzt werden.
