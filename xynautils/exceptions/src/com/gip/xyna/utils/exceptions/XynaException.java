...
/**
 * Exception ohne konkrete Angabe der Message sondern nur des Codes. Die tats�chliche Fehler
 * Nachricht wird �ber den {@link ExceptionHandler} erzeugt. {@link #getMessage} ist �berschrieben und
 * gibt die aus dem Code erzeugte Fehlernachricht zur�ck.
 */
public class XynaException extends Exception {
   ...
   /**
    * Erzeugt eine XynaException mit dem �bergebenen Code
    * 
    * @param code
    */
   ...
   /**
    * Erzeugt eine XynaException mit dem �bergebenen Code und einem Argument
    * 
    * @param code
    * @param arg
    */
   ...
   */
   ...
   /**
    * erzeugt eine XynaException mit dem �bergebenen Code und mehreren Argumenten
    * 
    * @param code
    * @param args
    */
   ...
   */
   public XynaException initCause(Throwable t) {
     if (t == null) {
       //getCause gibt trotzdem noch null zur�ck. der einzige unterschied zum "normalen super.initCause(null)" ist, dass man initCause(null) mehrfach aufrufen kann.
  ...
  /**
   * verwandelt die mehreren �bergebenen exceptions in eine einzige exception, so dass im stacktrace klar wird, dass
   * mehrere exceptions vorlagen, die nicht voneinander abh�ngig gewesen waren.
   * <p>
  ...
  public String getMessage() {
    refreshArgs();
    //erst versuchen mit aktueller default-sprache die fehlermeldung zu bauen. falls nicht m�glich => rollback auf gecachte fehlermeldung.
    try {
      ...
      try {
        //nicht einfach e.getMessage() aufrufen, weil das zu endlos-rekursion f�hren kann
  ...
  //TODO besserer umgang mit dynamischer lokalisierung (f�r verschiedenartige fehlermeldungen im gleichen system)
