...
public class CodeBuffer {
  ...
  /**
   * erh�ht intendation um 1, falls zeile mit { endet.
   * verringert intendation um 1, falls zeile mit } beginnt.
   * h�ngt semikolon an, falls zeile nicht mit einem der zeichen "//", "/*", "*" 
   * beginnt oder mit einem der zeichen "{", "}", ";", "," endet.
   * 
   * mehrere strings werden einfach verkettet, dann zeilenende. 
   *   verh�lt sich also genauso wie mehrfaches add(..) und dann addLB().
   * @param s
   * @return
   */
   ...
   * erh�ht die intendation um 1, falls der string mit "{" endet und danach ein zeilenumbruch folgt.
   * f�gt intendation nur an, falls dies entweder der erste methodenaufruf auf den codebuffer ist
   * oder der vorherige methodenaufruf einer mit zeilenumbruch (addLine, addLB) gewesen ist.
   * f�gt semikolon nur an, falls die zeile nicht mit einem der zeichen "}", "{", ",", ";" endet und falls danach ein zeilenumbruch folgt
   * @param s
   * @return
   */
  ...
  /**
   * f�gt "<content of s escaped>" ein, d.h. es werden anf�hrungszeichen um den string gewrappt, und alle sonderzeichen
...
//    t = t.replaceAll("\\", "\\\\");
   ...
   * 
   * f�gt die intendation nur an, falls vorher ein zeilenumbruch hinzugef�gt wurde (addLine, addLB).
   * f�gt ein ", " an, falls der n�chste codebufferpart wieder ein listenelement ist.
   * 
   * @param s
   */
