...
public abstract class ExceptionStorageInstance {
  ...
  /**
   * erstellt javaklassen f�r alle exceptioninformationen dieser instanz (ohne includes)
  ...
  /**
   * die exceptioninformationen aller includes werden rekursiv zu dieser instanz hinzugef�gt.
   * @return
   */
