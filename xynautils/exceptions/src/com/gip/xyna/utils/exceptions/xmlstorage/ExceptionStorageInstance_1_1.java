  ...
  public JavaClass[] generateJavaClasses(boolean loadFromResource, ExceptionEntryProvider provider, String xmlFile)
    ...
    try {
     ...
     /*   static {
        ...
        CodeBuffer refreshArgsMethod = new CodeBuffer("Utils"); //args m�ssen nachtr�gliche �nderungen nach dem konstruktor sinnvoll mitbekommen
        ...
        //protected constructor mit allen parametern f�r vererbung
