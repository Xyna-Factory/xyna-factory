...
/**
 * AbstractLoggerWrapper ist eine Basis f�r Wrapper der Klasse org.apache.log4j.Logger.
 * 
 * Leider kann nicht ohne Probleme eine Subklasse von Logger gebaut werden, 
 * dies wird in der Dokumentation sogar ausdr�cklich nicht empfohlen, stattdessen
 * sollten solche Wrapper verwendet werden.
 * 
 * AbstractLoggerWrapper bildet viele Methoden, die f�r einen Nachbau der Logger-Schnittstelle
