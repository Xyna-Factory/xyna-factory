 ...
 * Logger in einer JVM, eventuell m�ssen hier noch Anpassungen stattfinden,
 * damit der Server mehrere Logger �ffnen kann.
 * 
 * 
 */
@Deprecated
public class ConsoleLogger extends Logger {
   ...
   /**
    * Ausgabe von kritischen Zust�nden/Fehlern.
    * 
    * @param logMarker
    *              prefix for log line
    * @param msg
   ...
   /**
    * Ein Assert, das ein Panic ausl�st wenn 'b'=false ist.
    * 
    * @param b
    * @param string
    */
   ...
   /**
    * Liefert die Session-ID zur�ck, falls der Context gesetzt ist.
    * 
    * @param con
    *              Wenn con==null, dann kann keine Session zur�ckgeliefert
    *              werden.
    * @return
    */
   ...
   /**
    * Gibt Informationen �ber den aktuellen Speicherverbrauch der VM aus
    * 
    * @param str
    */
