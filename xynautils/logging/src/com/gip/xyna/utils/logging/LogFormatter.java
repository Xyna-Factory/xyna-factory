...
public class LogFormatter extends Formatter {
   ...
   /**
    * @param timeFormat
    *              Java-�bliches Zeitformat, oder aber 'off' um es
    *              auszuschalten.
    ...
    * Zeilennummer zur Verf�gung. Aus LogRecord kopiert und modifiziert.
    * 
    * @param record
    */
   ...
   /**
    * Expandiert einen String auf der linken Seite mit Leerzeichen bis zur Gr��e
    * size.
    * 
    * @param str
    * @param size
