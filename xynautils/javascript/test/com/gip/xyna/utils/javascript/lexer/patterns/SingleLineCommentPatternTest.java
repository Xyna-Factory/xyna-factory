 ...
 *
 */
public class SingleLineCommentPatternTest {

    private SingleLineCommentPattern pattern = new SingleLineCommentPattern();
    ...
    public void testNormalUse() {
        ...
        assertFalse(pattern.isMatchingPrefix("//foo\rbar"));
        assertFalse(pattern.isMatchingPrefix("//foo\u0085bar"));
        assertFalse(pattern.isMatchingPrefix("//foo\u2028bar"));
        assertFalse(pattern.isMatchingPrefix("//foo\u2029bar"));
        assertFalse(pattern.isMatchingPrefix("foo"));
        ...
        assertFalse(pattern.isCompleteMatch("//foo\rbar"));
        assertFalse(pattern.isCompleteMatch("//foo\u0085bar"));
        assertFalse(pattern.isCompleteMatch("//foo\u2028bar"));
        assertFalse(pattern.isCompleteMatch("//foo\u2029bar"));
        assertFalse(pattern.isCompleteMatch("foo"));
        assertFalse(pattern.isCompleteMatch(" "));
