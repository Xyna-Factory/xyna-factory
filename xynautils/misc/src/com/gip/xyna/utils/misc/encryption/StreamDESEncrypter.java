 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
package com.gip.xyna.utils.misc.encryption;
...
/**
 * Klasse zum verschl�sseln von Streams
 */
public class StreamDESEncrypter {
  ...
  /**
   * generiert einen key mittels der �bergebenen passphrase (muss 8 zeichen lang sein)
   * @param passPhrase
   * @return
   * @throws Exception
   */
  ...
  /**
   * initialisiert den encrypter. danach k�nnen mehrere streams mit dem gleichen key ver- und entschl�sselt werden.
   * @param key
   * @throws Exception
   */
  ...
  /**
   * liest die daten aus dem inputstream und schreibt sie verschl�sselt in den outputstream
   * @param in
   * @param out
   * @throws Exception
   */
  ...
  /**
   * liest die daten aus dem inputstream und schreibt sie entschl�sselt in den outputstream
   * @param in
   * @param out
   * @throws Exception
   */
