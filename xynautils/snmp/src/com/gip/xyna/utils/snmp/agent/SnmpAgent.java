...
public interface SnmpAgent {
  ...
  public abstract void setSnmpAgentLogger(SnmpAgentLogger snmpAgentLogger);

  public abstract void close();

  public static interface SnmpAgentLogger {

    void setLastReceived(int lastReceived);

    void setType(String string);

    void setLastSent(int lastSent);

    void setSuccess();

    void setFailed(SnmpRequestHandlerException e);
