...
public class Counter32VarBind extends VarBind {

  private final Long value;

  /**
   * Creates a new VarBind of type Counter32.
   * @param objectIdentifier object identifier to use.
   * @param value value to use.
   * @throws IllegalArgumentException if value is null.
   */
  public Counter32VarBind(final String objectIdentifier, final Long value) {
