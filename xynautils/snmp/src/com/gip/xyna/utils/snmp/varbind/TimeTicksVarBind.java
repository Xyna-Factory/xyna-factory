...
public class TimeTicksVarBind extends VarBind {

  private final Long value;

  /**
   * Creates a new VarBind of type TimeTicks.
   * @param objectIdentifier object identifier to use.
   * @param value value to use.
   * @throws IllegalArgumentException if value is null.
   */
  public TimeTicksVarBind(final String objectIdentifier, final Long value) {
