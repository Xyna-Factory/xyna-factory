...
public class JMSUtils {
   ...
   /**
    * Beginnt eine neue QueueSession, die f�r die �brigen Methoden ben�tigt
    * wird. F�r AQ bitte anderen Konstruktor verwenden. Dieser funktioniert �ber
    * JNDI.
    * 
    * @param url
   ...
   /**
    * Gibt die Anzahl der Nachrichten zur�ck, die sich in der Queue befinden.
    * 
    * @param queueName
    * @return
    * @throws Exception
   ...
   /**
    * Gibt alle Nachrichten in der Queue zur�ck, ohne sie auszulesen.
    * 
    * @param queueName
    * @return
    * @throws Exception
   ...
   /**
    * l�scht alle Nachrichten aus der Queue
    * 
    * @param queueName
    * @throws Exception
    */
   ...
   /**
    * l�scht alle Nachrichten mit der angegebenen correlationID aus der Queue
    * 
    * @param queueName
    * @param correlationId
    * @throws Exception
   ...
   /**
    * stellt eine neue Textnachricht mit �bergebenem Text und correlationID in
    * die Queue ein
    * 
    * @param queueName
    * @param text
   ...
   /**
    * r�umt session und connection auf.
    * 
    * @throws Exception
    */
