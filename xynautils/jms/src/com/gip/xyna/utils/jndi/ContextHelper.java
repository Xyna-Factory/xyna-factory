 ...
 * falls man den context des eigenen containers haben m�chte, ben�tigt man diese helperklasse
...
public class ContextHelper {
  ...
  /**
   * enumeration f�r die unterschiedlichen standard context factory types (oracle). <br>
  ...
  /**
   * setzt (oder l�scht bei null) den value f�r key Context.SECURITY_PRINCIPAL
   * @param user
   */
  ...
  /**
   * setzt (oder l�scht bei null) den value f�r key Context.SECURITY_CREDENTIALS
   * @param password
   */
  ...
  /**
   * setzt (oder l�scht bei null) den value f�r key Context.INITIAL_CONTEXT_FACTORY
   * @param cf
   */
  ...
  /**
   * setzt (oder l�scht bei null) den value f�r key Context.PROVIDER_URL
   * @param providerUrl
   */
  ...
  /**
   * setzt (oder l�scht bei null) den value f�r key Context.PROVIDER_URL im format <br>
  ...
  /**
   * m�glichkeit zus�tzliche parameter zu setzen
   * @param key
   * @param value
   */
   ...
   * @param indent zus�tzliche einr�ckung
