...
/**
 * Kapselt HttpURLConnection mit Util Methoden f�r Soap.
 * 
 */
public class SOAPConnector {
  ...
  public void open() throws XynaException {
    ...
    try {
      ...
      // Connection f�r Input und Output einrichten
      httpConn.setDoInput(true);
      httpConn.setDoOutput(true);
      // kein Cache, da dynamische Daten
      httpConn.setUseCaches(false);
      // Angaben zur �bertragung (siehe http://www.ietf.org/rfc/rfc2068.txt)
  ...
  /**
   * falls httpConnection offen, wird die property dort gesetzt, ansonsten beim n�chsten �ffnen
   * 
   * @param key
   * @param value
   */
  ...
  /**
   * kurz f�r setRequestProperty(PROPERTYKEY_CONTENT_TYPE, ct);
   * 
   * @param ct
   */
  ...
  /**
   * kurz f�r setRequestProperty(PROPERTYKEY_USER_AGENT, userAgent);
   * 
