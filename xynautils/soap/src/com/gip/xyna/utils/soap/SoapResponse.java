...
public class SoapResponse {
  ...
  /**
   * gibt Fehler zur�ck, oder falls kein Fehler aufgetreten ist: null.
   * @return
   */
  ...
  /**
   * gibt -1 zur�ck, falls keine httpConnection offen ist, oder eien IOException aufgetreten ist
   * @return
   */
