...
/**
 * TimeUtils sind Hilfsfunktionen, die zum �bertragen von Date und Timestamp 
 * in die DB verwendet werden.
 * 
 * Bei Timestamps wurde darauf geachtet, dass die Zeiten in UTC �bertragen 
 * und auch so gespeichert werden. Dies ist nun unabh�ngig davon, ob der 
 ...
 * GMT gemacht, der jedoch vernachl�ssigbar ist. {@link http://java.sun.com/j2se/1.5.0/docs/api/java/util/Date.html}
 * 
 * Bei Date wird keine derartige Zeitzonen�berpr�fung durchgef�hrt, da DATE
 * nicht f�r die Verwendung von Zeitzonen gedacht ist.
 * 
...
public class TimeUtils {
  ...
  /**
   * Parsen des �bergebenen Date-Strings
   * @param withMilli
   * @param string
   * @return
   * @throws SQLException
   ...
   * Format so gew�hlt, dass Angabe "UTC" der SimpleDateFormat-Ausgabe verstanden wird
   * @param paramName
   * @return
   */
  ...
  /**
   * @return benutztes DateFormat f�r Date
   */
  ...
  /**
   * @return benutztes DateFormat f�r Timestamp
   */
