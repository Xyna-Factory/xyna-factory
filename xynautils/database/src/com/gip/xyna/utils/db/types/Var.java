...
/**
 * Var<T> macht den Typen variabel: �ber get und set kann der Inhalt
 * ausgelesen und ver�ndert werden. 
 * 
 * Beispiel: ein Integer kann nur einen festen Wert haben, der 
 * zugrundeliegende int kann nicht ver�ndert werden. Mit dem 
 * Var<Integer> ist dies nun m�glich. Damit kann der Var<Integer> an 
 * verschiedenen Stellen gespeichert werden, und dann gleichzeitg an 
 * allen Stellen den Wert �ndern.
 * 
