...
/**
 * Parameterliste, in die Parameter mit Namen eingetragen werden k�nnen.
 * Dies ist bei l�ngeren Insert-Statements praktisch.
 */
public class NamedParameter {
  ...
  /**
   * �bernahme einer bereits bestehenden Parameterliste
   */
  ...
  /**
   * @return R�ckgabe der Platzhalter f�r Aufruf einer StoredProcesdure in der Form
   * "name1=>?,name2=>?"
   */
  ...
  /**
   * @return R�ckgabe der Platzhalter f�r Aufruf eines Updates in der Form
  "name1=?,name2=?"
   */
  ...
  /**
   * Bau eines Strings, der alle Namen aus names enth�lt, an jeden Namen wird
   * appendix angeh�ngt
   * @param appendix
   * @return
   */
