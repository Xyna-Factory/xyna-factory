 ...
 * Die Connections sollten markiert werden, um in der DB pr�fen zu k�nnen,
 * wer welche Connection ge�ffnet hat.
 */
...
/**
   ...
   * Auch die Falschschreibung user/passwd@localhost:1521/xynadb ist zul�ssig
   * @param clientInfo
   * @return
   */
  ...
  public static void markConnection(Connection connection, String clientInfo) {
    ...
    try{
      ...
      //Ein Fehler hier ist wenig sch�n, da die Connection nicht markiert ist, 
      //aber da kein Logger vorhanden ist, wird der Fehler unterdr�ckt, damit 
  ...
  /**
   * @deprecated diese methode ist absichtlich nicht public und gibt es nur aus abw�rtskompatibilit�tsgr�nden, um zu erlauben, dass man
