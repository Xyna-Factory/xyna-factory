...
public class SQLUtils {
   ...
   /**
    * Cachet das PreparedStatement zur sp�teren Wiederverwendung Achtung: nicht
    * f�r Callable-Statements verwendbar
    * 
    * @param sql
    */
   ...
   /**
    * Ausf�hrung einer DML-Statements (Insert, Update, Delete)
    * 
    * @param stmt
    * @return
    * @throws SQLException
   ...
   /**
    * Lesen der ersten Zeile des ResultSets und Ausf�hrung der
   ...
   /**
    * Lesen des ResultSets und Ausf�hrung der resultSetReaderFunction f�r jede
    * Zeile
    * 
    * @param rs
    * @param resultSetReaderFunction
   ...
   /**
    * Schlie�en des ResultSets und des PreparedStatements
    * 
    * @param rs
    * @param stmt
    */
   public void finallyClose(ResultSet rs, PreparedStatement stmt) {
      ...
      if (stmt != null) {
         if (statementCache == null || (!statementCache.contains(stmt))) {
            // Statement nur schlie�en, wenn Stament nicht dem Cache geh�rt
            try {
               stmt.close();
            } catch (SQLException e) {
            }
  ...
  /**
   * @deprecated diese methode soll nur erm�glichen, dass closeconnection nicht immer markConnection aufruft.
   ...
   */
   ...
   /**
    * Kapselung f�r ein Select, welches einen einzigen Integer zur�ckliefert
    * 
    * @param sql
    * @param params
    *           Parameter, die dem PreparedStatement �bergeben werden sollen
   ...
   /**
    * Kapselung f�r ein Select, welches eine einzige Zeile zur�ckliefert
    * 
    * @param sql
    * @param params
    *           Parameter, die dem PreparedStatement �bergeben werden sollen
    * @return R�ckgabe des resultSetReader, null bei Lesefehler
    */
   ...
   /**
    * Kapselung f�r ein Select, welches mehrere Zeilen zur�ckliefert
    * 
    * @param sql
    * @param params
    *           Parameter, die dem PreparedStatement �bergeben werden sollen
    * @return ArrayList mit R�ckgaben des resultSetReader, null bei Lesefehler
    */
   ...
   /**
    * Kapselung f�r ein Select, welches mehrere Zeilen zur�ckliefert, f�r jede
   ...
   /**
    * Kapselung f�r ein DML-Statement (Insert, Update, Delete)
    * 
    * @param sql
    * @param params
    *           Parameter, die dem PreparedStatement �bergeben werden sollen
   ...
   * 1 zurueckgegeben, welches den Fehlercode -2 (f�r UniqueConstraintViolation), -1 bei sonstigen Fehlern
   ...
   * Operation enth�lt (Anzahl der modifizierten Zeilen).
   */
  public int[] executeDMLBatch(String sql, Parameter... params) {
   ...
   /**
    * Kapselung f�r ein DDL-Statement
    * 
    * @param sql
    * @param params
    *           Parameter, die dem PreparedStatement �bergeben werden sollen
    * @return true bei erfolgreicher Ausf�hrung
    */
   ...
   /**
    * Kapselung f�r einen Aufruf einer Stored-Prozedure/Function
    * 
    * @param sql
    * @param params
    *           Array der dem PreparedStatement zu �bergebenden Parameter
    * @return true bei erfolgreicher Ausf�hrung (keine Exception)
    */
  ...
  /**
   * Kapselung f�r einen Aufruf eines Code-Blocks
   * @param sql
   * @param params
   * @return
   */
  ...
  private void registerOutputParameter(CallableStatement stmt, int i, OutputParam<?> output) throws SQLException {
     ...
     if (output.get() != null) { // f�r IN-OUT-Parameter
  ...
  /**
   ...
   /**
    * R�ckgabe der zuletzt aufgetretenen SQLException, null falls keine
    * Exception auftrat
    * 
    * @return
    */
   ...
   /**
    * Setzen der LastException in Sonderf�llen: Exception ist au�erhalb der SQLUtils 
    * aufgetreten, soll aber intern sein, z.B. f�r LogLastException 
    * @param exception
    */
   ...
   /**
    * Sollen bei einem Query Null-Elemente in der Liste zur�ckgegeben werden, falls der ResultSetReader Null-Elemente erzeugt?
    */
