 ...
 * zuerst die abstrakte Methode "lastSQL(String sql)" ausf�hren und "rollback" und "commit" zuerst 
 * "lastCommitOrRollback(boolean commit)" ausf�hren. Damit kann beispielsweise ein besonderes Logging
 * verwendet werden.
 */
