...
public class BLOB {
  ...
  /**
   * Einfacher Konstruktor, danach kann dann mit setDataAsString oder getOutputStream().write(..) der BLOB gef�llt werden
  ...
  /**
   * Direktes �bergeben der BLOB-Daten als ByteArrayOutputStream
   * @param data
   */
  ...
  /**
   * Kann �berschrieben werden, um andere ZipStreams zu verwenden, oder Einstellungen am Stream zu �ndern (z.B. Buffersize).
