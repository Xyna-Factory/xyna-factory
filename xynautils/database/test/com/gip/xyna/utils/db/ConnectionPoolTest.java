...
public class ConnectionPoolTest extends TestCase {
  ...
  public void testGetConnectionBeforeTimeout() throws Exception {
    //threads warten zuf�llige zeit, neue threads haben timeout > zuf�llige zeit und bekommen deshalb connections.
    //andere threads haben timeout < zuf�llige zeit und bekommen deshalb keine connection
  ...
  public void testOrderOfConnectionsForThreads() throws Exception {
    ...
    //dann �berpr�fen, dass der richtige thread sie bekommt.
  ...
  public void testRefreshConnectionPoolNoForceClose() throws Exception {
    ...
    //testen, dass genau poolSize neue connections zur verf�gung stehen
    for (int i = 0; i<connectionPoolSize; i++) {
      Connection con = cp.getConnection(1000, "");
      connections.add(con);
