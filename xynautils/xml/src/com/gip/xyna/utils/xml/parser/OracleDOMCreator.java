...
public class OracleDOMCreator {
   ...
   /**
    * parst den xml-String und gibt das zugeh�rige xmldocument zur�ck
    * 
    * @param xml
    * @return
    * @throws Exception
   ...
   /**
    * parst das xml in dem �bergebenen filenamen und gibt das zugeh�rige
    * xmldocument zur�ck
    * 
    * @param file
    * @return
   ...
   /**
    * f�gt eine referenz auf den nachrichtennamen aus dem xsd-file filename in
   ...
   public static XMLDocument mergeMessage(XMLDocument xsd, String fileName,
      ...
      // namespace abk�rzung definieren
