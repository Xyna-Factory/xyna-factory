...
/**
 */
public class ModifyOrderType extends OrderTypeTask {
  ...
  protected String getMessage() {
    ...
    buffer.append("<ns1:modifyOrderTypeRequest xmlns:ns1=\"" + NAMESPACE_MSGS + "\">");
    ...
    buffer.append("</ns1:modifyOrderTypeRequest>");
  ...
  protected String getSOAPAction() {
    return NAMESPACE_OPERATION + "/modifyOrderType";
  }
