...
public class ExistsApplication implements Condition {
  ...
  /**
   * �berpr�ft, ob die application "appName" im durch die anderen Parameter beschriebenen oc4j deployed ist.
   * @return
          ...
          if (tm instanceof TargetModuleIDImpl) {
            ...
            /* DataSourceInfo[] dsilist = tmi.getDataSources();
              for (DataSourceInfo dsi : dsilist) {
                System.out.println("ds = " + dsi.getDisplayName());
              }*/
            if (tmi.getObjectName().getKeyProperty("name").equals(appName)) {
              return true;
            }
  ...
  public static void main(String[] args) {
    try {
      ExistsApplication ea = new ExistsApplication();
      ea.appName = "ExecutionDispatcher";
