...
public class XynaNode implements JSONObject, XMLObject {
   ...
   /**
    * value = null => attribut wird gel�scht
    * 
    * @param name
    * @param value
    */
    ...
    * Node geh�rt (Kurz!). Ist ein Feld nicht gesetzt, wird "null" in den
   ...
   /**
    * Erzeugt im JSON-Format einen String der den Baum beschreibt, der zu dieser
    * Node geh�rt (Ausf�hrliche 1:1 Abbildung der Felder dieser Klasse). Ist ein
   ...
   public String getType() throws Exception {
      if (value != null) {
         ...
         // TODO ggfs hier erweitern f�r beliebige objekte mittels
         // reflection?!
