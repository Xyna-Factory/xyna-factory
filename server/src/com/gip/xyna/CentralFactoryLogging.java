...
/**
 * hier sollen sp�ter logger programmatisch ermittelt und ge�ndert werden k�nnen.
 */
public class CentralFactoryLogging {
  ...
  public static void setLogLevel(String loggerName, String levelString) { 
    ...
    if (loggerConfig == null) {
      //noch keine Config f�r diesen Logger vorhanden, daher nun eine neue anlegen,
      //damit nicht die Parent-Config �berschrieben wird.
  ...
  /*
   * TODO suspend-resume unterst�tzung. 
   *      statistiken pro ordertype
   *      aufr�umen von daten: 
   *        - fertiggelaufene auftr�ge separat von laufenden handhaben
  ...
  private static void logOrderTimingInternal(long id, String s, long t) {
    ...
    if (l.size() < NUMBER_ORDERTIMING_CALLS * 16) { //threadpool voll -> scheduler macht retries, die zu mehrfachen aufrufen f�hren
