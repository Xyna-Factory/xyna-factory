...
/**
 * kapselt die informationen �ber die svn �nderungen an einer xyna komponente
 */
public class ComponentCodeChange implements Serializable {
  ...
  protected List<ComponentCodeChange> changedSubComponent = new ArrayList<ComponentCodeChange>(); //bei shared libs die infos zu den ge�nderten sharedlib jars (ohne .jar endung)
  ...
  /**
   * pfad ab Komponententyp (trigger/filter, etc) innerhalb des lokal ausgecheckten svn, der folgende kinder enth�lt:
   * - src
   * - lib
   * etc. 
