...
public interface GeneralXynaObject extends Serializable {
  ...
  public static class XMLReferenceCache {
    ...
    /*
     * es werden immer negative ids zur�ckgegeben, die h�her als LONG.MAX_VALUE/2 sind.
     * d.h. ea funktioniert so, als w�re jedes �bergebene object anders/neu
     */
    ...
    /**
     * checkt, ob version bereits eine id zugeordnet hat. falls ja, wird die version zur�ckgegeben. falls nein, wird die negative neue versionsnummer zur�ckgegeben
     */
    //vorteil: hinzuf�gen und gleichzeitiger check auf gleichheit (teures equal+hashcode) muss so nur einmal durchgef�hrt werden
    ...
    private void addAuditImport(GeneralXynaObject xo) {
      ...
      //keine rekursion notwendig, weil f�r die kindobjekte diese methode ebenso aufgerufen wird bei toXml()
    }
