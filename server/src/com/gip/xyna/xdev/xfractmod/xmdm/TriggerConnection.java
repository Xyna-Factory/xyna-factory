...
public abstract class TriggerConnection implements Serializable {
  ...
  /**
   * beim �berschreiben immer super.close() aufrufen!!
   * pflegt die anzahl der gleichzeitig �ber den gleichen trigger gestarteten, laufenden auftr�ge.
   * beim close() wird die anzahl um eins verringert.
   * 
   * das close wird automatisch aufgerufen, und muss mehrfach aufgerufen werden k�nnen.
   */
  public synchronized void close() {
    ...
    if (trigger != null) {
      ...
      //TODO counter nach neustart weiterz�hlen? dann m�sste man den trigger anderweitig identifizieren um den korrekten counter zu finden. siehe eventlistener-todo
    }
  }
