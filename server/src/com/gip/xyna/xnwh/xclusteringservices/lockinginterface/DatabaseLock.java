...
public interface DatabaseLock {
  ...
  /**
   * Holen des Locks mit �bergabe der zum Lock zu verwendenden Connection
   * @throws LockFailedException
   */
  ...
  /**
   * R�ckgabe des Locks
   * @throws AlreadyUnlockedException falls erkannt werden konnte, dass das Lock bereits zur�ckgegeben wurde
   */
  public void unlock() throws AlreadyUnlockedException;

  /**
   * FIXME wird dies wirklich ben�tigt? Was soll es genau machen? 
   * Wartende Statements k�nnen nicht abgebrochen werden
   */
