 ...
 * 
 * Diese DatabaseLock erf�llt das {@link java.util.concurrent.locks.Lock}-Interface, jedoch kann 
 ...
 * In den Methoden setUseConnection() und lock() wird in Fehlerf�llen blockiert und Retries probiert,
...
public class ClusterLockingInterface extends FunctionGroup {
  ...
  public DatabaseLock createLockIfNonexistent(String name, DatabaseLockType databaseLockType)
    ...
    if (previousLock != null) {
      // Das alte lock muss in dem Fall nicht gel�scht werden, weil die Objekte nur einen
