...
public class TimeSeries {
  ...
  /**
   * liefert daten zwischen start- und endzeit bzgl der �bergebenen resolution und aggregation.
   * 
   * falls konvertierung nicht unterst�tzt, kann es sein, dass sowohl start- und endzeit, als auch resolution im result anders sind.
   * 
   * @param resolutionMS gew�nschte gr��e der buckets in millisekunden, bzgl der die daten zur�ckgegeben werden. bsp: 900000 =&gt; jeder zur�ckgegebene wert entspricht einer aggregation �ber 15 minuten.
