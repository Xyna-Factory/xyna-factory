...
public class SecuredStorable extends Storable<SecuredStorable> {
  ...
  @Column(name="id", size=255) //achtung bei h�heren werten. bei mysql k�nnen indizes maximal 767 bytes lang sein (encoding utf8 kann die stringl�nger vervielfachen)
  private String id;
