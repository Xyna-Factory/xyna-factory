...
public interface PersistenceLayer {
  ...
  /**
   * Gibt eine Connection zur�ck, die spezifisch zu dem PersistenceLayer ist. Kann intern zb �ber eine HashMap&lt;args, ConPool&gt;
  ...
  /**
   * wie {@link #getConnection()}, aber verwendet die innere Connection von der �bergebenen Connection (aus dem gleichen Pool!)
   * Achtung: Die innere connection wird dann nicht beim close geschlossen - sondern nur beim close der connection, die die innere connection ge�ffnet hat.
   */
  ...
  /**
   * Welche Parameter frisst die init Methode? f�r jeden Parameter einen beschreibenden String
   */
  public String[] getParameterInformation();

  /**
   * gibt true zur�ck, falls beide PersistenceLayer auf den gleichen Tabellen arbeiten, und dadurch zb Locks in dem einen
   * PersistenceLayer mit Locks vom anderen kollidieren k�nnen.
   */
  public boolean describesSamePhysicalTables(PersistenceLayer plc);

  /**
   * gibt true zur�ck, falls beide PersistenceLayer den gleichen ConnectionPool verwenden
   */
