...
/**
 * LocalODSCon kapselt eine �bergebene Connection, die null sein kann, und stellt in diesem Fall 
 * eine eigene lokale ODSConnection zu Verf�gung. 
 * Beispiel:
 * <pre>
...
public class LocalODSCon {
  ...
  /**
   * Liefert die Connection, dabei sind 3 F�lle m�glich: a) null, b) lokale Connection 
  ...
  /**
   * Ist Connection lokal ge�ffnet worden?
   * @return
   */
  ...
  /**
   * Commit bei lokaler Connection, externe Connection bleibt unver�ndert
  ...
  /**
   * Rollback bei lokaler Connection, externe Connection bleibt unver�ndert
   * @throws PersistenceLayerException
   */
  ...
  /**
   * Schlie�en der lokalen Connection, externe Connection bleibt unver�ndert
   * @throws PersistenceLayerException
   */
  ...
  /**
   * LocalODSCon hat sicher eine Connection != null. Falls con null ist, wird eine neue DEFAULT-Connection lokal ge�ffnet
   * @param con
   * @return
   */
  ...
  /**
   * LocalODSCon hat sicher eine Connection != null. Falls con null ist, wird eine neue HISTORY-Connection lokal ge�ffnet
   * @param con
   * @return
   */
