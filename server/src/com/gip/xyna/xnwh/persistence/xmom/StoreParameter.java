...
public class StoreParameter {
  ...
  private boolean forceRecursiveStore;
  
  public StoreParameter(boolean historizePreviousObject, boolean keepMetaFieldData, boolean forceRecursiveStore) {
    this.historizePreviousObject = historizePreviousObject;
    this.keepMetaFieldData = keepMetaFieldData;
    this.forceRecursiveStore = forceRecursiveStore;
  }
  ...
  public boolean doForceRecursiveStore() {
    return forceRecursiveStore;
  }
