...
public class DeleteParameter {
 ...
 /**
  * - recursive: Alle abh�ngigen XMOM Storables rekursiv l�schen. Dabei wird jeweils auch das Verhalten f�r R�ckw�rtsreferenzen beachtet.
  * - keep: Referenzierte Objekte werden nicht gel�scht sondern bleiben bestehen
  */
  ...
  /**
   * - cascade: Alle XMOM Storables, die ein zu l�schendes XMOM Storable referenzieren, werden ebenso gel�scht. Rekursiv
   * - error: Default. Fehler, falls eine solche Abh�ngigkeit festgestellt wird
   * - delete: Das Objekt wird entfernt. Andere XMOM Storables, die dieses Objekt referenzieren, referenzieren es jetzt nicht mehr, sind aber noch funktionst�chtig.
   * 
