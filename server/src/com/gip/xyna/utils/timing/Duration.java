 ...
 * M�gliche Einheiten sind {Tag "d", Stunde "h", Minute "min", Sekunde "s", Milli- "ms", Mikro- "�s" und Nanosekunde "ns"}
 * Diese Einheiten ergeben sich aus der vollst�ndigen Abdeckung der Konstanten aus {@link java.util.concurrent.TimeUnit TimeUnit}.
 * Eine Kombination "4 min 30 s" ist nicht m�glich!
 * 
 * Equals und Hash ber�cksichtigen nur die Zeit in Millisekunden, d.h. "60 s" und "1 min" sind gleich.
 */
public class Duration implements StringSerializable<Duration>, Serializable {
  private static final long serialVersionUID = 1L;
  private static final String P_STRING = "(\\d+)\\s*(d|h|min|s|ms|�s|ns|)";
  ...
  static { //komische Bef�llung, da Java 1.5 keine MINUTES, HOURS und DAYS kennt
    addUnit( UNITSIZE, 0, "ns");
    addUnit( UNITSIZE, 1, "�s");
  ...
  public static Duration valueOfSum(String string) {
    ...
    //Separatoren werden nicht erwartet, diese f�hren unten zu einer IllegalArgumentException 
  ...
  /**
   * Konvertiert Duration in andere Einheit. Achtung: bei Konversion in gr��ere Einheit kann Pr�zisionsverlust auftreten!
   * @param unit
