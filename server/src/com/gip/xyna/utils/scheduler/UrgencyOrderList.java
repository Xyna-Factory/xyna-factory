...
/**
 * Speicherung der zu scheduulenden Auftr�ge sortiert nach Urgency und gruppiert nach Tags, 
 * um ganze Tag-Gruppen �berspringen zu k�nnen. 
 *
 */
public class UrgencyOrderList<O> extends TaggedOrderedCollection<Urgency<O>> {
  ...
  /**
  * Wrapper f�r einen Auftrag O, damit die berechnete Urgency gespeichert werden kann. 
  ...
  */
  public static class Urgency<O> implements Comparable<Urgency<O>> {
    ...
    public int compareTo(Urgency<O> uo) {
      //hohe Urgency zuerst, d.h hier anderes Vorzeichen als �blich
      //return (o.urgency < urgency ? -1 : (o.urgency == urgency ? 0 : 1));
      if( uo.urgency < urgency ) {
        return -1; //h�here Urgency, d.h nach vorne
