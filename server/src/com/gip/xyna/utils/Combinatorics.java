...
public class Combinatorics {
  ...
  /**
   * Ruft den CombinationHandler f�r jede Kombination von n Zahlen zwischen 0 und propertyCounts[i] auf.
   * <br>
   ...
   * ]
   * <br>
   * Bricht ab, wenn der CombinationHandler false zur�ckgibt.
   */
