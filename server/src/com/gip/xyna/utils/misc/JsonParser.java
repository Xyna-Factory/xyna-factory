...
public class JsonParser {
  ...
  public interface JsonVisitor<T> {
    ...
    public enum Type { Null, String, Boolean, Number, Object, Mixed /*Achtung, wenn eine Liste Mixed ist, dann ist es nicht mehr m�glich pro Element die Typinformation wiederherzustellen*/ }
  ...
  private static class JsonTokenVisitorStackImpl implements JsonTokenVisitor {
    ...
    public void curlyBraceOpen() throws UnexpectedJSONContentException {
      ...
      //FIXME Unsch�n: F�r jedes Listenelement wird nach JsonVisitor gefragt
    }
