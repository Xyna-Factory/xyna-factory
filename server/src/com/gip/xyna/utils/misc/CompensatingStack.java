 ...
 * ausf�hren zu k�nnen und nach einem Fehler alle bereits ausgef�hrten Operationen kompensieren
 * zu k�nnen. 
 * <br>
 * Beispiel
 * <pre>
 ...
 * Die Klasse DoThreeOps m�sste nicht implementiert werden, der CompensatingStack ist auch direkt verwendbar.
 * Wichtig ist allerdings, dass die einzelnen Operationen das Interface {@link CompensatableStep} erf�llen.
 */
public class CompensatingStack {
   ...
   * darf beliebige Exceptions werfen, die dann w�hrende der Kompensation gesammelt werden
   *
   */
  ...
  /**
   * Eintragen des CompensatableStep, damit Kompensation ausgef�hrt werden kann
   * @param step
   */
  ...
  /**
   * Markierung, dass alle Operationen erfolgreich waren, demzufolge keine Kompensation n�tig ist
   */
  public void success() {
  ...
  /**
   * F�hrt die Kompensation aus. Alle dabei auftretenden Exceptions werden gesammelt
   */
  ...
  /**
   * Hinzuf�gen einer weiteren Exception, die beim Kompensieren aufgetreten ist
   * @param comment
   * @param e
   */
  ...
  /**
   * @return Sind Exceptions w�hrend der Kompensation aufgetreten?
   */
  ...
  /**
   * Ausgabe aller w�hrend der Kompensation aufgetretenen Exceptions
   * @return
   */
