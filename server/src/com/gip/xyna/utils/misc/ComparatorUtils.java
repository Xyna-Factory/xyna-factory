 ...
 * Erm�glicht auch Vergleich null mit Objekt mit definierter Sortierung.
 *
 */
public class ComparatorUtils {
   ...
   * Ansonsten wird die (notwendige) Implementierung von NotComparableHandler ausgef�hrt.
   *
   */
   ...
   * zu vergleichenden T-Objekte anwendet, bis diese einen Wert != 0 zur�ckgeben.
