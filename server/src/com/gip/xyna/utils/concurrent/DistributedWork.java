...
/**
 * utilklasse zum angenehmen verteilten abarbeiten von mehreren aufgaben �ber mehrere threads hinweg.
 * 
 ...
 * work.waitForCompletion(); //aufruf wartet nur, falls nicht rekursiv aufgerufen, ansonsten kommt er sofort zur�ck. das ist dann okay.
 * </pre>
...
public class DistributedWork {
  ...
  /**
   * gibt -1 zur�ck, falls kein weiteres offenes task vorhanden ist
   */
