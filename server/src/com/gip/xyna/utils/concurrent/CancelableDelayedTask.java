 ...
 * einer vorher definierten Wartezeit ausf�hren. Dabei k�nnen die eingestellten 
 * Tasks �ber cancel() abgebrochen werden oder ein Thread kann �ber join() auf 
 * die Ausf�hrung warten.
 * Es k�nnen mehrere Runnables gleichzeitig aktiv sein
 * 
 ...
 *    //Task konnte nicht mehr gecancelt werden, daher auf vollst�ndige Ausf�hrung warten
 *    cdt.Join(id);
 *  }
 */
public class CancelableDelayedTask {
  ...
  /**
   * @param name Name der ausf�hrenden Threads
   */
   ...
   * @param delay
   * @param task
   * @return Id, mit der cancel oder join aufgerufen werden k�nnen
   */
  ...
  /**
   * Abbrechen des �ber schedule(...) eingestellten Runnable. Achtung: ausf�hrender Thread 
   * wird interupted, dies kann auch das ausgef�hrte Runnable treffen.
   * @param id
   ...
   * @param id
   * @return Status, ob Auftrag ausgef�hrt wurde
