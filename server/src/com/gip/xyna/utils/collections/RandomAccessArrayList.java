...
/**
 * RandomAccessArrayList bietet anders als die �bliche ArrayList einen beliebigen Zugriff �ber den Index,
 * ohne eine Exception zu werfen, wenn der Index zu hoch ist. 
 * Stattdessen werden sinnvolle Operationen durchgef�hrt:
 * - set(index,E element) und add(int index, E element) vergr��ern die Liste entsprechend
 * - get(index) und remove(index) geben null zur�ck
 * Negative Indexe f�hren zum gewohnten Fehler
 * 
 * FIXME vollst�ndig implementieren! listIterator, subList, ?resize()?
 * 
 */
