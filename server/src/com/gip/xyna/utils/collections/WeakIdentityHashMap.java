...
/*
 * kopiert + leichte �nderungen von WeakHashMap:
 * - HashMap.hash() ersetzt durch System.identityHashCode()
 * - memberVariablen values und keySet erg�nzt, weil auf packageprivate members von parentklasse zugegriffen wurde
...
public class WeakIdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V> {
  ...
  //aus abstractmap kopiert. sollte f�r die verwendung hier keinen unterschied machen
