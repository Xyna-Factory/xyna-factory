...
/**
 * RandomizingBlockingQueue ist eine Queue, aus der Elemente in einer zuf�lligen Reihenfolge gezogen werden k�nnen.
 * - offer(element) tr�gt dabei die Elemente ein, null ist nicht erlaubt
 * - poll oder take entfernen ein zuf�lliges Element aus der Queue und geben dieses zur�ck;
