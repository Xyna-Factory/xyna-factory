...
public class CounterMap<K> extends WrappedMap<K, AtomicInteger> {
  ...
  /**
   * Gibt analog zu entrySet() alle Eintr�ge der Map aus, nun aber in einer Liste sortiert nach dem Count.
   * �ber die zur�ckgegebene Liste kann der Z�hlerstand ge�ndert werden! 
   * @param descending
   * @return
   */
