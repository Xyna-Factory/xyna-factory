...
public abstract class ObjectWithRemovalSupport {
   ...
   *  es wird sichergestellt, dass nach dem entfernen nichts mehr ge�ndert wird
   */
  ...
  /**
   * Wird ggfs mehrfach aufgerufen. Objekt wird nur aus Map entfernt, wenn diese Methode true zur�ck gibt.
   */
