...
public class CollectionUtils {
  ...
  /**
   * Transformation: die Methode transform berechnet aus dem �bergebenen From-Object das To-Object.
   *
   * @param <F> From-Typ
   * @param <T> To-Typ
   */
  ...
  /**
   * Filter: R�ckgabe gibt an, ob Value in der Ausgabe erscheint (true)
   *
   * @param <T> type
   */
  ...
  /**
   * Transformiert alle Elemente aus from und tr�gt diese in to ein
   * @param from
   * @param transformation
   * @param to
   */
  ...
  /**
   * Transformiert die Values der �bergebenen Map und liefert eine neue Map zur�ck.
   * @param from
   * @param transformation
   * @return
   */
  ...
  /**
   * Transformiert die Values der �bergebenen Map in die zweite �bergebene Map.
   * @param from
   * @param transformation
   * @param to
   */
  ...
  /**
   * Transformiert die Values der �bergebenen Map und liefert eine neue Map zur�ck; die neue Map enth�lt 
   * nur die Eintr�ge, f�r die die Transformation als Ergebnis keine null liefert.
   * @param from
   * @param transformation
   * @return
   */
  ...
  /**
   * Transformiert die Values der �bergebenen Map in die zweite �bergebene Map; die zweite Map erh�lt 
   * nur die Eintr�ge, f�r die die Transformation als Ergebnis keine null liefert.
   * @param from
   * @param transformation
   * @param to
  ...
  /**
   * Gibt die Mengen-Differenz Menge(all) ohne Menge(without) zur�ck.
   * @param all
   * @param without
   * @return
   */
  ...
  /**
   * Liefert die Werte aus der Map f�r die angegeben Keys.
   * @param map
   * @param keys
   * @return
   */
