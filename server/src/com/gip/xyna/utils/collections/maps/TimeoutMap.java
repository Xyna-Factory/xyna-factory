...
/**
 * TimeoutMap speichert wie eine Map, verliert die Eintr�ge jedoch nach einem Timeout, 
...
public class TimeoutMap<K,V> implements Map<K,V> {
  ...
  /**
   * wird bei jeder Map-Operation gerufen, um alte Eintr�ge zu entfernen
   */
  ...
  public boolean refresh(K key, long timeToLive) {
    ...
    while( removed ) { //Mehrfacheintr�ge entfernen
   ...
   * k�nnte w�hrenddessen Timeout sehen und map anschlie�end leeren...
   * @param key
   * @param value
   * @param timeToLive
   * @return
