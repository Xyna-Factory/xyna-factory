 ...
 * <li>Dabei bekommt ein Object (dessen HashCode sich nicht �ndert!) immer den gleichen Wert 
 ...
 * <li>�ber das Interface {@link com.gip.xyna.utils.collections.HashCodeMap.Constructor Constructor&lt;T&gt;}
...
public class HashCodeMap<T> implements Map<Object,T> {
   ...
   * um eine Basisbelegung der Map zu erzeugen. F�r jeden Eintrag wird die Methode {@link #newInstance() newInstance} gerufen.
   */
  ...
  /**
   * Capacity 32, kein Konstruktor f�r Values
   */
  public HashCodeMap() {
    this(32,null);
  }
  ...
  /**
   * Capacity und Constructor werden angegeben, �ber den Constructor wird eine Basisbelegung der Map erzeugt.
   * @param capacity
   * @param constructor
   */
