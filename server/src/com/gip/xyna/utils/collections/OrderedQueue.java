...
/**
 * OrderedQueue ist eine Queue-Implementierung, bei der alle Eintr�ge durch die 
 * nat�rliche Ordnung durch Comparable&lt;E&gt; angeordnet sind.
 * Dadurch haben offer(E o) und add(E o) ein O(N)-Verhalten.
 * �ber refresh() kann der erste Eintrag wieder neu einsortiert werden, wenn  
 * sein Ordnungskriterium ge�ndert wurde.
 */
