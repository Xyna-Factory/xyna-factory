...
public abstract class PullStatistics<S extends Serializable, T extends StatisticsValue<S>> extends Statistics<S, T> {

  public PullStatistics(StatisticsPath path) {
    super(path);
  }
