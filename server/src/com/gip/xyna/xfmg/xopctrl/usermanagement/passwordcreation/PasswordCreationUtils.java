...
public class PasswordCreationUtils {
  ...
  /**
   * Idee: hashe einmal zwischen GUI und Server, und einmal extra f�r die Datenbank. Vgl EncryptionPhase
   * F�lle: Konfigurierte HashFunktionen f�r Phase1+Phase2 Hashing (XynaProperty):
   *    1) (null, null)
   *    2) (X, null)
   *    3) (null, Y)
   *    4) (X, Y)
