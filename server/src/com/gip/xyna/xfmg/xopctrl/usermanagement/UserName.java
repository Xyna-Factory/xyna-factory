...
@XynaObjectAnnotation(fqXmlName = "xfmg.xopctrl.UserName")
public class UserName extends XynaObject {

  private static final long serialVersionUID = 8878808298545850091L;
  private static final Logger logger = CentralFactoryLogging.getLogger(UserName.class);
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends UserName, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>>  {

    protected _GEN_DOM_TYPE instance;

    protected InternalBuilder(UserName instance) {
      this.instance = (_GEN_DOM_TYPE) instance;
    }

    public UserName instance() {
  ...
  public static class Builder extends InternalBuilder<UserName, Builder> {
    public Builder() {
      super(new UserName());
    }
    public Builder(UserName instance) {
      super(instance);
    }
  }

  public Builder buildUserName() {
  ...
  */
  ...
  protected void fillVars(UserName source, boolean deep) {
  ...
  public UserName clone(boolean deep) {
    UserName cloned = new UserName();
  ...
  public static class ObjectVersion extends com.gip.xyna.xdev.xfractmod.xmdm.XOUtils.ObjectVersionBase {
    ...
    protected boolean memberEquals(com.gip.xyna.xdev.xfractmod.xmdm.XOUtils.ObjectVersionBase o) {
      ...
      UserName xoc = (UserName) xo;
      UserName xoco = (UserName) other.xo;
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "UserName", "xfmg.xopctrl", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
  ...
  */
  ...
  public static Field getField(String target_fieldname) throws InvalidObjectPathException {
    ...
    try {
      foundField = UserName.class.getDeclaredField(target_fieldname);
      if (foundField == null) {
