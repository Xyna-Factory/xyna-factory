...
public class SessionUserMap {
  ...
  //TODO user-Eintrag aus userToSessions entfernen, wenn der user gel�scht wird
  ...
  /**
   * Tr�gt eine Session mit zugeh�rigem User in die Maps ein.
   * @param sessionId
   * @param user
  ...
  /**
   * Liefert die SessionIds f�r einen User
   * @param user
   * @return
   */
  ...
  /**
   * Tr�gt gesperrte User in die lockedUser-Liste bzw. entfernt nicht gesperrte User.
   * @param user
   */
