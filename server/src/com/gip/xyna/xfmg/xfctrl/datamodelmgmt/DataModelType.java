...
/**
 * DataModelType sammelt die Methoden, die alle konkreten DataModelType-Implementierungen erf�llen m�ssen.
 * 
...
public interface DataModelType {
  ...
  /**
   * Initialisierung des DataModelTypes, R�ckgabe der initialen PluginDescription
  ...
  /**
   * Konfiguration der Default-Parameter, R�ckgabe der angepassten PluginDescription
   * @param paramMap
   * @return PluginDescription
   */
   ...
   * Diese sollte vom DataModelType gecacht werden, da showDescription() h�ufiger gerufen werden kann
   * @return PluginDescription
   */
