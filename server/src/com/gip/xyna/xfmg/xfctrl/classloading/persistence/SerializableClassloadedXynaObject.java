...
public class SerializableClassloadedXynaObject implements Serializable {
  ...
  /**
   * F�r Container und Listen gen�gt ein mdm classloader. Falls die liste auch abgeleitete klassen enth�lt, muss der
   * classloader die klassen durch delegation finden k�nnen.
   */
  private void getRelevantClassLoadersRecursively(GeneralXynaObject xo, Set<ClassLoader> classloaders) {
    ...
    if (xo instanceof GeneralXynaObjectList) {
      ...
      // Achtung, es muss in solchen Objekten z.b. �ber writeObject sichergestellt werden, dass membervariablen korrekt behandelt werden
    }
  }
