...
@Persistable(primaryKey = XMOMExceptionDatabaseEntry.COL_ID, tableName = XMOMExceptionDatabaseEntry.TABLENAME)
public class XMOMExceptionDatabaseEntry extends XMOMDomOrExceptionDatabaseEntry {
  ...
  public XMOMExceptionDatabaseEntry(String fqname, Long revision) {
