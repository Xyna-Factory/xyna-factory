...
public abstract class XMOMDomOrExceptionDatabaseEntry extends XMOMDatabaseEntry {
  ...
  public static final String COL_USEDINIMPLOF = "usedInImplOf";
  ...
  @Column(name = COL_USEDINIMPLOF, size = 1000)
  protected String usedInImplOf;
  ...
  public XMOMDomOrExceptionDatabaseEntry(String fqname, Long revision) {
  ...
  public XMOMDomOrExceptionDatabaseEntry(DomOrExceptionGenerationBase object) {
    super(object.getOriginalFqName(), object.getLabel(), object.getOriginalPath(), object.getOriginalSimpleName(), "", object.getXmlRootTagMetdata(), object.isXynaFactoryComponent(), object.getRevision());
    isExtending = retrieveSuperClasses(object);
    possesses = concatVariables(object.getAllMemberVarsIncludingInherited());
    setTimestamp(object.getParsingTimestamp());
  }
  ...
  public String getUsedInImplOf() {
    return usedInImplOf;
  }
  
  
  public void setUsedInImplOf(String usedInImplOf) {
    this.usedInImplOf = usedInImplOf;
  }
  ...
  public <U extends XMOMDatabaseEntry> void setAllFieldsFromData(U data) {
    ...
    usedInImplOf = ((XMOMDomOrExceptionDatabaseEntry)data).usedInImplOf;
  }

  @Override
  public XMOMDomOrExceptionDatabaseEntry clone() throws CloneNotSupportedException {
    return (XMOMDomOrExceptionDatabaseEntry) super.clone();
  }
