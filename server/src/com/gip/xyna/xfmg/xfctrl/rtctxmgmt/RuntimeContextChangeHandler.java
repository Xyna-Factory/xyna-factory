...
/**
 * Fehler bei der Ausf�hrung (RuntimeExceptions/Error) werden nur geloggt 
 */
public interface RuntimeContextChangeHandler {
  ...
  /**
   * wird nicht aufgerufen, falls ein rtc-change durch ein migrate ausgel�st wird. stattdessen wird die methode migration(from, to) aufgerufen.
   */
