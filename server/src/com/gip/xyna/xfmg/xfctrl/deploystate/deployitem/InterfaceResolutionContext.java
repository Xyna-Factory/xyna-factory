...
public class InterfaceResolutionContext {
  ...
  /*
   * es wird nicht angenommen, dass relation USEDINIMPLOF �bergeben wird
        ...
        switch (type) {
          case INPUT :
            if (contains(relation, XMOMDatabaseEntryColumn.NEEDEDBY)) {
              //innerhalb von workflows werden die inputs von aufgerufenen services auch mit INPUT geflaggt. Diese sollen nicht als neededby aufgef�hrt werden
