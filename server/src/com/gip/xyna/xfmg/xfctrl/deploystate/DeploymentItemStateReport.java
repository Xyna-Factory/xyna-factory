...
public class DeploymentItemStateReport implements Serializable {
  ...
  public static class Inconsistency implements Serializable {
    ...
    public String toFriendlyString() {
      ...
      switch ( type) {
        case INVALID_0001 :
        case INVALID_0011:
          //falls application, k�nnte man das "only" auch weglassen.
  ...
  public enum ServiceImplInconsistencyState {
    SAVED_INTERFACE_CHANGE,       //ImplJar ist vom <lastJarChange>, aber ServiceGroup wurde am <lastChange> ge�ndert
    DEPLOYED_INTERFACE_CHANGE,    //ImplJar ist vom <lastJarChange>, aber ServiceGroup wurde am <lastChange> deployed
    SAVED_USED_OBJECT_CHANGE,     //ImplJar ist vom <lastJarChange>, aber der verwendete <usedXmomType> <usedFqName> wurde am <lastChange> ge�ndert
