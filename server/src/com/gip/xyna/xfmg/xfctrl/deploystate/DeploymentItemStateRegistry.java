...
public class DeploymentItemStateRegistry implements DeploymentItemRegistry {
  ...
  public void delete(String fqName, DeploymentContext ctx) {
     ...
     *   lokale callsites k�nnen im parent nicht immer aufgel�st werden.
     *    - es kann aber welche geben, die dort aufgel�st werden k�nnen und deshalb dort migriert werden sollten.
     */          
  ...
  public void deployFinished(String fqName, DeploymentTransition transition, boolean copiedXMLFromSaved,
    ...
    if (dis == null) {
      ...
      try {
        ...
        //beim speichern der exception werden exception causes aus java serialisierungsgr�nden in "deploymentTransition" genullt. 
        //das deployment soll die causes aber noch sehen k�nnen
