...
public class ApplicationXmlHandler extends DefaultHandler {
  ...
  public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException { 
    ...
    //neue Action f�r den Child erzeugen
  ...
  private static class Action<T> {
    ...
    /**
     * Pr�fung, ob der childTag erwartet wird
     * @param locator
     * @param childTag
     * @throws SAXException 
     */
    ...
    /**
     * Gibt die entsprechende Action f�r den childTag zur�ck
     * @param childTag
     * @return
     * @throws SAXException
     */
    ...
    /**
     * End-Tag des Childs: �bernahme der Daten in eigene Speicherung
     * @param childTag
     * @param value
     * @param started
     * @throws SAXException
  ...
  private static class ApplicationInfoAction extends Action<ApplicationInfoEntry> {
    ...
    public void endElement(String childTag, String value, Action<?> started) {
      if(TAG_AI_DESCRIPTION.equals(childTag) ) {
        ...
        //ListAction hat Daten bereits �bertragen
  ...
  protected final static String XMLVERSION = "1.1"; //bei �nderungen beachte abw�rtskompatibilit�t: man soll auch alte applications importieren k�nnen (s.o.)
