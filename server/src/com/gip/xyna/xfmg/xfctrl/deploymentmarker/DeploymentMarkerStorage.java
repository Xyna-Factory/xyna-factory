...
public class DeploymentMarkerStorage {
  ...
  //Lock, damit z.B. der Index nicht gleichzeitg hochgez�hlt wird 
  //und beim L�schen aller DeploymentMarker eines DeploymentItems nicht gleichzeitig ein neuer Marker angelegt wird
