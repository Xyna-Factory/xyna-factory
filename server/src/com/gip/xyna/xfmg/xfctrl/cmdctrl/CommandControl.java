...
/**
 * Factory Operationen sollen unter Umst�nden nicht gleichzeitig laufen. Mit dieser Klasse kann man ausdr�cken, dass eine Menge 
 * von Operations vorr�bergehend gesperrt sein soll. Das ganze pro Revision.
 * 
...
public class CommandControl {
  ...
  private static class SingleLock<T> extends ObjectWithRemovalSupport {
     ...
     * 
     * @param lockedBy
     * @return null, falls Lock bekommen, sonst Operation, die das writeLock h�lt
     */
    public boolean writeLock(T lockedBy) {
      if (isReadLockedByCurrentThread()) {
        //eigener Thread hat bereits ein readLock, dies w�rde zu einem DeadLock f�hren
    ...
    /**
     * �berpr�ft, ob der eigene Thread bereits ein readLock h�lt.
     */
  ...
  private static class LockCollection<T, S> extends ObjectWithRemovalSupport {
    ...
    /**
     * WriteLocks f�r die angegebenen Operations in allen Revisions. Falls eine Operation durch einen anderen Thread
  ...
  /**
   * readlock in default workingset f�r diese operation.
   * andere komponenten sollen sich davor sch�tzen, dass nicht gleichzeitig ein prozess am laufen ist, der ein writelock auf der operation ben�tigt.
 ...
 */
  public enum Operation {
    ...
    /**
     * Liefert alle Operations au�er der �bergebenen zur�ck.
     * @param operation
     * @return
     */
  ...
  /**
   * readlock f�r diese operation in der revision.
   * andere komponenten sollen sich davor sch�tzen, dass nicht gleichzeitig ein prozess am laufen ist, der ein writelock auf der operation ben�tigt.
   * z.b. clearworkingset oder removeapplication.
   * wirft exceptions, falls nicht gelockt.
   */
  ...
  /**
   * readlock f�r diese operation in dem runtimecontext
   * andere komponenten sollen sich davor sch�tzen, dass nicht gleichzeitig ein prozess am laufen ist, der ein writelock auf der operation ben�tigt.
   * z.b. clearworkingset oder removeapplication.
   * wirft exceptions, falls nicht gelockt.
  ...
  public static void tryLock(Operation operation, RuntimeContext runtimeContext) throws XFMG_CouldNotLockOperation {
    try {
      ...
      throw new XFMG_CouldNotLockOperation(operation.toString(), runtimeContext.toString(), e); //TODO unsch�ne fehlermeldung
    }
  }
  ...
  /**
   * readlock f�r diese operation in der application.
   * andere komponenten sollen sich davor sch�tzen, dass nicht gleichzeitig ein prozess am laufen ist, der ein writelock auf der operation ben�tigt.
   * z.b. clearworkingset oder removeapplication.
  ...
  /**
   * writelock f�r die angegebenen operations in der angegebenen revision.
   * 
   ...
   * @param timout
   * @param unit
   * @return null, falls writeLocks f�r alle Operations in allen Revisions geholt werden konnten. Ansonsten ein Paar bestehend aus 
      ...
      for (long revision : revisions) {
        ...
        try {
          ...
          if (result != null) {
              ...
              locked.add(revision); //Locks bekommen -> Locks f�r n�chste Revision holen
            }
          suc = true;
        } finally {
          if (result != null || !suc) {
  ...
  //damit man das array nach aussen hin unver�ndert l�sst, es aber intern sortieren kann
