...
public class RemoteDestinationManagement extends FunctionGroup {
  ...
  protected void init() throws XynaException {
    ...
    //fr�he Initialisierung mit Properties und PersistenceLayer, 
    //NodeManagement f�r g�ltige FactoryNodes
    ...
    //Cluster-Initialisierung, damit verwendbar f�r andere Factories
  ...
  public void removeRemoteDestinationInstance(String instancename) {
    //TODO checken, ob instanz von laufenden auftr�gen verwendet wird. force-parameter? -> vermutlich nicht notwendig
  }
