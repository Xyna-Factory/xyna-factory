...
public class CredentialsCache implements IPropertyChangeListener {
  ...
  private static final XynaPropertyString userNameProperty = new XynaPropertyString("xfmg.xfctrl.nodemgmt.remotecall.user", "XYNAADMIN")
                  ...
                  .setDefaultDocumentation(DocumentationLanguage.DE, "User-Name f�r Remote-Calls. (Muss auch lokal definiert sein)")
                  .setHidden(true);
  ...
  //deprecated nur f�r externe verwendung. es soll das singleton verwendet werden!
  @Deprecated
  ...
  public synchronized void clearSession(String nodeName) {
    ...
    if (session != null && System.currentTimeMillis() - session.age >= minOffsetForSessionDeletion.getMillis()) {
      ...
      //TODO sch�ner w�re es, wenn stattdessen alle interlink-verwender einfach konsistenz die session-fehler behandeln, d.h. wenn das alles �ber
      //einen gemeinsamen codepfad gehen w�rde
