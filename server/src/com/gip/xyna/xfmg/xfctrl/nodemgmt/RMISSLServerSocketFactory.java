  ...
  public ServerSocket createServerSocket(int port) throws IOException {
    ...
    return new WrappingServerSocket(ss) { //alle methoden an SSLServerSocket delegieren
      ...
      public Socket accept() throws IOException {
        ...
        //TODO das timeout von oben ohne nachdenken zu verwenden ist nicht gut, weil verschiedene timeouts nicht ohne weiteres realisiert werden k�nnen
        //siehe bug 23373 
        ...
        //verschiedene timeouts zusammen mit gleichem communicationport f�hrt dann dazu, dass der Endpoint als unterschiedliche befunden wird
