...
public class FactoryNodeCaller {
  ...
  /**
   * Trennung der Threads: hier�ber werden RemoteCallNotification dem NotificationProcessor-Thread �bergeben.
  ...
  public void shutdown(boolean hasSuccessor) {
    ...
    if( ! notificationProcessor.isFinished() ) {
      //nun sind doch nochmal unerwartet Auftr�ge eingegangen ...
  ...
  public void disconnect() {
    //alle AwaitOrderNotification mit Fehler beenden, damit wartende Threads nicht auf Reconnect warten m�ssen
