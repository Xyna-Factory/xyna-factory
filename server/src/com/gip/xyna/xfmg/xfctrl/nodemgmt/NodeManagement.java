...
public class NodeManagement extends FunctionGroup {
  ...
  private static final XynaPropertyString ownNodeNameProperty = new XynaPropertyString("xfmg.xfctrl.nodemgmt.node_name", "")
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Name des eigenen Factory-Nodes. Wird vom Remote Call Feature verwendet, um auf der entfernten Seite wartende Antworten von Remote Call Auftr�gen zu korrelieren. Wert sollte deshalb nicht ge�ndert werden, solange noch Remote Call Auftr�ge laufen.")
      ;
  ...
  private void checkName(String name) {
    ...
    //TODO weitere Namenseinschr�nkungen, z.B f�r StringSerializableList
  }
  ...
  /**
   * Entfernt den Factory Node mit dem �bergebenen Namen
   * @param name
   * @return  true, falls Eintrag vorhanden war und gel�scht wurde
   * @throws PersistenceLayerException
   */
   ...
   * vom ApplicationManagament ben�tigt
   * @return
  ...
  /**
   * Liefert alle bekannten Factory Nodes
   * Detailanzeige f�r listfactorynodes
   * @return
   */
  ...
  /**
   * Liefert den Factory Node mit dem �bergebenen Namen
   * @param name
   * @return
   */
  public FactoryNode getNodeByName(String name) {
   ...
   /**
   * Liefert den Status zu einm Factory Node mit dem �bergebenen Namen
   * @param name
   * @return
   */
  ...
  /**
   * Entfernt den Cluster Node mit dem �bergebenen Namen
   * @param name
   * @return  true, falls Eintrag vorhanden war und gel�scht wurde
   * @throws PersistenceLayerException
   */
