...
public class InterFactoryRMIChannel implements InterFactoryChannel {
  ...
  /*
   *  falls keystore nicht gesetzt, wird der keystore verwendet, der �ber die xynaproperties RMI_SSL_KEYSTORE_TYPE etc gesetzt ist
   *  falls truststore nicht gesetzt, wird kein truststore verwendet.
   *  falls truststore gesetzt ist, wird server-authentication durchgef�hrt
   */
  ...
  public void setupCommunication(Duration timeout) {
    //falls der server nicht auf SSL konfiguriert ist, ist das �berfl�ssig. schadet aber nichts
