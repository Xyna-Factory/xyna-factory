...
@XynaObjectAnnotation(fqXmlName = "xfmg.xods.configuration.XynaPropertyUnreadableString")
public class XynaPropertyUnreadableString extends XynaProperty {

  private static final long serialVersionUID = 2592736384L;
  private static final Logger logger = CentralFactoryLogging.getLogger(XynaPropertyUnreadableString.class);
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends XynaPropertyUnreadableString, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends XynaProperty.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(XynaPropertyUnreadableString instance) {
      super(instance);
    }

    public XynaPropertyUnreadableString instance() {
      return (XynaPropertyUnreadableString) instance;
    }
  ...
  public static class Builder extends InternalBuilder<XynaPropertyUnreadableString, Builder> {
    public Builder() {
      super(new XynaPropertyUnreadableString());
    }
    public Builder(XynaPropertyUnreadableString instance) {
      super(instance);
    }
  }
  ...
  public XynaPropertyUnreadableString() {
    super();
  }
  ...
  */
  public XynaPropertyUnreadableString(String value) {
    this();
    this.value = value;
  }
  ...
  */
  public XynaPropertyUnreadableString(String propertyName, com.gip.xyna.xfmg.xods.configuration.xynaobjects.BehaviourIfPropertyNotSet behaviourIfPropertyNotSet, String value) {
    this(value);
    unversionedSetPropertyName(propertyName);
    unversionedSetBehaviourIfPropertyNotSet(behaviourIfPropertyNotSet);
  }

  protected void fillVars(XynaPropertyUnreadableString source, boolean deep) {
    super.fillVars(source, deep);
    this.value = source.value;
  }

  public XynaPropertyUnreadableString clone() {
    return clone(true);
  }

  public XynaPropertyUnreadableString clone(boolean deep) {
    XynaPropertyUnreadableString cloned = new XynaPropertyUnreadableString();
  ...
  public static class ObjectVersion extends com.gip.xyna.xfmg.xods.configuration.xynaobjects.XynaProperty.ObjectVersion {
    ...
    protected boolean memberEquals(com.gip.xyna.xdev.xfractmod.xmdm.XOUtils.ObjectVersionBase o) {
      ...
      XynaPropertyUnreadableString xoc = (XynaPropertyUnreadableString) xo;
      XynaPropertyUnreadableString xoco = (XynaPropertyUnreadableString) other.xo;
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "XynaPropertyUnreadableString", "xfmg.xods.configuration", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
  ...
  */
  ...
  public static Field getField(String target_fieldname) throws InvalidObjectPathException {
    ...
    try {
      foundField = XynaPropertyUnreadableString.class.getDeclaredField(target_fieldname);
  ...
  public String toString() {
    return "XynaPropertyUnreadableString("+super.toString()+
