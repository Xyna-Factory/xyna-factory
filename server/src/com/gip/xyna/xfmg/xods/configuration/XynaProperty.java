...
public interface XynaProperty {
  ...
  /**
   * true =&gt; auftr�ge die auf scheduling warten (weil ihre capacities belegt sind oder sowas) werden gebackupped. false
  ...
  public static final XynaPropertyDuration XYNA_SCHEDULER_STOP_TIMEOUT_OFFSET =
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, 
                              "Diese Property bewirkt, dass Auftr�ge vor dem Herunterfahren des Servers bereits "+
  ...
  public static final XynaPropertyDuration TIMEOUT_SHUTDOWN_ORDERS_IN_CLEANUP = 
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, 
                              "So lange maximal auf Auftr�ge im Cleanup warten, nachdem der Scheduler "+
                              "angehalten wurde.");
  public static final XynaPropertyDuration TIMEOUT_SHUTDOWN_ORDERS_IN_PLANNING = 
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, 
                              "So lange maximal auf Auftr�ge im Planning warten, nachdem der Scheduler "+
                              "angehalten wurde.");
  ...
  //FIXME die geh�ren in Constants-Klasse
  /**
  ...
  /*
   * Properties f�r BlackExceptionCodeManagement
   */
  ...
  public static final XynaPropertyDurationCompatible<Long> GUI_SESSION_TIMEOUT_SECONDS = 
      new XynaPropertyDurationCompatible<Long>("xyna.xfmg.xopctrl.managedsessions.timeout", SessionManagement.DEFAULT_GUI_SESSION_TIMEOUT_SECONDS)
        .setDefaultDocumentation(DocumentationLanguage.DE, "G�ltigkeitsdauer einer Sitzung in Sekunden.")
  ...
  public static final XynaPropertyDurationCompatible<Long> GUI_SESSION_DELETION_INTERVAL =
      new XynaPropertyDurationCompatible<Long>("xyna.xfmg.xopctrl.managedsessions.sessiondeletioninterval", SessionManagement.DEFAULT_SESSION_DELETION_INTERVAL)
        .setDefaultDocumentation(DocumentationLanguage.DE, "H�ufigkeit des Aufr�umens verwaister Sessions zur Freigabe von von der Session belegten Ressourcen. Eine Session gilt als verwaist, wenn sie abgelaufen ist, aber nicht beendet ist.")
  ...
  public static final XynaPropertyBoolean CREATE_MULTIPLE_SESSIONS_IF_ALLOWED = new XynaPropertyBoolean("xfmg.xopctrl.managedsessions.createMultipleSessionsIfAllowed", false)
      .setDefaultDocumentation(DocumentationLanguage.DE, "Falls gesetzt d�rfen Benutzer mit einer Rolle mit dem Recht MULTIPLE_SESSION_CREATION mehrere Sitzungen gleichzeitig ge�ffnet haben.")
  ...
  public static final XynaPropertyString THREADPOOL_PLANNING_POOL_SIZE_STRATEGY = 
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, "Konfiguration des Verhaltens bei ausgelastetem ThreadPool, der "+
          "seine maximale Gr��e jedoch noch nicht erreicht hat: "+
          "'eager': Jeder neue Task erh�lt sofort einen Thread. "+
          "'lazy_<n>': (Beispiel 'lazy_2') F�r jeweils <n> in der Queue wartende Tasks wird ein neuer Thread gestartet. "+
  ...
  /**
   * wie lange werden antworten im synchronizationmanagement vorgehalten, f�r die noch keine anfragen gekommen sind, bevor sie
   * verworfen werden.
   */
  ...
  /**
   * maximale anzahl von auftr�gen in memory
   */
  ...
  public static final XynaPropertyDuration SCHEDULER_CLOSED_TIMEWINDOW_REMOVE_TIME_OFFSET = new 
      ...
      setDefaultDocumentation(DocumentationLanguage.DE,
                              "Auftr�ge, die auf ihren Startzeitpunkt warten m�ssen, werden tempor�r aus dem Scheduling "
  ...
  public static final XynaPropertyInt SCHEDULER_MAX_RETRIES = new 
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, 
                              "Maximale Anzahl Retries, die ein Auftrag in einem Scheduling-Durchlauf versuchen darf - "
                                  ...
                                  +"dem n�chsten Auftrag fortgesetzt."); 
  ...
  public static final XynaPropertyBoolean SCHEDULER_WAIT_FOR_STABLE_TIME_WINDOWS = new
      ...
      setDefaultDocumentation(DocumentationLanguage.DE, 
                              "Diese Property gibt im Cluster-Betrieb vor, ob Auftr�ge im Scheduler, " +
                              "die ein Zeitfenster ben�tigen, warten, bis die Zeitfenster stabil vorliegen " +
                              "(d.h. es kann nicht passieren, dass der andere Knoten �nderungen an den " +
                              "Zeitfenstern vornimmt, die der lokale Knoten nicht sieht) \u2013 Wert true \u2013 " +
                              "oder ob die Zeitfenster vorl�ufig wiederhergestellt " +
                              "werden sollen mit der Gefahr, dass der andere Knoten �nderungen daran vornimmt, " +
                              "die noch nicht bemerkt werden k�nnen \u2013 Wert false. " +
  ...
  /**
   * Default-Priority f�r XynaOrder<br>
  ...
  /**
   * Properties f�r OrderSeriesManagement
   */
  ...
  /**
   * Properties f�r SuspendResumeManagement
   */
  ...
  /**
   * Property bestimmt, ob ein nach einem erfolgreichen Killprozess noch die Kompensation durchgef�hrt werden soll.
   */
  ...
  public static XynaPropertyDuration BATCH_CANCEL_WAIT_TIMEOUT = new XynaPropertyDuration("xyna.xprc.xbatchmgmt.cancel_wait_timeout", "5 s").
      setDefaultDocumentation(DocumentationLanguage.DE,
                              ...
                              "k�nnen; danach werden weiterhin laufende Slaves abgebrochen. Falls kein ExecutionTimeOut f�r "+
  ...
  public static final XynaPropertyEnum<BatchProcessManagement.MissingLimitationReaction> BATCH_NO_LIMITATION_REACTION =
      ...
      setDefaultDocumentation(DocumentationLanguage.DE,
                              "Reaktion auf fehlende Limitierung (weder SlaveExecutionPeriod noch Kapazit�ten f�r die Slaves konfiguriert): "
                                  +BatchProcessManagement.MissingLimitationReaction.documentation(DocumentationLanguage.DE)); 

  /*
   * Properties f�r Node Management
   */
  ...
  /*
   * Properties f�r MasterWorkflowPostScheduler
   */
  public static final XynaPropertyBoolean CLEANUP_WORKFLOW_BEFORE_FREEING_CAP_VETO = new XynaPropertyBoolean("xyna.xprc.xpce.cleanup_workflow_before_freeing_cap_and_veto", false).
      ...
      setDefaultDocumentation(DocumentationLanguage.DE,
                              "Cleanup-Workflow wird vor der Freigabe von Caapcitys und Vetos ausgef�hrt.");
  ...
  public static final XynaPropertyString FILE_MANAGEMENT_TEMP_DIR = new XynaPropertyString("xyna.xfmg.xfctrl.filemgmt.temp_dir", "/tmp/filemgmt").
      ...
      setDefaultDocumentation(DocumentationLanguage.DE,
                              "Verzeichnis, in dem das Filemanagement tempor�re Dateien und Verzeichnisse ablegt.");
  public static final XynaPropertyDuration FILE_MANAGEMENT_DEFAULT_TIMEOUT = new XynaPropertyDuration("xyna.xfmg.xfctrl.filemgmt.default_timeout", "30 min").
      ...
      setDefaultDocumentation(DocumentationLanguage.DE,
                              "Standard Zeitlimit bis zur L�schung einer hochgeladenen Datei.");
  public static final XynaPropertyInt FILE_MANAGEMENT_STATE_TRANSITION_RETRIES = new XynaPropertyInt("xyna.xfmg.xfctrl.filemgmt.transition_retries", 100).
                  ...
                  setDefaultDocumentation(DocumentationLanguage.DE,
                                          "Anzahl der Wiederholungsversuchen eines Status�bergangs."
                                       + " Sollte passend zur erwarteten Menge an konkurrierenden Zugriffen angepasst werden. (< 0 f�r unbeschr�nkte Wiederholungen)");

 
  /*
   * Properties f�r ListFurtherInformationFromStartup
   */
  ...
  public static final XynaPropertyDuration SERVICE_IMPL_INCONSISTENCY_TIME_LAG = new XynaPropertyDuration("xyna.xfmg.xfctrl.deploystate.service_impl_inconsistency_time_lag", "10 s").
                  setDefaultDocumentation(DocumentationLanguage.DE,
                                          ...
                                          "Ist das ImplJar �lter, geht die ServiceGroup den Zustand INVALID");
  ...
  public static final XynaPropertyBoolean XMOMDISCOVERY_ON_STARTUP = new XynaPropertyBoolean("xyna.xfmg.xfctrl.xmomdatabase.discovery_on_startup", false).
                  setDefaultDocumentation(DocumentationLanguage.DE, "Beim Startup wird ein XMOM-Discovery ausgef�hrt.");

  /**
   * erlaubte Werte f�r Deployment-Tags
   */
  ...
  /*
   * versionierung kostet bei monitoringlevel <= 15 performance, und hat das risiko f�r bugs. bei monitoringlevel > 15 spart es wiederum performance
   * intern verwendete objekte haben immer versionierung an.
   * 
   * �nderung von 0/5 auf anderen wert ben�tigt erneutes deployment
   * 
   * 5 = immer true generiert
   * 3,4 = abh�ngig von xynaproperty-value (3 = false, 4 = true)
   * 1,2 = reserviert f�r konfiguration pro ordertype/order (derzeit = 0)
   *    ACHTUNG: konfiguration pro ordertype/order: es muss immer die gesamte objektinstanz-hierarchie versionierung unterst�tzen, ansonsten gehen �nderungen verloren.
   * 
  ...
  public static final XynaPropertyInt DEFAULT_SIZE_COLUMN_TYPE = new XynaPropertyInt("xyna.xnwh.persistence.dbmodifytable.defaultSize", DatabasePersistenceLayerWithAlterTableSupportHelper.DEFAULT_SIZE_COLUMN_TYPE).
                  ...
                  setDefaultDocumentation(DocumentationLanguage.DE, "Standard-Gr�sse f�r gr�ssenabh�ngige Datenbankspalten welche f�r Storables erzeugt werden");
  ...
  public static final XynaPropertyBoolean THROW_EXCEPTION_ON_DUPLICATE_DESTINATION_RESOLUTION =
                  new XynaPropertyBoolean("xyna.xprc.xpce.planning.throwOnDuplicateOrdertype", true)
                        ...
                        .setDefaultDocumentation(DocumentationLanguage.DE, "Auftr�ge welche eine OrderType-Kollision feststellen terminieren mit einer Fehlermledung.");
  ...
  public static final XynaPropertyBuilds<PrettyPrintConfig> TABLE_FORMATTER_PRETTY_PRINT = 
      ...
      setDefaultDocumentation(DocumentationLanguage.EN, "Separator f�r TableFormatter (e.g. CLI output), format: 3 chars as string VHC").
      setDefaultDocumentation(DocumentationLanguage.DE, "Trennzeichen f�r TableFormatter (z.B CLI-Ausgaben), Format: 3 Zeichen als String VHC");
  ...
  public static final XynaPropertyInt ZETA_TABLE_LIMIT = new XynaPropertyInt("zeta.table.limit", 100).
      setDefaultDocumentation(DocumentationLanguage.DE, "Die maximale Anzahl an Tabellen-Eintr�gen, die zur�ck gegeben werden.").
  ...
  public static final XynaPropertyInt WAREHOUSE_JOB_BATCH_SIZE = new XynaPropertyInt("xyna.xnwh.xwarehousejobs.defaultBatchSize", 1000).
                  setDefaultDocumentation(DocumentationLanguage.DE, "Die Gr�sse der Batches die von einem Warehousejob bearbeitet werden.").
