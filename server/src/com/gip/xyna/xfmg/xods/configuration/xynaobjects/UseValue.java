...
@XynaObjectAnnotation(fqXmlName = "xfmg.xods.configuration.parameter.UseValue")
public class UseValue extends BehaviourIfPropertyNotSet {

  private static final long serialVersionUID = -1L;
  private static final Logger logger = CentralFactoryLogging.getLogger(UseValue.class);


  protected static class InternalBuilder<_GEN_DOM_TYPE extends UseValue, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends BehaviourIfPropertyNotSet.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(UseValue instance) {
      super(instance);
    }

    public UseValue instance() {
      return (UseValue) instance;
    }

  }

  public static class Builder extends InternalBuilder<UseValue, Builder> {
    public Builder() {
      super(new UseValue());
    }
    public Builder(UseValue instance) {
      super(instance);
    }
  }

  public Builder buildUseValue() {
  ...
  protected void fillVars(UseValue source, boolean deep) {
    super.fillVars(source, deep);
  }

  public UseValue clone() {
    return clone(true);
  }

  public UseValue clone(boolean deep) {
    UseValue cloned = new UseValue();
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "UseValue", "xfmg.xods.configuration.parameter", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
