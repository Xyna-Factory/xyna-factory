...
@XynaObjectAnnotation(fqXmlName = "xfmg.xods.configuration.parameter.BehaviourIfPropertyNotSet")
public abstract class BehaviourIfPropertyNotSet extends XynaObject {

  private static final long serialVersionUID = -1L;
  private static final Logger logger = CentralFactoryLogging.getLogger(BehaviourIfPropertyNotSet.class);


  protected static class InternalBuilder<_GEN_DOM_TYPE extends BehaviourIfPropertyNotSet, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>>  {

    protected _GEN_DOM_TYPE instance;

    protected InternalBuilder(BehaviourIfPropertyNotSet instance) {
      this.instance = (_GEN_DOM_TYPE) instance;
    }

    public BehaviourIfPropertyNotSet instance() {
      return (BehaviourIfPropertyNotSet) instance;
    }

  }

  public BehaviourIfPropertyNotSet() {
    super();
  }

  protected void fillVars(BehaviourIfPropertyNotSet source, boolean deep) {
  }

  public abstract BehaviourIfPropertyNotSet clone();

  public abstract BehaviourIfPropertyNotSet clone(boolean deep);
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "BehaviourIfPropertyNotSet", "xfmg.xods.configuration.parameter", objectId, refId);
    } else {
      objectId = -1;
    }
    if (!onlyContent) {
  ...
  */
  ...
  public static Field getField(String target_fieldname) throws InvalidObjectPathException {
    ...
    try {
      foundField = BehaviourIfPropertyNotSet.class.getDeclaredField(target_fieldname);
