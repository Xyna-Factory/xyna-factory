...
@XynaObjectAnnotation(fqXmlName = "xfmg.xods.configuration.parameter.enums.EN")
public class EN extends DocumentationLanguage {

  private static final long serialVersionUID = -1L;
  private static final Logger logger = CentralFactoryLogging.getLogger(EN.class);


  protected static class InternalBuilder<_GEN_DOM_TYPE extends EN, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends DocumentationLanguage.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(EN instance) {
      super(instance);
    }
  ...
  public static class Builder extends InternalBuilder<EN, Builder> {
    public Builder() {
      super(new EN());
    }
    public Builder(EN instance) {
      super(instance);
    }
  }

  public Builder buildEN() {
  ...
  protected void fillVars(EN source, boolean deep) {
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "EN", "xfmg.xods.configuration.parameter.enums", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
