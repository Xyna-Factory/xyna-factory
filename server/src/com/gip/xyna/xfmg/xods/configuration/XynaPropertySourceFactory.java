 ...
 * <li>DependencyRegister f�r Verwender-Anzeige</li>
 * </ul>
 */
public class XynaPropertySourceFactory implements XynaPropertySource, PropertyCacher {
  ...
  public void register(XynaPropertyBase<?,?> property) {
    ...
    if( cxp == null ) {
      ...
      if( existing != null ) {
        cxp = existing; //jemand anderes war schneller, dessen CachedXynaProperty �bernehmen
  ...
  public void addProperty(XynaPropertyStorable storable) {
    ...
    if( cxp != null ) {
      ...
      if( existing != null ) {
        ...
        //jemand anderes war schneller, dessen CachedXynaProperty �bernehmen
      }
    }
  }
