 ...
 * Auftragsinputs k�nnen beliebig kompliziert erstellt werden
 *  - konstant
 ...
 * </li>
 * <li>
 * {@link OrderInputSource} Instanzen entsprechen den Eintr�gen die in der GUI sichtbar sind. Immer wenn ein Auftrag
 * bzgl eines Typs mit Parametrisierung gestartet werden soll, wird auf die zugeh�rige {@link OrderInputSource} Instanz zugegriffen und daraus eine
...
public interface OrderInputSourceType {
   ...
   * @param destinationKey Was f�r ein Auftragstyp soll mit dieser InputSource gestartet werden
  ...
  /**
   * refactored die �bergebenen parameter in der map
