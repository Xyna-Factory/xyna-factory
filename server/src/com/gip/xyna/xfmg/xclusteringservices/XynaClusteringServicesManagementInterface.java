...
public interface XynaClusteringServicesManagementInterface {
  ...
  /**
   * f�r jeden unterst�tzten clustertype (z.B. oracle RAC, direct RMI-communication, etc) ein string, der beschreibt,
  ...
  /**
   * @param clusterType im verzeichnis server/clusterproviders muss ein unterverzeichnis mit dem �bergebenen namen
  ...
  /**
   * @throws XFMG_ClusterComponentConfigurationException falls fr�her bereits configured war, und clustered den fehler bei enableCluster wirft
   */
