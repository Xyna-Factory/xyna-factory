...
public class RMIClusterProviderTools {
  ...
  /**
   * f�hrt das �bergebene runnable f�r alle registrierten cluster members und f�r localImpl aus. falls verbindung nicht
   * hergestellt werden kann, wird changeClusterState(DISCONNECTED) aufgerufen, und der entsprechende knoten wird
   * �bersprungen. es wird kein fehler geworfen.
   * @param <R> result type
   ...
   * @param runnable auszuf�hrendes runnable
   * @param localImpl null falls nicht lokal ausgef�hrt werden soll
   * @throws E
