...
public interface RMIClusterProviderInterconnectInterface extends Remote {
  ...
  /**
   * Knoten B signalisiert zur�ck an Knoten A, dass er im Cluster willkommen ist, beide sind dann CONNECTED
   */
  public void connect() throws RemoteException;
  
  /**
   * knoten, der bereits zum cluster geh�rt, wird disconnected 
   */
  ...
  /**
   *  Knoten B signalisiert nach einem {@link #register(String, int, boolean)} zur�ck an Knoten A, dass er noch nicht so weit ist, um timeouts beim warten
