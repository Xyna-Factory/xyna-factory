...
public class IDGenerator extends FunctionGroup {
  ...
  /**
   * gibt f�r diese jvm eindeutige ids. wird beim serverstart resetted.
   * 
   * d.h. nicht global eindeutig, weder �ber mehrere knoten hinweg noch �ber neustart hinweg.
  ...
  /*
   * ACHTUNG: abw�rtskompatibel halten, weil in projekten verwendet
   */
  /**
  ...
  /**
   * gibt die als lastStoredId gespeicherte id vom anderen binding/knoten zur�ck 
   * nur unterst�tzt, wenn factory geclustered ist
   */
