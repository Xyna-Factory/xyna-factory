...
public class Updater implements UpdaterInterface {
  ...
  private void init() {
    try {
      ...
      ud.addFollowingBranchVersionsAsAllowedForUpdate(4); //alles was mit 6.1.1 anfängt, und gröÃŸer gleich 6.1.1.5 ist
      updates.add(ud);
      ...
      // 6.1.2.3
      //codegen Ã„nderungen fÃ¼r objekt-versionierung, xml referenzen in toXml-darstellung, und deep-equals Möglichkeiten. xynaobjectlist ist nicht serialisierungskompatibel
      ...
      ud = new UpdateDeployMDMs(v242, v243,
                                ...
                                new String[] {},
                                true, false, false);
      ud.addFollowingBranchVersionsAsAllowedForUpdate(4); //alles was mit 6.1.2 anfängt, und gröÃŸer gleich 6.1.2.9 ist
      updates.add(ud);
      ...
      //         prozess benötigen, mÃ¼ssen die versionen, auf denen die updates passieren sollen, oben genau angegeben werden.
  ...
  private void checkUpdateGeneral() throws XPRC_GENERAL_UPDATE_ERROR, XPRC_VERSION_DETECTION_PROBLEM, PersistenceLayerException {
    ...
    try {
      ...
      if (doGeneralUpdates) {
        ...
        //FutureExecution fÃ¼r Updates, die erst später ausgefÃ¼hrt werden sollen, einstellen
                ...
                if (success) {
                  ...
                  try {
                    ...
                    if (!success && previousVersion != null) {
                      //rollback, damit die parametrisierung fÃ¼r das rewrite beim nächsten update erneut verwendet wird
                      try {
      ...
      // entsprechende funktion und sorgen selbständig fÃ¼r sicherheitskopien etc
