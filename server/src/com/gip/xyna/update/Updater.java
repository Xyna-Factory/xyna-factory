...
public class Updater implements UpdaterInterface {
  ...
  private void init() {
    try {
      ...
      // 9.0.2.1
      Version v468 = new Version(v467).increaseToMajorVersion(4, 1);
      ud = new UpdateJustVersion(v467, v468, false);
      updates.add(ud);

      // 9.0.2.2
      Version v469 = new Version(v468).increaseToMajorVersion(4, 1);
