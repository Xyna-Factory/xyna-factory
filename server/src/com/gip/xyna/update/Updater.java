...
public class Updater implements UpdaterInterface {
  ...
  private void init() {
    try {
      ...
      // 10.8.0.1
      Version v480 = new Version(v479).increaseToMajorVersion(4, 1);
      ud = new UpdateJustVersion(v479, v480);
      updates.add(ud);

      // 10.8.0.2
      Version v481 = new Version(v480).increaseToMajorVersion(4, 1);
      ud = new UpdateJustVersion(v480, v481);
      updates.add(ud);

      // 10.8.0.3
      Version v482 = new Version(v481).increaseToMajorVersion(4, 1);
      ud = new UpdateJustVersion(v481, v482);
      updates.add(ud);

      // 10.8.0.4
      Version v483 = new Version(v482).increaseToMajorVersion(4, 1);
      ud = new UpdateJustVersion(v482, v483);
      updates.add(ud);
