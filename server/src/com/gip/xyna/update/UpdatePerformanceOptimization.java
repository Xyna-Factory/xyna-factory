...
public class UpdatePerformanceOptimization extends UpdateJustVersion {


  private static final String PROPERTY_KEY_PERFORMANCE_OPTIMIZATION = "xmcp.xfm.processmodeller.dev.performanceoptimization";


  public UpdatePerformanceOptimization(Version oldVersion, Version newVersion) {
  ...
  protected void update() throws XynaException {
    XynaFactory.getInstance().getFactoryManagement().getXynaFactoryManagementODS().getConfiguration()
        .removeProperty(PROPERTY_KEY_PERFORMANCE_OPTIMIZATION, true);
  }
