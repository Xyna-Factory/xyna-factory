...
public class XynaObjectList<I extends XynaObject> extends XynaObject implements List<I>, Cloneable {
  ...
  private Object readResolve() throws ObjectStreamException {
    ...
    if (s != null && !s.isEmpty()) {
      //h�sslicher stack-size vergleich.
      if (Thread.currentThread().getStackTrace().length - s.peek() < 12) {
        //liste ist teil von container -> wegen xynaobject-array-kompatibilit�t nicht hier ersetzen, sondern in container beim readresolve.
        //wenn man hier bereits umwandeln w�rde, gibt es arraystoreexception im container, falls dort ein XynaObject[] gespeichert ist
        return this;
      }
    }
