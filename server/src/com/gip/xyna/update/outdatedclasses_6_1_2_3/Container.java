...
public class Container  extends XynaObject {
  ...
  public Object get(String name) throws InvalidObjectPathException {
    if ("params".equals(name)) {
      ...
      throw new InvalidObjectPathException(new XDEV_PARAMETER_NAME_NOT_FOUND(name)); //wegen abw�rtskompatibilit�t nicht direkt werfen
    }
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, XMLReferenceCache cache) {
    ...
    for (GeneralXynaObject xo : params) {
      if (xo != null) {
        ...
        xml.append("<Data/>\n"); //das ist in vielen f�llen richtig
      }
    }
    return xml.toString();
  }
  ...
  //Container k�nnte ein Array mit componenttyp XynaObject enthalten - das ist dann nicht kompatibel mit (General)XynaObjectList-Elementen, die keine XynaObjects sind.
  private Object readResolve() throws ObjectStreamException {
    Stack<Integer> s = stackSize.get();
    s.pop(); //aufr�umen TODO eigtl br�uchte man hier nen finally bei der deserialisierung... 
