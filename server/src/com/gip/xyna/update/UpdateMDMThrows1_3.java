...
/**
 *  1.2 workflows und datentypen erhalten ein throw-xynaexception tag f�r abw�rtskompatibilit�t. zuk�nftig werden throws genau definiert sein.
 */
    ...
    for (Element serviceElement : serviceElements) {
      ...
      for (Element operation : operations) {
        ...
        if (throwsElements.size() == 0) {
          ...
          //nun wird das throws element tats�chlich angef�gt
          if (nextElement == null) {
