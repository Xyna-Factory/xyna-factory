...
/**
 * �berfl�ssigerweise angelegte (persistent) default destinations entfernen, die werden beim deployment ja wieder angelegt. 
 * das sind genau alle destinations, bei denen der key und der value gleich sind und die zugeh�rigen destinations der anderen dispatcher.
 */
public class UpdateRemoveDefaultDestinations extends Update {
  ...
  protected void update() throws XynaException {
     ...
     * defaults werden wie folgt gesetzt:
        ...
        beim l�schen wie folgt vorgehen:
    ...
    try {
      ...
      //hauptdestinations (key = value) finden die man l�schen kann
      ...
      //nebendestinations (key ist gel�schte hauptdestination) finden, die man l�schen kann
      for (DispatcherDestinationStorable dds : coll) {
