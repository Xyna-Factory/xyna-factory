...
public class OrderInstance extends Storable<OrderInstance> {
  ...
  private List<XynaExceptionInformation> exceptions;
  ...
  public void addException(XynaException exception) {
    ...
    exceptions.add(new XynaExceptionInformation(exception, -1, GeneralXynaObject.XMLReferenceCache.getCacheObjectWithoutCaching(revision)));
  }
  ...
  protected static void fillByResultSet(OrderInstance oi, ResultSet rs, boolean includeExceptions)
      throws SQLException {
  ...
  private static class OrderInstanceReader implements ResultSetReader<OrderInstance> {
    ...
    public OrderInstance read(ResultSet rs) throws SQLException {
      ...
      fillByResultSet(oi, rs, this.includeExceptions);
      return oi;
    }
  ...
  public <U extends OrderInstance> void setAllFieldsFromData(U data) {
    ...
    exceptions = cast.exceptions; //TODO clone?
  ...
  public static class DynamicOrderInstanceReader implements ResultSetReader<OrderInstance> {
    ...
    public OrderInstance read(ResultSet rs) throws SQLException {
      ...
      if (selectedCols.contains(OrderInstanceColumn.C_EXCEPTIONS)) {
        oi.exceptions =
            (List<XynaExceptionInformation>) oi.readBlobbedJavaObjectFromResultSet(rs, OrderInstanceColumn.C_EXCEPTIONS
                .getColumnName());
      }
