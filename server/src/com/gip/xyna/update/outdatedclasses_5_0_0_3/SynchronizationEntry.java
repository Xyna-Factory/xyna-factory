...
package com.gip.xyna.update.outdatedclasses_5_0_0_3;
...
public class SynchronizationEntry extends Storable<SynchronizationEntry> {
  ...
  @Column(name = COL_LANE_ID_2_RESUME, size = 4000)
  private Long laneId;
  ...
  @Column(name = COL_ANSWER, size = 2000)
  ...
  public <U extends SynchronizationEntry> void setAllFieldsFromData(U data) {
    SynchronizationEntry synchronizationEntry = data;
    this.correlationId = synchronizationEntry.correlationId;
    this.orderId = synchronizationEntry.orderId;
    this.laneId = synchronizationEntry.laneId;
    this.answer = synchronizationEntry.answer;
    this.timeout = synchronizationEntry.timeout;
    this.timeStamp = synchronizationEntry.timeStamp;
    this.notified = synchronizationEntry.notified;
    this.readyToResume = synchronizationEntry.readyToResume;
    this.orderResumed = synchronizationEntry.orderResumed;
    this.internalXynaStepId = synchronizationEntry.internalXynaStepId;
    this.correspondingResumeOrderId = synchronizationEntry.correspondingResumeOrderId;
    this.receivedTimeout = synchronizationEntry.receivedTimeout;
  }
  ...
  private static void fillByResultSet(SynchronizationEntry entry, ResultSet rs) throws SQLException {
    ...
    entry.laneId = rs.getLong(COL_LANE_ID_2_RESUME);
    if (entry.laneId == 0 && rs.wasNull()) {
      entry.laneId = null;
    }
