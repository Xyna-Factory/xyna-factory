...
public abstract class Update {
  ...
  //wann soll das update ausgef�hrt werden
  protected ExecutionTime executionTime = ExecutionTime.initialUpdate;
  
  //wann wird das update gerade ausgef�hrt?
  ...
  /**
   * gibt neue version zur�ck falls update durchgef�hrt werden soll und es das auch wurde. ansonsten
   * wird currentVersion zur�ckgegeben. 
   */
  ...
  /**
   * falls &lt;= 4, werden beim ausf�hren der update methode alle versionen, die in ihren 
   * ersten (index-1) stellen �bereinstimmen und insgesamt gr��ergleich getAllowedVersionForUpdate sind,
   * als passend erkannt und das update wird durchgef�hrt.
   * 
  ...
  /**
   * erlaubt die Angabe zus�tzlicher Versionen, auf die das Update ausgef�hrt werden kann. Dabei sind alle
