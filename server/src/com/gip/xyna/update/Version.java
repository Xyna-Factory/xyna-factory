...
public class Version {
  ...
  public final boolean isStrictlyGreaterThan(Version otherVersion) {
    ...
    if (equals(otherVersion)) {
      //ohne diese abfrage muss die schleife vollst�ndig durchlaufen werden um equals zu bestimmen.
      return false;
    }
    ...
    for (int i = 0; i < len; i++) {
      ...
      //else == => n�chsten versions-part testen
    }
    ...
    //nicht equals und nicht kleiner oder gr��er...
   ...
   * 
   * erh�ht die i-te versionsstelle um &lt;increment&gt; (bei 1 anfangen zu z�hlen). die darauffolgenden versionstellen werden auf 0 gesetzt.
   * zb f�r i=4, increment=1 aus 3.0.0.12 mache 3.0.0.13
   * oder aus 3.0.0.alpha9 mache 3.0.0.alpha10
   * oder aus 3.0.0.bla mache 3.0.0.bla0
   * 
   * zb f�r i = 2, increment = 3 aus 3.0.0.12 mache 3.3.0.0
   * @return ge�ndertes versionsobjekt
   */
   ...
   * es wird also nur die angegebene stelle um den angegebenen wert erh�ht.
   */
