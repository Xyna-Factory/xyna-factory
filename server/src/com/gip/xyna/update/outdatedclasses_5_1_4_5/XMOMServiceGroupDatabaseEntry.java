...
@Persistable(primaryKey = XMOMServiceGroupDatabaseEntry.COL_FQNAME, tableName = XMOMServiceGroupDatabaseEntry.TABLENAME)
public class XMOMServiceGroupDatabaseEntry extends XMOMDatabaseEntry {
  ...
  public XMOMServiceGroupDatabaseEntry(String fqname) {
    super(fqname);
  }
  ...
  @Override
  public XMOMServiceGroupDatabaseEntry clone() throws CloneNotSupportedException {
    XMOMServiceGroupDatabaseEntry clone = new XMOMServiceGroupDatabaseEntry();
