...
public class UpdateConfigureTriggerConfigurationPersistenceLayerToXml extends Update{
  ...
  protected void update() throws XynaException {
    ...
    //�berpr�fen, ob bereits persistent konfiguriert
    ...
    //TriggerConfiguration auf die XMLPersistenceLayerInstanz f�r XynaActivation konfigurieren
    //(wird in UpdateTriggerFilterUseNewPersistence f�r Trigger und Filter angelegt)
    ...
    if (targetXmlPlID == null) {
      //XMLPersistenceLayerInstanz f�r XynaActivation nicht gefunden, daher neu anlegen
