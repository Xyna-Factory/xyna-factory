...
public class UpdateRewriteOrderBackupAndCronLikeOrders {
  ...
  protected void update() throws XynaException {
    ...
    try {
      // factory ist noch nicht initialisiert, zur Deserialisierung des xprc.xfractwfe.base.XynaProcess aber n�tig
  ...
  private void updateCronLikeOrder(ODSConnection conHis) throws PersistenceLayerException {
    try {
      ...
      //xmlpersistence oder �hnliches. crons kann man nicht verwenden, wenn sie nicht auf einen durchsuchbaren persistencelayer konfiguriert sind
  ...
  private void updateOrderBackup(ODSConnection conDef) throws PersistenceLayerException {
    try {
      ...
      //xmlpersistence oder �hnliches. backups kann man nicht verwenden, wenn nicht auf einen durchsuchbaren persistencelayer konfiguriert
      //deshalb ist hier nichts zu tun
