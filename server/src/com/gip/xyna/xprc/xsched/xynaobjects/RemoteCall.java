  ...
  private GeneralXynaObject initiateRemoteCall_InternalImplementation(
    ...
    if( getRemoteOrderId() == null ) {
      ...
      if( startTimeStamp == null ) {
        //�blicher Start: StartTimeStamp und RemoteOrderId nicht gesetzt
        startTimeStamp = System.currentTimeMillis();
        resumed = false;
      } else {
        //verz�gerter Start nach Resume
        resumed = true;
      }
      ...
      if( start.getSecond() != null ) {
        defaultTarget = start.getSecond(); //evtl DispatchingTarget �bernehmen, falls Fehler mit defaultTarget auftrat
      }
