...
@XynaObjectAnnotation(fqXmlName = "xprc.xsched.Capacity")
public class Capacity extends com.gip.xyna.xprc.xpce.planning.Capacity {

  private static final long serialVersionUID = 1L;
  private static final Logger logger = CentralFactoryLogging.getLogger(Capacity.class);


  protected static class InternalBuilder<_GEN_DOM_TYPE extends Capacity, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends com.gip.xyna.xprc.xpce.planning.Capacity.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {
  ...
  public Builder buildSchedulerCapacity() {
  ...
  */
  ...
  public static class ObjectVersion extends com.gip.xyna.xprc.xpce.planning.Capacity.ObjectVersion {
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "Capacity", "xprc.xsched", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
  ...
  */
  ...
  public static Field getField(String target_fieldname) throws InvalidObjectPathException {
    ...
    if (foundField == null) {
      return com.gip.xyna.xprc.xpce.planning.Capacity.getField(target_fieldname);
    } else {
