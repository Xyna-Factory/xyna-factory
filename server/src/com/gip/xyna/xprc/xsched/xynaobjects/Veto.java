...
@XynaObjectAnnotation(fqXmlName = "xprc.xsched.Veto")
public class Veto extends com.gip.xyna.xprc.xpce.planning.Veto {

  private static final long serialVersionUID = 1L;
  private static final Logger logger = CentralFactoryLogging.getLogger(Veto.class);


  protected static class InternalBuilder<_GEN_DOM_TYPE extends Veto, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends com.gip.xyna.xprc.xpce.planning.Veto.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {
  ...
  public Builder buildSchedulerVeto() {
  ...
  */
  public Veto(String vetoName) {
    this();
    unversionedSetVetoName(vetoName);
  }
  ...
  public static class ObjectVersion extends com.gip.xyna.xprc.xpce.planning.Veto.ObjectVersion {
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    if (!onlyContent) {
      ...
      XMLHelper.beginType(xml, varName, "Veto", "xprc.xsched", objectId, refId);
    } else {
      objectId = -1;
    }
    if (objectId != -2) {
  ...
  */
  ...
  public static Field getField(String target_fieldname) throws InvalidObjectPathException {
    ...
    if (foundField == null) {
      return com.gip.xyna.xprc.xpce.planning.Veto.getField(target_fieldname);
    } else {
