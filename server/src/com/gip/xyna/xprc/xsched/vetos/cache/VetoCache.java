...
public class VetoCache {
  ...
  public enum State {
    ...
    Compare,    //n�chster State muss untersucht werden 
    ...
    Scheduled,  //ist zum Schedulen verwendet worden, Auftrag l�uft
    Used,       //ist nun in DB eingetragen
    Free,       //Auftrag ben�tigt Veto nicht mehr
  ...
  public String changeAdminVeto(VetoCacheEntry veto, AdministrativeVeto administrativeVeto) {
    ...
    if( veto.isAdministrative() ) {
      //Umsetzen des Status, damit �nderung vom VetoCacheProcessor bearbeitet wird
 ...
 public boolean free(VetoCacheEntry veto, long orderId) {
  ...
  public void beginScheduling(long currentSchedulingRun) {
    ...
    //TODO Liste kleiner halten durch Auslagerung der selten ver�nderten Vetos im State Used?
  ...
  public void endScheduling() {
    //wird im Scheduler-Thread aufgerufen
    //alle �briggebliebenen Usable auf Unused setzen
