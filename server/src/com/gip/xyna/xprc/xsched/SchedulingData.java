...
/**
 * SchedulingData enth�lt Daten, die f�r das Scheduling der XynaOrder relevant sind.
 * 
...
public class SchedulingData implements Serializable {
  ...
  /**
   * sollen capacities beim n�chsten scheduling entnommen werden 
   */
  ...
  /**
   * falls false, z�hlt das nur f�r das n�chste scheduling. dann wird das flag wieder auf true gesetzt.
   * falls true, bleibt es true.
   * bewirkt, ob beim n�chsten scheduling die capacities entnommen werden. 
   */
