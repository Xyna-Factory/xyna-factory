...
public class CMLocal extends CMAbstract {
  ...
  protected int transportReservedCaps(List<Reservations> reservations) {
    //eigentlich darf diese Methode nicht gerufen werden, deswegen w�re 
    ...
    //auf CMLocal zu wechseln, zu einem anderen Zeitpunkt erh�lt las der ClusteredScheduler, der die 
    //Demands verwirft.
