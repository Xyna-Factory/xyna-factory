 ...
 * verwendet, um Capacities mehrfach allokieren zu k�nnen. 
 * 
 * Mehrfache bedeutet hier nicht, dass die Kardinalit�t einer Capacity h�her ist als 1, sondern dass die 
 * gesamte CapacityGruppe mehrfach allokiert wird.
 * 
 * Beispiel: MultiAllocationCapacities ({(A,1),(B,2)},min=3,max=5) m�chte eine Capacitygruppe mindestens 
 * 3 mal und maximal 5 allokieren, die Capacitygruppe besteht dabei aus 1 mal "A" und 2 mal "B".
 * <pre>
 * Vorhanden -----&gt; allokiert                Kommentar
 * A    B           A     B    allocations  
 * 20   20          5     10             5   gen�gend vorhanden, um max=5 zu erhalten
 ...
 * 10    5          0      0             0   reicht nicht mehr, um min=3 zu erf�llen -&gt; Auftrag wird nicht geschedult. 
 * </pre>
 * 
 * �ber das Flag "transferable" k�nnen die allokierten Capacities  
 */
public class MultiAllocationCapacities implements Serializable {
  ...
  private int allocations;   //wie h�ufig konnte allokiert werden? 
