...
public interface TrySchedule {
  ...
  public static enum TryScheduleResultType {
    ...
    CONTINUE,        //aus irgendeinem Grund: Fortsetzen mit n�chstem Auftrag
    ...
    RETRY_NEXT,      //in der n�chsten Scheduler-Schleife Try-Schedules r�ckg�ngig machen, weil in der n�chsten Scheduler-Schleife der Auftrag eventuell durch einen mit h�herer Urgency versteckt wird
    REORDER;         //in der n�chsten Scheduler-Schleife mit anderer Urgency
  }
  ...
  public static class TryScheduleResult {
    ...
    public static TryScheduleResult getCapacityNotAvailableInstance(CapacityAllocationResult car) {
      //TODO Performance f�r jede Capacity cachen statt immer neue Objekte zu bauen
    ...
    //timeconstraint sagt, dass z.b. zeitfenster gerade zu ist, aber sp�ter wieder aufgeht
