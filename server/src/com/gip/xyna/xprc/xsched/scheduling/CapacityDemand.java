...
public class CapacityDemand implements Serializable {
  ...
  public boolean addUrgency(long urgency, int demand) {
    if( count < maxDemand ) {
      ...
      //  add = maxDemand-count;
      //} doch ruhig mehr fordern, damit es in jedm Fall reicht. Sonst w�re folgendes m�glich:
      //3 Caps vorhanden, 2 auf A, 1 auf B. Knoten B m�chte mit hoher Urgency Auftrag mit 2 Caps schedulen,
      //Knoten A einen Auftrag mit niedriger Urgency. Was passiert? A erf�llt zuerst die Forderung von B und 
      //gibt eine Cap an B ab und fordert dann maximal 1 Cap von B. B kann nun schedulen und gibt eine Cap 
      //an A zur�ck. Nun fehlt A noch eine Cap, die er jedoch nicht mehr fordert, da er den gleichen Bedarf 
