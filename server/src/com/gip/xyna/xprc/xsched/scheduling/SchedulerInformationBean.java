...
public class SchedulerInformationBean {
  ...
  public static enum HistogramColumn {
    ...
    private boolean isRate;  //Raten-Werte k�nnen im Histogramm normlisiert werden: auf ganze Sekunden beziehen
  ...
  //TODO sortieren
  private long schedulerRunNumber = 0; //Id des letzten SchedulerRuns, Anzahl der bislang durchgef�hrten SchedulerRuns 
