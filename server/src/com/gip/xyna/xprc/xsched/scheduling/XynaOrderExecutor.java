 ...
 * </ul>
 * <br>
 * Die R�ckgabe dieser Methoden sollte meist <code>true</code> sein. <code>false</code> bedeutet, 
 * dass der ThreadPool im XynaExecutor �berlastet ist und der Aufruf daher nochmal (nach einer Pause)
 * wiederholt werden muss. Dabei wird zuerst versucht, ThreadPools mit niedrigeren Priorit�ten zu 
 * verwenden.
 * 
 * <br>
...
public class XynaOrderExecutor {
  ...
  /**
   * Start der XynaOrder: Ausf�hrung des MasterWorkflowPostScheduler im XynaExecutor
   * Achtung: dieses direkte Starten sollte nur durch den Scheduler aufgerufen werden
   * @param schedulingOrder
   * @return false, wenn Ausf�hrung nicht m�glich war und der Aufruf wiederholt werden muss
   */
  ...
  /**
   * Einstellen des XynaRunnable mit der Priorit�t <code>prio</code> in den XynaExecutor
   * Falls der ThreadPool des XynaExecutors zu der angegebenen Priorit�t belegt ist, 
   * wird versucht, den ThreadPool zur n�chstniedrigeren Priorit�t zu belegen.
   * @param xr
   * @param prio
   * @return false, wenn Ausf�hrung nicht m�glich war
   */
