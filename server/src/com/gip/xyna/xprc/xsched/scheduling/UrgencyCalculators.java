...
public class UrgencyCalculators {
   ...
   * Beispiel:
   * p     t       Interpretation
   * 0     1       Priorit�ten werden nicht ber�cksichtigt
   * 1     0       Wartezeiten werden nicht ber�cksichtigt
   * 60000 1       Eine Wartezeit von 60 Sekunden bedeutet Hochstufung um eine Priorit�tsstufe
   *
   */
