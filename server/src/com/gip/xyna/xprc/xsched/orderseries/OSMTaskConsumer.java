...
public class OSMTaskConsumer implements Runnable {
  ...
  private static final int MAX_INTERN = 3; //Maximal 3 interne Auftr�ge, dann wieder ein externer 
  ...
  public OSMTask retrieveTask() throws InterruptedException {
    ...
    if( internCounter == MAX_INTERN ) {
      //MAX_INTERN interne wurden bearbeitet, daher erst mal einen externen ausf�hren
      internCounter = 0;
  ...
  public void execute(OSMTask task) {
    ...
    try {
      ...
      //FIXME besser behandeln: Jeder Fehler bedeutet, dass Auftr�ge nicht ausgef�hrt werden!
   ...
   * unpause() ausgef�hrt und die InterruptedException weitergeworfen. 
