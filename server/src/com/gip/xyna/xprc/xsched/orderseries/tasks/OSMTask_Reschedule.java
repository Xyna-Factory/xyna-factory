...
public class OSMTask_Reschedule extends OSMTask {
    ...
    try {
      ...
      if( stillWaiting ) {
        ...
        if( orderStatusGuess.isFinished() ) {
          ...
          //Auftrag wartete bei Erstellung des Tasks noch, ist nun aber bereits fertig: das Problem hat sich von alleine gel�st
  ...
  private Solution handleWaiting(SeriesInformationStorable sis) {
    ...
    switch( sisStatus ) {
      ...
      case RUNNING:
        ...
        if( force ) {
          //Achtung: damit k�nnte Auftrag zweimal laufen!
      ...
      case CANCELED:
      case CANCELING: //sollte eigentlich nicht auftreten k�nnen
      case FAILED:
      case SUCCEEDED:
        ...
        if( force ) {
          ...
          orderSeriesManagement.removeOrder(orderId); //Achtung: damit k�nnte Auftrag zweimal laufen!
  ...
  private Solution handleFinished(SeriesInformationStorable sis) {
    ...
    switch( sisStatus ) {
      ...
      case WAITING:
        ...
        //der zugeh�rige OSMTask_Finish ist also verloren gegegangen, dies nun nachholen
      ...
      case CANCELING:
        if( mws == MasterWorkflowStatus.CANCELED ) {
          ...
          //dies sollte nicht auftreten k�nnen
  ...
  public boolean canBeStarted() {
    ...
    if( solution != null ) {
      return false; //Problem (teilweise) gel�st -> Task sollte nicht laufen
    }
  ...
  private void handleMissingSeriesInformationStorable(OSMCache osmCache) {
    ...
    if( xo != null ) {
      ...
      if( force ) {
        //unlesbare XynaOrder -> nichts mehr zu machen au�er Auftrag zu entfernen
