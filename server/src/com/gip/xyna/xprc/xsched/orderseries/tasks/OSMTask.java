...
public abstract class OSMTask {
  ...
  /*
  Versuch, eine PriorityQueue zu verwenden: Problem Finish darf nicht Preschedule �berholen, da sonst der 
  Cache (osmCache und predecessorTrees) in Unordnung ger�t (nicht schlimm, aber zuviel Anfragen in DB
