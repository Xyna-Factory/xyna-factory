...
public class SeriesInformationStorable extends ClusteredStorable<SeriesInformationStorable> {
  ...
  public static final int SIZE_ID_LIST = 100000; //viel zu gro�, soll Speicherung als Clob bewirken
  ...
  public enum OrderStatus implements StringSerializable<OrderStatus> {
    WAITING(false,false),
    RUNNING(false,false),
    CANCELING(false,false), //kein Fehler, da Successoren noch nicht gecancelt werden d�rfen
