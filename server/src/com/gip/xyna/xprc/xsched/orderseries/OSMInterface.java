...
public interface OSMInterface {
  ...
  public enum OrderState {
    ...
    HasToBeCanceled,        //Auftrag muss abgebrochen werden wegen AutoCancel des Vorg�ngers
  ...
  /**
   * Auftrag mit angegebener ID muss nicht l�nger warten und kann durch den Scheduler ausgef�hrt werden
