...
/**
 * TimeWindow ist die Basisklasse f�r verschiedene Zeitfenster-Implementierungen.
 * Nachdem ein {@link #recalculate(long) recalculate} mit dem aktuellen Timestamp aufgerufen wurde,
 * kann �ber {@link #isOpen()} der Zustand des Zeitfensters und �ber {@link #getNextChange()}
 * der Zeitpunkt des n�chsten Zustandswechsel erfragt werden.
 */
public abstract class TimeWindow {
  ...
  /**
   * TimeWindowData enth�lt die wesentlichen Daten, die das Zeitfenster derzeit charakterisieren.
   * Dazu geh�ren nicht die Daten, die Grundlage zur Neuberechnung sind.
   * <ul>
   * <li>isOpen: ist Zeitfenster derzeit offen (nextClose&lt;nextOpen)</li>
   * <li>nextOpen: n�chster Zeitpunkt, zu dem Zeitfenster ge�ffnet wird</li>
   * <li>nextClose: n�chster Zeitpunkt, zu dem Zeitfenster geschlossen wird</li>
   * </ul>
  ...
  /**
   * Was ist der Zeitpunkt des n�chsten Wechsel offen nach geschlossen oder umgekehrt?
   * @return
   */
  ...
  /**
   * Was ist der Zeitpunkt des n�chsten Wechsels offen nach geschlossen?
   * @return
   */
  public long getNextClose() {
  ...
  /**
   * Was ist der Zeitpunkt des n�chsten Wechsels geschlossen nach offen?
   * @return
   */
  public long getNextOpen() {
