...
public interface TimeControlPart {
  ...
  /**
   * berechnet den n�chsten zeitpunkt (in richtung stepping), der bzgl der schrittweite am n�hesten an "reference" liegt.
   * 
   * dazu braucht man einen st�tzpunkt, an dem man sich orientieren kann (aValidTime).
   */
      ...
      switch (stepping) {
        ...
        case AFTER :
          if (calculation.isAfter(target)) {
            ...
            //n�chstkleinere (oder gleiche) zahl, die durch increment teilbar ist 
            ...
            //n�chstgr��ere (oder gleiche) zahl, die durch increment teilbar ist 
