...
/**
 * TimeConstraintWindow ist die kapselnde Klasse, die ein oder mehrere zusammengeh�rige {@link TimeWindow}s,
 * einen Namen und Beschreibung sowie eine Liste aller auf das Zeitfenster wartenden Auftr�ge 
 * zusammenfasst.
 */
public class TimeConstraintWindow {
  ...
  private volatile ArrayList<SchedulingOrder> waitingOrders; //TODO w�re ConcurrentHashMap besser? //Lock k�nnte evtl. entfallen
  ...
  public void setRemoved() {
    //TODO Warnung, wenn noch wartende Auftr�ge vorliegen
  ...
  /**
   * Hinzuf�gen eines wartenden Auftrags
  ...
  /**
   * Wiedereinstellen aller wartenden Auftr�ge in den Scheduler
   * (wird innerhalb des Locks gerufen)
   * @param allOrders
   */
  ...
  /**
   * Schutz, damit nicht gleichzeitig Zeitfenster ge�ffnet wird und trotzdem noch 
   * wartende Auftr�ge angeh�ngt werden.   
   */
  public void lock() {
    lock.lock();
  }
