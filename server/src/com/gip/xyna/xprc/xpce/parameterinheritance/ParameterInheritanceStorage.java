...
public class ParameterInheritanceStorage {
  ...
  /**
   * �ndert eine bestehende InheritanceRule oder legt sie neu an, falls sie noch nicht existiert.
   * @param parameterType
   * @param dk
  ...
  /**
   * L�scht alle InheritanceRules f�r einen OrderType.
   * @param dk
   * @throws PersistenceLayerException
   * @throws XFMG_NoSuchRevision
   */
