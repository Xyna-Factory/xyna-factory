...
public class ServiceDestination extends DestinationValue {
  ...
  private static class FractalProcessStepServiceDestination extends FractalProcessStep<ServiceDestinationWrapper> implements JavaCall {
    ...
    public void executeInternally() throws XynaException {
      //TODO performance: method cachen (siehe auskommentierter code). achtung: dann ben�tigt man einen cache-refresh mechanismus, der beim classreloading des services zuschl�gt. vgl bug 15802
  ...
  private Method getOperationOfService(XynaOrderServerExtension xo)
    ...
    try {
      ...
      try {
        ...
        throw new RuntimeException(e); //sollte nicht passieren, weil dann eher MDMObjectClassLoaderNotFoundException kommen w�rde.
      }
    }
  ...
  public boolean equals(Object obj) {
    //wenn die destination gleich ist, kann sie trotzdem deployed werden m�ssen, weil sie auf alte classloader zeigt (vgl bug 15802)
    return this == obj;
  }
