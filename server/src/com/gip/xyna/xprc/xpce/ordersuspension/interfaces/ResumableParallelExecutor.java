...
public interface ResumableParallelExecutor {
  ...
  public static enum ResumeState {
    ...
    NotFound, 
    /**
     * FractalWorkflowParallelExecutor ist in einem Zustand, in dem er nicht l�uft und daher keine Resumes durchf�hren kann
     */
    NotRunning, 
    /**
     * Resume hat geklappt
  ...
  /**
   * Wartet, bis alle Threads der parallelen Ausf�hrung beendet sind
   * @return
