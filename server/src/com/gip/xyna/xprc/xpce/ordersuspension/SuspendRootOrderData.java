 ...
 *    <li>Interrupt: alle ausf�hrenden Thread erhalten ein Interrupt</li>
 *    </ul></li>
 * <li>SuspensionFailedAction: Behandlung im Fehlerfall "Suspendierung nicht fertig":
 *    <ul>
 *    <li>UndoSuspensions: Bisherige Suspendierungen werden r�ckg�ngig gemacht</li>
 *    <li>StopSuspending: Es werden keine weiteren Suspendierungen durchgef�hrt, bestehende Suspendierungen werden nicht r�ckg�ngig gemacht</li>
 *    <li>KeepSuspending: Es wird weiter suspendiert, bestehende Suspendierungen werden nicht r�ckg�ngig gemacht</li>
 *    </ul></li>
 * <li>Timeout und SuspensionCause</li>
 * </ul>
 * Als R�ckgabe werden folgende Daten eingetragen
 * <ul>
...
public class SuspendRootOrderData {
  ...
  public enum SuspensionFailedAction {
    /**
     * Bisherige Suspendierungen r�ckg�ngig machen
     */
    UndoSuspensions,
    /**
     * Nicht weiter suspendieren, bestehende Suspendierungen nicht r�ckg�ngig machen
     */
    StopSuspending,
    /**
     * Weiter suspendieren, bestehende Suspendierungen nicht r�ckg�ngig machen
     */
    KeepSuspending;
  }
