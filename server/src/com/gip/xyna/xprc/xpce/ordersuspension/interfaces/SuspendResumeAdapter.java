...
public interface SuspendResumeAdapter<C,O> {
  ...
  /**
   * Supendieren des Auftrags, indem dieser gebackupt wird //FIXME aufr�umen?
   * @param order
  ...
  /**
   * Ssupendierung aller Kindauftr�ge im Scheduler und Eintragen der ResumeTargets in RootOrderSuspension
   * @param rootSRInformation
   * @param rootOrderSuspension
   * @return
   */
  ...
  /**
   * Resume mehrerer Root-Auftr�ge mit Retries
  ...
  /**
   * Schickt Interrupts an alle ausf�hrenden Threads
   * @param rootSRInformation
   * @param rootOrderSuspension
  ...
  /**
   * Wartet, bis RootOrders im OrderBackup zug�nglich sind
   * @param retry
   * @param rootId
   * @return
   */
