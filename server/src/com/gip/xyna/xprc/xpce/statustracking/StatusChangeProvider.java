...
public class StatusChangeProvider extends FunctionGroup {
  ...
  private void notifyListeners(XynaOrderServerExtension xo, String newState, Long sourceId) {
    ...
    readLock.lock();
    try {
      //TODO performance: die sicherheitskopie k�nnte man auch nur einmal machen und sich dann in der xynaorder merken.
     
      //vielleicht ist das sogar ein bug, und man MUSS das machen. ansonsten werden nicht alle zustands�berg�nge
      //eines auftrags innerhalb eines listeners ausgef�hrt
      //achtung: transactionmgmt verl�sst sich auf das bisherige feature!!
      ...
      //ungelockt auf kopie arbeiten, falls statusChanged l�nger dauert
