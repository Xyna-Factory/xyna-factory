...
public class MasterWorkflowPreScheduler {
  ...
  public void startOrder() {
    ...
    try {
      ...
      try {
        if (!OrdertypeManagement.internalOrdertypes.contains(xo.getDestinationKey().getOrderType())) { //achtung, interne destinationkeys �berschreiben teilweise methoden, vgl. XynaDispatcher.<clinit>
          //wenn die revision nicht gesetzt ist, die aus dem destinationkey �bernehmen
          ...
          //in welcher revision ist der ordertype definiert? => entsprechenden RTC auch f�r den destinationkey verwenden
