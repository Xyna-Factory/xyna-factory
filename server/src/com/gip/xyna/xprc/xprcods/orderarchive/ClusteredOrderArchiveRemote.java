...
public class ClusteredOrderArchiveRemote extends LocalRemote implements ClusteredOrderArchiveRemoteInterface {


  ClusteredOrderArchiveRemote(ODS ods) {
    super(ods);
  }
  ...
  public Pair<SortedMap<OrderInstance, Collection<OrderInstance>>, List<OrderInstance>> searchConnectionTypeRemotly(OrderInstanceSelect select,
    ...
    return this.searchConnectionType(select, maxRows, startTime, searchMode, connectionType, selectedPreCommittedOrdersFromDEFAULT);
  }
  ...
  public int sendCountQueryForConnectionTypeRemotly(OrderInstanceSelect select, ODSConnectionType connectionType) throws RemoteException,
    ...
    return this.sendCountQueryForConnectionType(select, connectionType);
  }
