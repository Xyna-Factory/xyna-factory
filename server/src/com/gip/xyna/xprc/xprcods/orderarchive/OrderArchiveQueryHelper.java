...
public final class OrderArchiveQueryHelper {
  ...
  /**
   * ohne suspendierte auftr�ge mit monitoringlevel &gt;= 15, ggfs inkl suspendierter auftr�ge 
   * mit kleinerem monitoringlevel (dort kann man es nicht unterscheiden)<p>
   * da eine query aufs orderarchive, werden typischerweise nur auftr�ge mit monitoringlevel &gt;= 10 angezeigt
   */
