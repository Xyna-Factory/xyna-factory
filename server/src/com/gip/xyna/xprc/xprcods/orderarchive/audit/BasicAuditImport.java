 ...
 * Dies sind f�r die Modellierung wichtige Datentypen (z.B. Xyna Exception, Xyna Exception Base,
 * Exception, Storable, ...).
 *
 */
public class BasicAuditImport {
  ...
  //TODO auditImports-Cache refreshen, wenn sich eine Basis-Application ge�ndert hat
