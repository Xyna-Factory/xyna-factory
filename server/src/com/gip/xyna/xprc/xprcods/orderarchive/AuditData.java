...
public class AuditData implements Serializable {
  ...
  private transient Long rootRevision;
  ...
  public AuditData(XynaOrder order) {
    ...
    if (((XynaOrderServerExtension)order).getRootOrder() == null) {
      rootRevision = revision;
    } else {
      rootRevision = ((XynaOrderServerExtension)order).getRootOrder().getRevision();
    }
  }
  ...
  private void readObject(ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
    this.rootRevision = inputStream.readLong();
  ...
  public void setRootRevision(Long rootRevision) {
