...
public class OrderInstanceBackup extends ClusteredStorable<OrderInstanceBackup> {
  ...
  public static enum BackupCause {
    ...
    /**
     * nachdem Auftrag vom Scheduler in die Execution-Phase �bergeht
     */
    AFTER_SCHEDULING(-1),
    ...
    /**
     * bei Suspendierung werden beendete Kindauftr�ge mit diesem BackupCause gesichert
     */
    FINISHED_SUBWF(-1),
  ...
  /**
   * Dies ist ein Workaround f�r Bug 12543/12550: In UpdateOrderInstanceBackupWithRootOrderID 
   * wurde die rootId eingef�hrt und sollte dort auch in die OrderInstanceDetails eingetragen 
  ...
  private static ResultSetReader<OrderInstanceBackup> reader = new ResultSetReader<OrderInstanceBackup>() {
