...
public abstract class XynaRunnable implements Runnable {
  ...
  void setExecutingThread(Thread t) {
    if (executingThread != null && t != null) {
      //xyna runnables k�nnen wegen der thread-referenzen nicht parallel wiederverwendet werden.
      //siehe bugz 12663. das f�hrt zu ganz fiesen problemen.
  ...
  /**
   * wird von XynaThreadPoolExecutor aufgerufen, bevor RejectionHandler ausgef�hrt wird. 
   * ACHTUNG: Falls false zur�ckgegeben wird, wird dem Einsteller des Tasks in den Threadpool nicht Bescheid gegeben, dass das Task nicht ausgef�hrt wird.
   */
