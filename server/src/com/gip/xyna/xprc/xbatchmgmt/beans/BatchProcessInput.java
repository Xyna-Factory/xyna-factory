...
public class BatchProcessInput implements Serializable{
  ...
  private RemoteXynaOrderCreationParameter masterOrder; //XynaOrderCreationParameter des Masters (enth�lt die TimeConstraints) 
  ...
  private InputGeneratorData inputGeneratorData; //Daten f�r den Input Generator
  ...
  private TimeWindowDefinition timeWindowDefinition; //wenn Zeitfenster nur f�r den BatchProcess angelegt wird, wird hier die Definition �bergeben
