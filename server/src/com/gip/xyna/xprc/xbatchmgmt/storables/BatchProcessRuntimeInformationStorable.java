...
public class BatchProcessRuntimeInformationStorable extends Storable<BatchProcessRuntimeInformationStorable> {
  ...
  public static final String COL_NEXT_EXECUTION_TIME = "nextExecutionTime"; //N�chster Zeitpunkt, zu dem fr�hestens ein Scheduling m�glich sein wird; -1 falls die Ausf�hrung zu diesem Zeitpunkt rein durch Kapazit�ten beschr�nkt ist
  public static final String COL_STATE = "state"; //aktueller Status des BatchProcesses
  public static final String COL_RUNNING = "running"; //Anzahl der gerade laufenden Subauftr�ge
  ...
  public static final String COL_PAUSE_CAUSE = "pauseCause"; //Ursache f�r das Pausieren des Batch Processes
  ...
  private String nextExecutionTime; //N�chster Zeitpunkt, zu dem fr�hestens ein Scheduling m�glich sein wird; -1 falls die Ausf�hrung zu diesem Zeitpunkt rein durch Kapazit�ten beschr�nkt ist

  @Column(name = COL_STATE)
  private BatchProcessState state; //aktueller Status des BatchProcesses

  @Column(name = COL_RUNNING)
  private int running; //Anzahl der gerade laufenden Subauftr�ge
  ...
  private String pauseCause; //Ursache f�r das Pausieren des Batch Processes
  ...
  /**
   * Z�hlt running um eins runter, falls der Slave bereits gebackupt wurde
   */
  public void decrRunningIfBackuped(OrderInstanceStatus slaveState) {
    //Running nur runterz�hlen, falls der Slave im Planning keinen Fehler hatte
    //(da running erst beim Backup hochgez�hlt wird)
