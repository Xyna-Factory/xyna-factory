 ...
 * zu l�schen, nachdem das entsprechende BatchProcessArchiveStorable angelegt wurde.
 *
 */
public class ArchiveBatchProcess implements WarehouseRetryExecutableNoResult {
  ...
  public void executeAndCommit(ODSConnection con) throws PersistenceLayerException {
    //Es soll jetzt nichts mehr an den RuntimeInformations ge�ndert werden.
    ...
    //BatchProcessRuntimeInformation Eintrag l�schen
    con.deleteOneRow(runtimeInformation);
    
    //BatchProcessCustomizationStorable Eintrag l�schen
    con.deleteOneRow(customization);
    
    //BatchProcessRestartInformationStorable Eintrag soll derzeit nicht gel�scht werden
    //Daher sogar persistieren, um �nderungen zu behalten
