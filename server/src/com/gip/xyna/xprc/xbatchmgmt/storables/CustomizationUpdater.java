...
/**
 * CustomizationUpdater f�hrt ein Update auf einem BatchProcessCustomizationStorable aus.
 *
 */
public class CustomizationUpdater implements WarehouseRetryExecutableNoResult {
  ...
  /**
   * Inkrementieren der Counter um die �bergebenen Werte
   * @param counter
   */
  ...
  /**
   * Setzen der Counter auf die �bergebenen Werte
   * @param counter
   */
  ...
  public void update() {
    ...
    try {
      ...
      //Die Exception wird hier unterdr�ckt mit folgendem Grund:
      //1) die Slaves k�nnen in ihrer Execution-Phase diesen Fehler nicht behandeln
      //2) nach kurzer Zeit wird der n�chste Slave ebenfalls ein Update machen und dann die aktuelle 
      //   �nderung mit persistieren
