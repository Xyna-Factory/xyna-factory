...
/**
 * AcknowledgableObject das daf�r sorgt, dass die Anzahl der laufenden Auftr�ge in der
 * BatchProcessRuntimeInformation nur hochgez�hlt und der Input als "used" markiert werden,
...
public class SlaveBackupAck extends AbstractBackupAck {
  ...
  /**
   * Connection bei Fehler im Planning schlie�en
   */
  @Override
