...
public class BatchProcessSlaveCreatorTask implements ParallelTask {
  ...
  /**
   * Holt sich die n�chsten Inputs f�r die Slaves, legt SlaveTasks zum Starten
   * der Slaves an und f�hrt diese im ParallelExecutor aus.
   */
  public void execute() {
    //SlaveTasks in den ParallelExecutor einstellen
    int numberOfSlaves = allocatedCaps;
    //Wenn die Anzahl der zu startenden Slaves nicht durch Kapazit�ten beschr�nkt ist,
