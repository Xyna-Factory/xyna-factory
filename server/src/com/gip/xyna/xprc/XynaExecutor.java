...
public class XynaExecutor {
  ...
  private XynaExecutor() {
    ...
    for (int i = 1; i < 11; i++) {
      // keine (bzw leere) queue, weil ansonsten subauftr�ge nie gestartet werden k�nnten, deren parentauftr�ge die
      // threads blockieren
      // grund daf�r ist, dass die threadpoolexecutoren die logik besitzen, dass neue threads oberhalb von der
      // corepoolsize
