...
public class Redirection extends ResponseListener implements Serializable {
  ...
  //TODO was passiert, wenn redirectionauftrag am laufen ist, und neu gestartet wird mit der wfabstraction? f�r die execution braucht sie einen verweis auf die xynaorder!

  private WorkflowAbstractionLayer<RedirectionBean, RedirectionAnswer> wfAbstraction;
  private XynaOrderServerExtension parentRootOrder; //root of stuck workflowfamily TODO wird heir doppelt gespeichert: einmal regul�res OrderBackup der parentRootOrder, zum zweiten hier im MI-Auftrag
  ...
  /**
   * startet den �ber die wfAbstraction definierten auftrag asynchron.
   * der urspr�ngliche Auftrag wird erst danach fortgesetzt.
...
- fehlerzustand behalten, bzw fehler erneut werfen
  das ist nicht so einfach! man will ja auch kompensation. man m�sste dazu alle steps, die einen fehler geworfen haben, erneut durchlaufen, bis auf den letzten - 
...
- schritt erneut ausf�hren

fall 2: wf step h�ngt weiter
  ...
  private void handleResponse(final RedirectionAnswer rAnswer) throws XNWH_RetryTransactionException {
    ...
    WarehouseRetryExecutableNoResult wre = new WarehouseRetryExecutableNoResult() {
      ...
      public void executeAndCommit(ODSConnection con) throws PersistenceLayerException {
        ...
        //ParentRootOrder nun so backuppen, dabei Redirection entfernen, da bereits ausgef�hrt.
        ...
        //Fortsetzen des urspr�nglichen Auftrags, beim Commit dann in den Scheduler aufnehmen
