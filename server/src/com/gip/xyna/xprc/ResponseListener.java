 ...
 * responselisteners eine antwort zur�ck (das connectionobjekt kann so behalten werden)
 */
public abstract class ResponseListener implements Serializable {
   ...
   * �ber den OrderContext k�nnen offene Connections weiterbenutzt werden o.�.
   * @param response
   * @param ctx
   */
  ...
  /**
   * wird vom Processing aufgerufen, falls die Prozessausf�hrung in einem
   * Fehler geendet hat.
   * @param e
   * @param ctx
   */
