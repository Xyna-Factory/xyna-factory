...
public class CronLikeOrderCreationParameter extends XynaOrderCreationParameter {
  ...
  //Startzeitpunkt und Intervall zwischen zwei Events f�r periodische Vorg�nge
  ...
  //evtl will man aber unterscheiden zwischen customfeldern f�r die clo-tabelle und customfeldern f�r die gespawnten auftr�ge
  //dann ben�tigt man einen speicherort... derzeit werden die in der gui angegebenen customfelder f�r beides verwendet.
  ...
  /**
   * Setzt die Startzeit. Wird null oder 0 �bergeben, so 
   ...
   * falls ein neuer Wert gr��er als 0 �bergeben wird.
   * @param interval
   */
  public void setInterval(Long interval) {
    if (interval != null) {
      ...
      if (interval != 0 && !interval.equals(this.interval)) {
        //calendarDefinition neu berechnen, falls sich das Intervall ge�ndert hat
  ...
  /**
   * Wandelt ein Millisekunden-Intervall in eine CalendarDefinition f�r ein RestrictionBasedTimeWindow um.
   * @param interval
   * @return
   */
  ...
  /**
   * Baut ein CronLikeOrderCreationParameter-Objekt. Dabei kann �ber Type gesteuert werden, ob
   * die CronLikeOrderCreationParameter f�r ein Create oder ein Modify verwendet werden sollen.
   * 
   * Zum Beispiel k�nnen CronLikeOrderCreationParameter zum �ndern des Labels und der calendarDefinition
