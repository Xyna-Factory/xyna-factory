...
public interface Scope {
  ...
  /**
   * wieviel InputVars werden ben�tigt?
   */
   ...
   * bei paralleler ausf�hrung von threads ist hier nicht sichergestellt, dass alle 
   * steps zur�ckgegeben werden, da diese evtl erst dynamisch erzeugt werden (for-each).
   */
  FractalProcessStep<?>[] getAllSteps();

  /**
   * alle steps die nicht zu einer verschachtelten scope geh�ren
   */
