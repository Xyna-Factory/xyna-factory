...
public class DefaultAFractalWorkflowProcessorProcessingCheckAlgorithm implements AFractalWorkflowProcessorProcessingCheckAlgorithm {

  public void checkOrderReadyForProcessing(XynaOrderServerExtension xo, DispatcherType type) throws XynaException {
    // no additional checks required before processing for default behavior    
  }
