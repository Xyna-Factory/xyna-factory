...
public abstract class DefaultSubworkflowCall<T extends Scope> extends FractalProcessStep<T> implements SubworkflowCall {
  ...
  private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
    ...
    //passiert genau dann, wenn durch klassen�nderung ein ehemals teilausgef�hrter nicht-subworkflow-step beim deserialisieren durch einen subworkflow-step ersetzt wird
    //dann ist firstExecution == false und subworkflow == null. wenn man diesen fix nicht einbaut, w�rde beim resume der subworkflow kein planning durchf�hren.
    //trifft zwar auch bereits beendete detached subworkflow-aufrufe, aber das macht nichts. da ist dann halt das flag merkw�rdig gesetzt...
    s.defaultReadObject();
  ...
  //false, falls compensation �berschrieben ist, oder der subworkflow (rekursiv) selbst keine compensation-schritte enth�lt
