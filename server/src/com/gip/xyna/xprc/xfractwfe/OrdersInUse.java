...
public class OrdersInUse implements Serializable{
  ...
  public enum FillingMode {
    ...
    EasyInfos, //alle Informationen die leicht bestimmt werden k�nnen, werden gesetzt
  ...
  private final Map<Long, OrderInfo> rootOrders = new HashMap<Long, OrderInfo>(); //laufende Root-Auftr�ge (ohne Batch Prozess Master)
  ...
  /**
   * Tr�gt eine neue XynaOrder ein, falls es ein Root-Auftrag ist und kein Batch Prozess Master
   * @param oi
   * @param binding
   */
  ...
  /**
   * Tr�gt eine neue XynaOrder ein, falls noch nicht vorhanden und
  ...
  /**
   * Tr�gt eine Cron Like Order ein
   * @param clo
   */
  ...
  /**
   * Tr�gt einen FrequencyControlledTask ein
   * @param id
   * @param orderType
   * @param binding
   */
