...
public class DeploymentLocks {
  ...
  private static class DeploymentLockCompound extends ObjectWithRemovalSupport {
    ...
    private final Semaphore semaphore = new Semaphore(PERMITS, true); //fair, weil sonst das "writelock" ewig warten k�nnte
  ...
  /**
   * passiert immer mit dem gleichen thread als das zugeh�rige readlock.
  ...
  /**
   * passiert evtl mit einem anderen thread als das zugeh�rige writelock
   */
