 ...
 * 
 * path-variable ist der default-pfad f�r den audit etc
 */
public final class Path implements Serializable {
  ...
  //TODO cache reduzieren auf die objekte, die man wirklich ben�tigt
  ...
  /**
   * erstellt ein pfad-objekt, passend zu dem xfl-path, bezogen auf das datenmodell. das pfad-objekt enth�lt
   * ggfs die OID, die sich aus den OID-bestandteilen, die im datenmodell angegeben sind, zusammensetzt.
   * 
   * falls der pfad im datenmodell nicht aufgel�st werden kann oder das datenmodell null ist, wird der pfad 1:1 �bernommen
   */
  public static Path createPath(String xflVariablePath, String fqDataModelName) throws XPRC_InvalidPackageNameException,
    ...
    /*
     * am dom entlang hangeln und f�r jeden schritt aus dem datenmodell entsprechend OID auslesen
     * 
     * index-informationen werden im syntax ".<index>" angef�gt (nicht [<index>] wie es bei XFL ist)
     * 
     */
  ...
  /**
   * gibt die datamodel-infos zur�ck, die an im datenmodell an der stelle, die durch den pfad beschrieben ist, angegeben sind. 
   * gibt null zur�ck, falls der pfad im datenmodell nicht aufgel�st werden kann.
   */
