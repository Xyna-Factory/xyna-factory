...
public abstract class Step implements XmlAppendable, HasMetaTags {
  ...
  public boolean replaceChild(Step oldChild, Step newChild) {
    throw new UnsupportedOperationException(); //wird in Kindklassen teilweise ausf�hrbar
  }
  ...
  /**
   * gibt ids von vars zur�ck, die in diesem schritt als input gelten. wird von stepcatch benutzt
   */
  ...
  /**
   * gibt ids von vars zur�ck, die in diesem schritt als output gelten. wird von stepcatch benutzt
   */
