...
public abstract class DomOrExceptionGenerationBase extends GenerationBase implements HasDocumentation {
  ...
  /**
   * reihenfolge: membervars von oberklasse zuerst. (je h�her in hierarchie, desto fr�her werden die vars angegeben).
  ...
  private Set<GenerationBase> getSubTypesInternally(GenerationBaseCache parseAdditionalCache, boolean resolveFromGlobalCache) {
    //dependencyregister bem�hen. das mag zu beginn nicht vollst�ndig sein, aber zu dem zeitpunkt sind die subtypen dann halt noch nicht bekannt. ok
