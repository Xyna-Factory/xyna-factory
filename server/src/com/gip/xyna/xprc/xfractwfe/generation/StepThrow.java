...
public class StepThrow extends Step {
  ...
  protected void appendExecuteInternally(CodeBuffer cb, HashSet<String> importedClassesFqStrings) {
     ...
     * negative nebeneffekt: erst exception erstellen, dann in mapping anpassen, dann werfen, f�hrt nicht zu einem stacktrace von "weiter vorne" im workflow.
    ...
    if (targetExceptionVariable.variable.isJavaBaseType() &&
      ...
      //FIXME das clone f�hrt zu h�sslichem stacktrace. der f�ngt dann immer mit clone() an, wo man sich fragt "wieso?"
    ...
    if (isIncludeCause()) {
      ...
      //das hat auch den vorteil, dass man nicht �ber die xynaexceptioninformationthrowable gehen muss.
      cb.addLB();
