...
public abstract class Operation implements HasDocumentation {
  ...
  /**
   * enth�lt ggfs auch xynaexception-klasse
   */
  ...
  /**
   * signature ab output, ohne �ffnende klammer f�r impl, also z.b.<br>
  ...
  /**
   * vergleicht methodenname, und inputvariablen auf kompatibilit�t. es ber�cksichtigt nicht "throws"-parameter und outputparameter 
   */
