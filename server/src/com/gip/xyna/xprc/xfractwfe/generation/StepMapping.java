      ...
      for (int i = 0; i < rawExpressions.size(); i++) {
        ...
        if (parsed == null) {
          ...
          if (parsed.getFoundAssign() == null && !parsed.hasPathMapTarget()) {
            //TODO hier m�sste man noch �berpr�fen, dass das pathmaptarget auch ohne values zurecht kommt.
    ...
    public void functionStarts(FunctionExpression fe) {
      if (fe instanceof DynamicResultTypExpression) {
        ...
        try {
          ...
          //ignore, fehler passiert sp�ter beim validieren. bei getDependencies soll es keinen fehler geben
        }
      }
    }
