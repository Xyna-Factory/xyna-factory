...
/**
 * Steuerung welche XynaObjekte oder Exceptions in welcher Form zur�ckgegeben werden, damit man sich gegen
 * Deserialisierungsprobleme durch unbekannte Klassen sch�tzen kann.<br>
 * 
 * Beispiel: Eine Exception enth�lt einen Cause, dessen Exceptionklasse aus einem PersistenceLayer kommt. Dann
 ...
 * zur�ckgegeben werden sollen, und welche in anderer Form (z.b. nur bestehend aus Klassenname, Message
 * und Stacktrace).<br>
 * Das gleiche kann auch f�r XynaObjekte gesteuert werden (Wahl zwischen XML und Original Javaobjekt). 
 * TODO Achtung: Diese k�nnen als Membervariablen auch Exception enthalten. Diese sollen von dieser Klasse
...
public final class ResultController implements Serializable {
  ...
  /**
   * default ist XML. hiermit kann man angeben, dass auch andere daten zur�ckgegeben werden sollen
   */
  ...
  /**
   * alle exceptions deren classloader von der �bergebenen klasse ist (oder davon abgeleitet) werden wie angegeben
   * gewrapped.
   */
   ...
   * alle exceptions die von der angegebenen klasse sind (oder davon abgeleitet) werden wie angegeben
   * gewrapped.<br>
   * hilfsmethode f�r private classloader klassen.
   */
   ...
   * <ul>
   * <li>SIMPLE ist immer unterst�tzt</li>
   * <li>defaultForException ist immer unterst�tzt</li>
   * <li>ORIGINAL ist f�r alle mit dem bootstrap classloader geladenen klassen unterst�tzt</li>
   * <li>ansonsten ist die klasse genau dann unterst�tzt, wenn sie �ber supportedExceptionClasses oder -ClassLoader angegeben wurde</li>
   * </ul> 
   */
