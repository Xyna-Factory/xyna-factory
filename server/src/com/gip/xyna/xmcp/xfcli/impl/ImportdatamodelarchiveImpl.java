...
import com.gip.xyna.xmcp.xfcli.generated.Importdatamodelarchive;



public class ImportdatamodelarchiveImpl extends XynaCommandImplementation<Importdatamodelarchive> {

  public void execute(OutputStream statusOutputStream, Importdatamodelarchive payload) throws XynaException {
    ...
    dmm.importDataModelArchive(result, payload.getFilename(), payload.getOverwrite());
