...
import com.gip.xyna.xmcp.xfcli.generated.Undeploy;


public class UndeployImpl extends XynaCommandImplementation<Undeploy> {

  public void execute(OutputStream statusOutputStream, Undeploy payload) throws XynaException {
    ...
    try {
      XynaFactory.getInstance().getProcessing().getWorkflowEngine()
          .undeployWorkflow(payload.getFqWorkflowName(), false, payload.getIgnore(), revision);
    } finally {
