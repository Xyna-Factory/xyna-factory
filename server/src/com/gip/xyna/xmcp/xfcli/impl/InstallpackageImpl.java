...
import com.gip.xyna.xmcp.xfcli.generated.Installpackage;



public class InstallpackageImpl extends XynaCommandImplementation<Installpackage> {

  @Override
  public void execute(OutputStream statusOutputStream, Installpackage payload) throws XynaException {
    ...
    try {
      ...
      try {
        factory.getXynaMultiChannelPortalPortal().installDeliveryItem(deliveryItemInputStream, statusOutputStream,
                                                                      payload.getForceoverwrite(),
                                                                      payload.getNoupdatemdm(), payload.getVerbose());
      } finally {
