...
import com.gip.xyna.xmcp.xfcli.generated.Undeployexception;


public class UndeployexceptionImpl extends XynaCommandImplementation<Undeployexception> {

  public void execute(OutputStream statusOutputStream, Undeployexception payload) throws XynaException {
    ...
    try {
      XynaFactory.getInstance().getProcessing().getWorkflowEngine()
          .undeployException(payload.getFqExceptionName(), false, payload.getIgnore(), revision);
    } finally {
