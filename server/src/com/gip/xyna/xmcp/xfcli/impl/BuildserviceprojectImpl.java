...
import com.gip.xyna.xmcp.xfcli.generated.Buildserviceproject;



public class BuildserviceprojectImpl extends XynaCommandImplementation<Buildserviceproject> {

  public void execute(OutputStream statusOutputStream, Buildserviceproject payload) throws XynaException {
    String targetString = payload.getTargetDirectory();
    String implementationString = payload.getFqDatatypeName();

    writeToCommandLine(statusOutputStream, "Using target location " + targetString + " and implementation parameters "
    ...
    File f;
    try {
      InputStream is = factory.getXynaMultiChannelPortalPortal().getServiceImplTemplate(FileUtils.generateRandomFilename(targetString, "t", ""), implementationString, revision, true, true);
