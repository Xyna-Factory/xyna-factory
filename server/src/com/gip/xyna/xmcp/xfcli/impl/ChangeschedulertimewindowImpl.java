...
import com.gip.xyna.xmcp.xfcli.generated.Changeschedulertimewindow;
...
public class ChangeschedulertimewindowImpl extends XynaCommandImplementation<Changeschedulertimewindow> {

  public void execute(OutputStream statusOutputStream, Changeschedulertimewindow payload) throws XynaException {
    ...
    if( payload.getComment() != null ) {
      ...
      TimeConstraintWindowDefinition def = tcm.getDefinition(payload.getName());
      if( def == null ) {
        throw new IllegalStateException("TimeWindow "+payload.getName()+" does not exist" );
      }
      builder.setDescription(def.getDescription());
    }
    tcm.changeTimeWindow(builder.construct());
