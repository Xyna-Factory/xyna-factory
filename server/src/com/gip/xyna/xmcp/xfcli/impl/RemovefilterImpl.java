...
import com.gip.xyna.xmcp.xfcli.generated.Removefilter;



public class RemovefilterImpl extends XynaCommandImplementation<Removefilter> {

  public void execute(OutputStream statusOutputStream, Removefilter payload) throws XynaException {
    ...
    try {
      //Filter f�r sp�tere Status-Ausgabe suchen
      ...
      //Filter entfernen
      factory.getXynaMultiChannelPortalPortal().removeFilter(payload.getFilterName(), revision);
      ...
      CommandControl.unlock(CommandControl.Operation.FILTER_REMOVE, revision);
    }
  }
