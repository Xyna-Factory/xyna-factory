...
import com.gip.xyna.xmcp.xfcli.generated.Addwarehousecopyjob;
...
public class AddwarehousecopyjobImpl extends XynaCommandImplementation<Addwarehousecopyjob> {

  public void execute(OutputStream statusOutputStream, Addwarehousecopyjob payload) throws XynaException{
    ...
    job = WarehouseJobFactory.getCronWarehouseJob("XynaProperty Job", WarehouseJobActionType.Copy, interval, null,
