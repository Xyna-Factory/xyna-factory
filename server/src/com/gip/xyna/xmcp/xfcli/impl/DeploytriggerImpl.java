...
import com.gip.xyna.xmcp.xfcli.generated.Deploytrigger;



public class DeploytriggerImpl extends XynaCommandImplementation<Deploytrigger> {

  public void execute(OutputStream statusOutputStream, Deploytrigger payload) throws XynaException {
    ...
    try {
      ...
      XynaFactory
          ...
          .deployTrigger(payload.getTriggerName(), payload.getTriggerInstanceName(), payload.getStartParameters(), "",
