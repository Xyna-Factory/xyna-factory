...
public class KillThread implements CommandExecution {
  ...
  public void execute(AllArgs allArgs, CommandLineWriter clw) {
    ...
    //TODO parametrisierung �ber parameter die bei kill -3 sichtbar sind. 
    //"VM Thread" prio=10 tid=0x000000005f7cf800 nid=0x7d96 runnable  -> weder tid (adresse des threads) noch nid h�ngen eindeutig mit der thread id zusammen.
