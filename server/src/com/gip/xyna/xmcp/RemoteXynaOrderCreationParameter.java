 ...
 * enthaltene InputPayload als XynaObject nicht au�erhalb der Factory 
...
public final class RemoteXynaOrderCreationParameter extends XynaOrderCreationParameter {
  ...
  /**
   * gibt xml immer ohne wrapper-element zur�ck
   * @return
   */
   ...
   * auch wieder au�erhalb der Factory deserialisiert werden kann
   */
