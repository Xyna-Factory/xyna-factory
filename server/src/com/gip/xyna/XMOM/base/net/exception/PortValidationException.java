...
public class PortValidationException extends ValidationException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  private PortValidationException() {
    super(new String[] {"XYNA-BASE-00015", null});
  }


  public PortValidationException(String parameter1) {
    super(new String[]{"XYNA-BASE-00015", parameter1 + ""});
    setParameter1(parameter1);
  }

  public PortValidationException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00015", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected PortValidationException(String[] args) {
    super(args);
  }

  protected PortValidationException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public PortValidationException initCause(Throwable t) {
    return (PortValidationException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "PortValidationException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(PortValidationException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public PortValidationException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public PortValidationException cloneWithoutCause(boolean deep) {
    PortValidationException cloned = new PortValidationException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends PortValidationException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends ValidationException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(PortValidationException instance) {
      super(instance);
    }

    public PortValidationException instance() {
      return (PortValidationException) instance;
    }

  }

  public static class Builder extends InternalBuilder<PortValidationException, Builder> {
    public Builder() {
      super(new PortValidationException());
    }
    public Builder(PortValidationException instance) {
      super(instance);
    }
  }

  public Builder buildPortValidationException() {
  ...
  public static Field getField(String target_fieldname) {
    ...
    try {
      foundField = PortValidationException.class.getDeclaredField(target_fieldname);
