...
import com.gip.xyna.xprc.xsched.xynaobjects.InvalidDateStringException;

public class AddressNoNetmaskException extends ValidationException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  private AddressNoNetmaskException() {
    super(new String[] {"XYNA-BASE-00004", null});
  }


  public AddressNoNetmaskException(String parameter1) {
    super(new String[]{"XYNA-BASE-00004", parameter1 + ""});
    setParameter1(parameter1);
  }

  public AddressNoNetmaskException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00004", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected AddressNoNetmaskException(String[] args) {
    super(args);
  }

  protected AddressNoNetmaskException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public AddressNoNetmaskException initCause(Throwable t) {
    return (AddressNoNetmaskException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "AddressNoNetmaskException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(AddressNoNetmaskException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public AddressNoNetmaskException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public AddressNoNetmaskException cloneWithoutCause(boolean deep) {
    AddressNoNetmaskException cloned = new AddressNoNetmaskException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends AddressNoNetmaskException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends ValidationException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(AddressNoNetmaskException instance) {
      super(instance);
    }

    public AddressNoNetmaskException instance() {
      return (AddressNoNetmaskException) instance;
    }

  }

  public static class Builder extends InternalBuilder<AddressNoNetmaskException, Builder> {
    public Builder() {
      super(new AddressNoNetmaskException());
    }
    public Builder(AddressNoNetmaskException instance) {
      super(instance);
    }
  }

  public Builder buildAddressNoNetmaskException() {
  ...
  public static Field getField(String target_fieldname) {
    ...
    try {
      foundField = AddressNoNetmaskException.class.getDeclaredField(target_fieldname);
