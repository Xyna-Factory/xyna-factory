...
public class IllegalNetmaskLengthException extends ValidationException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  private IllegalNetmaskLengthException() {
    super(new String[] {"XYNA-BASE-00006", null});
  }


  public IllegalNetmaskLengthException(String parameter1) {
    super(new String[]{"XYNA-BASE-00006", parameter1 + ""});
    setParameter1(parameter1);
  }

  public IllegalNetmaskLengthException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00006", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected IllegalNetmaskLengthException(String[] args) {
    super(args);
  }

  protected IllegalNetmaskLengthException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public IllegalNetmaskLengthException initCause(Throwable t) {
    return (IllegalNetmaskLengthException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "IllegalNetmaskLengthException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(IllegalNetmaskLengthException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public IllegalNetmaskLengthException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public IllegalNetmaskLengthException cloneWithoutCause(boolean deep) {
    IllegalNetmaskLengthException cloned = new IllegalNetmaskLengthException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends IllegalNetmaskLengthException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends ValidationException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(IllegalNetmaskLengthException instance) {
      super(instance);
    }

    public IllegalNetmaskLengthException instance() {
      return (IllegalNetmaskLengthException) instance;
    }

  }

  public static class Builder extends InternalBuilder<IllegalNetmaskLengthException, Builder> {
    public Builder() {
      super(new IllegalNetmaskLengthException());
    }
    public Builder(IllegalNetmaskLengthException instance) {
      super(instance);
    }
  }

  public Builder buildIllegalNetmaskLengthException() {
  ...
  public static Field getField(String target_fieldname) {
    ...
    try {
      foundField = IllegalNetmaskLengthException.class.getDeclaredField(target_fieldname);
