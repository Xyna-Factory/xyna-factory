...
public class IPv4ValidationException extends ValidationException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  private IPv4ValidationException() {
    super(new String[] {"XYNA-BASE-00008", null});
  }


  public IPv4ValidationException(String parameter1) {
    super(new String[]{"XYNA-BASE-00008", parameter1 + ""});
    setParameter1(parameter1);
  }

  public IPv4ValidationException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00008", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected IPv4ValidationException(String[] args) {
    super(args);
  }

  protected IPv4ValidationException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public IPv4ValidationException initCause(Throwable t) {
    return (IPv4ValidationException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "IPv4ValidationException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(IPv4ValidationException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public IPv4ValidationException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public IPv4ValidationException cloneWithoutCause(boolean deep) {
    IPv4ValidationException cloned = new IPv4ValidationException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends IPv4ValidationException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends ValidationException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(IPv4ValidationException instance) {
      super(instance);
    }

    public IPv4ValidationException instance() {
      return (IPv4ValidationException) instance;
    }

  }

  public static class Builder extends InternalBuilder<IPv4ValidationException, Builder> {
    public Builder() {
      super(new IPv4ValidationException());
    }
    public Builder(IPv4ValidationException instance) {
      super(instance);
    }
  }

  public Builder buildIPv4ValidationException() {
  ...
  public static Field getField(String target_fieldname) {
    ...
    try {
      foundField = IPv4ValidationException.class.getDeclaredField(target_fieldname);
