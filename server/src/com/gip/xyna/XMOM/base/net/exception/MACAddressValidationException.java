...
public class MACAddressValidationException extends ValidationException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  
  private MACAddressValidationException() {
    super(new String[] {"XYNA-BASE-00011", null});
  }


  public MACAddressValidationException(String parameter1) {
    super(new String[]{"XYNA-BASE-00011", parameter1 + ""});
    setParameter1(parameter1);
  }

  public MACAddressValidationException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00011", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected MACAddressValidationException(String[] args) {
    super(args);
  }

  protected MACAddressValidationException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public MACAddressValidationException initCause(Throwable t) {
    return (MACAddressValidationException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "MACAddressValidationException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(MACAddressValidationException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public MACAddressValidationException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public MACAddressValidationException cloneWithoutCause(boolean deep) {
    MACAddressValidationException cloned = new MACAddressValidationException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends MACAddressValidationException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends ValidationException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(MACAddressValidationException instance) {
      super(instance);
    }

    public MACAddressValidationException instance() {
      return (MACAddressValidationException) instance;
    }

  }

  public static class Builder extends InternalBuilder<MACAddressValidationException, Builder> {
    public Builder() {
      super(new MACAddressValidationException());
    }
    public Builder(MACAddressValidationException instance) {
      super(instance);
    }
  }

  public Builder buildMACAddressValidationException() {
  ...
  public static Field getField(String target_fieldname) {
    ...
    try {
      foundField = MACAddressValidationException.class.getDeclaredField(target_fieldname);
