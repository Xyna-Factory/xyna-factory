...
public class IPv6FormatException extends FormatException implements GeneralXynaObject {

  private static final long serialVersionUID = -1L;

  private IPv6FormatException() {
    super(new String[] {"XYNA-BASE-00009", null});
  }


  public IPv6FormatException(String parameter1) {
    super(new String[]{"XYNA-BASE-00009", parameter1 + ""});
    setParameter1(parameter1);
  }

  public IPv6FormatException(String parameter1, Throwable cause) {
    super(new String[]{"XYNA-BASE-00009", parameter1 + ""}, cause);
    setParameter1(parameter1);
  }

  protected IPv6FormatException(String[] args) {
    super(args);
  }

  protected IPv6FormatException(String[] args, Throwable cause) {
    super(args, cause);
  }

  public IPv6FormatException initCause(Throwable t) {
    return (IPv6FormatException) super.initCause(t);
  }
  ...
  public String toXml(String varName, boolean onlyContent, long version, com.gip.xyna.xdev.xfractmod.xmdm.GeneralXynaObject.XMLReferenceCache cache) {
    ...
    com.gip.xyna.xdev.xfractmod.xmdm.XynaObject.XMLHelper.beginExceptionType(xml, varName, "IPv6FormatException", "base.net.exception", objectId, refId);
    if (objectId != -2) {
  ...
  protected void fillVars(IPv6FormatException source, boolean deep) {
    super.fillVars(source, deep);
  }

  public IPv6FormatException cloneWithoutCause() {
    return cloneWithoutCause(true);
  }

  public IPv6FormatException cloneWithoutCause(boolean deep) {
    IPv6FormatException cloned = new IPv6FormatException();
  ...
  protected static class InternalBuilder<_GEN_DOM_TYPE extends IPv6FormatException, _GEN_BUILDER_TYPE extends InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>> extends FormatException.InternalBuilder<_GEN_DOM_TYPE, _GEN_BUILDER_TYPE>  {

    protected InternalBuilder(IPv6FormatException instance) {
      super(instance);
    }

    public IPv6FormatException instance() {
      return (IPv6FormatException) instance;
    }

  }

  public static class Builder extends InternalBuilder<IPv6FormatException, Builder> {
    public Builder() {
      super(new IPv6FormatException());
    }
    public Builder(IPv6FormatException instance) {
      super(instance);
    }
  }

  public Builder buildIPv6FormatException() {
