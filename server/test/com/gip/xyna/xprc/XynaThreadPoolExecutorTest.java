...
public class XynaThreadPoolExecutorTest extends TestCase {
  ...
  public void testReject_Rejectable() throws InterruptedException {
    ...
    assertEquals( 1, rehi_run.rejectedCnt.get() );  //... da RejectableRunnable sich um reject k�mmern muss
    assertEquals( 3, execCnt.get() );
    assertEquals( r1, rehi_run.rejectedList.get(0) ); //erstes (�ltestes) Runnable wird verworfen
