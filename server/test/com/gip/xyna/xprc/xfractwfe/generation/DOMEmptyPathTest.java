...
public class DOMEmptyPathTest extends DOMTestTemplate {
  ...
  protected ArrayList<String> getXmlString() {
    ...
    xmlStrings.add(
    "<DataType Label=\"" + testType + "\" TypeName=\"" + testType + "\" TypePath=\"" + testPath + "\" Version=\"1.5\" xmlns=\"http://www.gip.com/xyna/xdev/xfractmod\">\n"
      ...
      + "      </SourceCode>\n"
      + "      <Throws><Exception ReferenceName=\"XynaException\" ReferencePath=\"core.exceptions\"/></Throws>"
      + "    </Operation>\n"
      + "  </Service>\n"
    + "</DataType>\n");
    return xmlStrings;
