...
public class CompilationTest extends TestCase {
  ...
  public void testPartialCompileError() throws XPRC_CompileError, InterruptedException {
    ...
    s.setClassDir("mydir1");
    /*
     * compilereihenfolge richtet sich scheinbar danach, in welcher reihenfolge man die argumente an den compiler �bergibt.
     * bei test4 bricht er ab, deshalb wird 6 und 7 nicht mehr kompiliert.
     * 
     * so einfach ist es nicht. es kommt auf die art von compilefehler an. bei schlimmeren fehlern wird schon fr�her abgebrochen und dann gar nichts kompiliert.
     */
