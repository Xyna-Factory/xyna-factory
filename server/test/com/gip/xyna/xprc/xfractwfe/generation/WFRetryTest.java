...
public class WFRetryTest extends AGenerationTestTemplate<WF> {

  private String testTypeWorkflow = "testTypeWorkflowRetry";
  private String testPath = "testPath";

  private String testType1 = "TestTypeR13";
  private String testType2 = "testTypeR23";
  private String testType = "testTypeR3";
  ...
  public void checkGeneration(WF wf) throws XynaException, IOException {
   ...
   if (!generated.contains("protected void onDeployment() throws XynaException {")) {
    ...
    // test for retry
    if(!generated.contains("public void executeInternally() throws RetryException, XPRC_RetryLimitExpired {")) {
      fail("missing 'throws RetryException, XPRC_RetryLimitExpired' in executeInternally()");
    }
    ...
    if(!generated.contains("executions = getParentScope().retryParameter.getValue();")) {
      fail("missing statement to get retryParameter.getValue()");
    }
  }
