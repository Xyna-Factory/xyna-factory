...
public class RestrictionBasedTimeWindowTest extends TestCase {
  ...
  private static final String RESTRICTION_4 = "[Second=0;Minute=0;Hour=12;Day=20W][Hour=3]"; // am Wochentag welcher dem 20. am n�hesten is
  ...
  public void testRestriction1() {
    ...
    // letzte Schlie�ung + 1 Woche - Dauer = nextOpen
  ...
  public void testBehaviourOfSmallIncrementsInSavedTime() {
    final String LOCAL_RESTRICTION_1 = "[Minute=30;Hour=:3][Hour=1]"; // um halb alle 3 Stunden f�r eine Stunde
    ...
    final String LOCAL_RESTRICTION_2 = "[Minute=55:30][Minute=5]"; // alle 30min f�r 5min
  ...
  public void testLargeIncrements() {
    final String LOCAL_RESTRICTION_1 = "[Minute=:90][Hour=1]"; // alle 90min f�r eine Stunde
    final String LOCAL_RESTRICTION_2 = "[Second=:300][Minute=1]"; // alle 5min f�r eine Minute
    final String LOCAL_RESTRICTION_3 = "[Second=:3660][Minute=1]"; // alle 61 Minute f�r eine Minute
  ...
  public void testCompositeIncrementsIncludingLarge() {
    final String LOCAL_RESTRICTION_1 = "[Second=:300;Minute=:3][Second=15]"; // alle 300sec=5min und 3min f�r 15sec ==> alle 15min
    ...
    final String LOCAL_RESTRICTION_2 = "[Second=:600;Minute=1-9][Second=15]"; // alle 600sec=10min bei Minute 1 bis 9 ==> st�ndlich bei Minute 1-9 (je nach StartZeitpunkt)
    ...
    final String LOCAL_RESTRICTION_3 = "[Millis=123;Second=:6000;Minute=:10][Second=20]"; // alle 100 min (eigentliche Minuten-Periode ist ein Bruchteil der Sekunden-Einschr�nkung) f�r 20 sec
    ...
    final String LOCAL_RESTRICTION_5 = "[Minute=:240;Day=15W][Hour=3]"; // Alle Stunden an dem Wochentag welcher dem 15 am n�hsten ist
  ...
  public void testWindowsFromCronConversion() {
    ...
    params.add(new CronConversionParameter(1000 * 60 * 60, EUROPE_BERLIN, false)); // St�ndlich
    params.add(new CronConversionParameter(1000 * 60 * 90, EUROPE_BERLIN, false)); // alle 90 min
    params.add(new CronConversionParameter(1000 * 60 * 60 * 24, EUROPE_BERLIN, false)); // t�glich
    params.add(new CronConversionParameter(1000 * 60 * 60 * 24, EUROPE_BERLIN, true)); // t�glich
    params.add(new CronConversionParameter(1000 * 60 * 60 * 24 * 7, EUROPE_BERLIN, false)); // w�chentlich
    params.add(new CronConversionParameter(1000 * 60 * 60 * 24 * 7, EUROPE_BERLIN, true)); // w�chentlich
