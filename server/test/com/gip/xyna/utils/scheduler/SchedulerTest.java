 ...
 * 
 * 
 * TODO noch Testf�lle aus com.gip.xyna.xprc.xsched.SchedulerAlgorithmUsingUrgencyAndDemandTest
 *                     und com.gip.xyna.xprc.xsched.SchedulerAlgorithmTestBase
 *      �bernehmen?
 * TODO com.gip.xyna.xprc.xsched.ParallelSchedulingTest f�r CapacityDemand-Tests 
 *      sind hier nicht m�glich
 * alle drei Tests sind gel�scht, da sie nach Scheduler-Umstellung schwierig zu reparieren sind.
 *
 *
 * TODO weitere Testf�lle?
 */
public class SchedulerTest extends TestCase {
        ...
        new TryScheduleTest() {
          ...
          public ScheduleResult trySchedule(Urgency<TestOrder> uo) {
            switch( (int)(uo.getOrderId() %3) ) {
              case 0: //Cap A ist dauerhaft nicht verf�gbar
                return new ScheduleResult.TagScheduleResult("A", true);
              case 1: //Cap B ist erst nach dem 2 ScheulerLauf wieder verf�gbar
  ...
  public void testBreakLoop() {
    ...
    assertEquals("0_0_6", tsi.getWaiting_Tags_Null_Unknown() ); //6 Auftr�ge sind nicht untersucht worden
  ...
  public void testSchedulingOrderUsingUrgency() {
    ...
    assertEquals("0_0_0", tsi.getWaiting_Tags_Null_Unknown() ); //6 Auftr�ge sind nicht untersucht worden
