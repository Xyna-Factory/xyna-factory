...
/**
 * Allgemeing�ltiger Context f�r eine Session
 * f�r die Basis-Klassen.
 */
public class OBContext implements OBContextInterface {
  ...
  /**
   * Der Session-Identifier ist eine eindeutige ID f�r die angemeldete Session. 
  ...
  /**
   * Setzen der Session-Identifier (eindeutige ID f�r die angemeldete Session.) 
