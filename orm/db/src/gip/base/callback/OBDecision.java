...
abstract public class OBDecision extends Object implements java.io.Serializable {
  ...
  /**
   * Liefert true oder false als Entscheidung zur�ck
  ...
  /**
   * Liefert die Entscheidung als String zur�ck, 
   * n�tzlich bei mehreren Wahlm�glichkeiten.
   * @return Entscheidung
   */
  ...
  /**
   * Liefert nur eine Warnung, die i.d.R. best�tigt werden muss,
   * die abgeleiteten Klassen m�ssen damit entsprechen umgehen. 
   */
   ...
   * die Default-Answer zur�ckgeliefert.
   * @return Wert
   */
   ...
   * Desweiteren wird das Objekt zur�ckgesetzt.
  ...
  /**
   * Setzt eine Menge von Entscheidungsm�glichkeiten.
  ...
  /**
   * Setzt die prim�re DefaultAnswer die von 
  ...
  /**
   * Liefert die m�glichen Entscheidungen.
