...
f_import_application () {
  ...
  # tail -1 gibt nur die h�chste Versionsnummer zurück, weil die Ausgabe von listapplications bereits sortiert ist. Migration von älteren Applications muss manuell erfolgen
