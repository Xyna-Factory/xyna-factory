...
public class TypeInfo {
  ...
  public void addMemberDontChangePosition(TypeInfoMember member) {
    members.add( member );
  }
  
  public void addMemberAndIncrementPosition(TypeInfoMember member) {
