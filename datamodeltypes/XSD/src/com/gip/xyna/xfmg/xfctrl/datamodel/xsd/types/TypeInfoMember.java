...
/**
 * TypeInfoMember sammelt Informationen �ber die Membervariablen eines Datentyps.
 */
public class TypeInfoMember {
  ...
  //Basisdaten, nicht f�r equals und hashCode
  ...
  public static class TypeInfoMemberBuilder {
    ...
    private static class SimpleTypes {
      ...
      public SimpleTypes() {
        ...
        add(XSConstants.INTEGER_DT, PrimitiveType.INT, PrimitiveType.INTEGER);  //FIXME keine L�ngenbeschr�nkung!
        ...
        add(XSConstants.FLOAT_DT, PrimitiveType.DOUBLE, PrimitiveType.DOUBLE_OBJ);//TODO Float von Factory nicht unterst�tzt
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((complexType == null) ? 0 : complexType.getName().hashCode()); //hier f�r rekursive typeInfos keine Endlosschleife!
