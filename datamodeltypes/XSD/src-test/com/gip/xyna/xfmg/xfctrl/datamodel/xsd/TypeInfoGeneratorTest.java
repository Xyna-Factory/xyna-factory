...
public class TypeInfoGeneratorTest extends TestCase {
  ...
  public static GenerationParameter fillImportParameter(List<String> list, String ... additional ) throws StringParameterParsingException {
    ...
    return ImportParameter.parameterForImport("XSD",map);
  }
  ...
  public void testXmomPath_OmitHost_UseNsPath() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    ...
    assertEquals("TypeInfo(Simple,http://www.gip.com/path/to/ns,sTest,root)\n"+
                 "         TypeInfoMember(sTest,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testXmomPath_Prefix() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    ...
    assertEquals("TypeInfo(Simple,http://www.gip.com/path/to/ns,prefixTestSuffix,root)\n"+
                 "         TypeInfoMember(prefixTestSuffix,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testXmomPath_Reserved() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    ...
    assertEquals("TypeInfo(Simple,http://www.gip.com/path/to/ns,interfaceTestSuffix,root)\n"+
                 "         TypeInfoMember(interfaceTestSuffix,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testXmomPath_InvalidChar() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    ...
    GenerationParameter impParams = fillImportParameter(importParameterList, "pathCustomization=/meinPfad/#nsrevhost/#nspath");
    TypeGeneration tg = new TypeGeneration(impParams);
    tg.parseXSDs(xsds);
    tg.generateTypes();
    
    assertEquals("TypeInfo(Simple,http://www.gip.com/pa_th/$to-#_ns_v01.01,ele,root)\n"+
                 "         TypeInfoMember(ele,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
    assertEquals("meinPfad.com.gip.www.pa_th._to_ns_v01.01.Ele\n"+
                 "         ele String\n",
        xmomTypesToString(tg)
        );
  }
  
  public void testEmbeddedSimple() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD( 
     "<xsd:element name=\"sTest\" type=\"xsd:string\" />"       
        );
  ...
  public void testSimple() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD( 
     "<xsd:simpleType name=\"STest_Type\">",
     "  <xsd:restriction base=\"xsd:string\">",
     "    <xsd:minLength value=\"5\"/>",
     "  </xsd:restriction>",
     "</xsd:simpleType>",             
     "<xsd:element name=\"sTest\" type=\"STest_Type\" />"       
        );
  ...
  public void testUnusedComplex() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    List<String> xsds = buildXSD(
     "<xsd:complexType name=\"CTest_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"entry\" type=\"xsd:string\"/>",
     "  </xsd:sequence>",
     "  </xsd:complexType>",
     "<xsd:complexType name=\"UTest_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"entry\" type=\"xsd:string\"/>",
     "  </xsd:sequence>",
     "  </xsd:complexType>",
    ...
    GenerationParameter impParams = fillImportParameter(importParameterList, "generationOptions=includeHiddenTypes=true");
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,CTest_Type,root)\n"+
                 "         TypeInfoMember(entry,Element,type=java_String)\n"+
                 "TypeInfo(Complex,http://www.gip.com,UTest_Type)\n"+
                     "         TypeInfoMember(entry,Element,type=java_String)\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.CTest_Type\n"+
                 "         entry String\n"+
                 "basePath.www.gip.com.UTest_Type\n"+
                     "         entry String\n",
        xmomTypesToString(tg)
        );
  ...
  public void testAnonymousDuplicate() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
     "<xsd:element name=\"aTest\">",
     "  <xsd:complexType>",
     "    <xsd:sequence>",
    ...
    assertEquals("TypeInfo(Anonymous,http://www.gip.com,aTest,root)\n"+
                 "         TypeInfoMember(entry,Element,type=java_String)\n"+
                 "TypeInfo(Anonymous,http://www.gip.com,baTest,root)\n"+
                 "         TypeInfoMember(aTest,Element,type=TypeInfo(Anonymous,http://www.gip.com,aTest,root))\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.ATest\n"+
                 "         entry String\n"+
                 "basePath.www.gip.com.BaTest\n"+
                 "         aTest basePath.www.gip.com.ATest\n",
        xmomTypesToString(tg)
        );
  }
  
  public void testAnonymousNoDuplicate() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
     "<xsd:element name=\"aTest\">",
     "  <xsd:complexType>",
     "    <xsd:sequence>",
     ...
     "        <xsd:complexType>",
     "          <xsd:sequence>",
     "            <xsd:element name=\"entryNo\" type=\"xsd:string\"/>",
     "          </xsd:sequence>",
     "        </xsd:complexType>",
     "      </xsd:element>",
     "    </xsd:sequence>",
    ...
    assertEquals("TypeInfo(Anonymous,http://www.gip.com,aTest,root)\n"+
                 "         TypeInfoMember(entry,Element,type=java_String)\n"+
                 "TypeInfo(Anonymous,http://www.gip.com,aTest)\n"+
                 "         TypeInfoMember(entryNo,Element,type=java_String)\n"+
                 "TypeInfo(Anonymous,http://www.gip.com,baTest,root)\n"+
                 "         TypeInfoMember(aTest,Element,type=TypeInfo(Anonymous,http://www.gip.com,aTest))\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.ATest\n"+
                 "         entry String\n"+
                 "basePath.www.gip.com.ATest1\n"+
                 "         entryNo String\n"+
                 "basePath.www.gip.com.BaTest\n"+
                 "         aTest basePath.www.gip.com.ATest1\n",
        xmomTypesToString(tg)
        );
  }
  
  public void testAnonymousNamed() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
     "<xsd:element name=\"aTest\">",
     "  <xsd:complexType>",
     "    <xsd:sequence>",
  ...
  public void testSimpleUnion() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
      "<xsd:simpleType name=\"Union_Type\">",
      "  <xsd:union memberTypes=\"ut1 ut2\" />",
      "</xsd:simpleType>",
      "<xsd:simpleType name=\"ut1\">",
      "  <xsd:restriction base=\"xsd:integer\">",
      "    <xsd:minInclusive value=\"10\" />",
      "    <xsd:maxInclusive value=\"19\" />",
      "  </xsd:restriction>",
      "</xsd:simpleType>",
      "<xsd:simpleType name=\"ut2\">",
      "  <xsd:restriction base=\"xsd:integer\">",
      "    <xsd:minInclusive value=\"50\" />",
      "    <xsd:maxInclusive value=\"69\" />",
      "  </xsd:restriction>",
      "</xsd:simpleType>",
      "<xsd:element name=\"uTest\" type=\"Union_Type\" />"
        );
    ...
    assertEquals("TypeInfo(Simple,http://www.gip.com,uTest,root)\n"+
                 "         TypeInfoMember(uTest,Text,type=java_int)\n",
        xsdTypesToString(tg)
        );

    assertEquals("basePath.www.gip.com.UTest\n"+
                 "         uTest int\n",
        xmomTypesToString(tg)
        );
  ...
  public void testChoice() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
      "<xsd:complexType name=\"CTest_Type\">",
      "  <xsd:choice>",
      "    <xsd:element name=\"eString\" type=\"xsd:string\"/>",
      "    <xsd:element name=\"eNumber\" type=\"xsd:integer\"/>",
      "  </xsd:choice>",
      "</xsd:complexType>",                          
      "<xsd:element name=\"cTest\" type=\"CTest_Type\" />" 
        );
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,CTest_Type,root)\n"+
                 "         TypeInfoMember(eString,optional Element,type=java_String)\n"+
                 "         TypeInfoMember(eNumber,optional Element,type=java_Integer)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testChoiceUnbounded() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD(
      "<xsd:complexType name=\"CTest_Type\">",
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,CTest_Type,root)\n"+
                 "         TypeInfoMember(eString,optional List,type=java_String)\n"+ //FIXME
                 "         TypeInfoMember(eNumber,optional List,type=java_Integer)\n",
        xsdTypesToString(tg)
        );
    
    assertEquals("basePath.www.gip.com.CTest_Type\n"+
                 "         eString List<String>\n"+
                 "         eNumber List<Integer>\n",
        xmomTypesToString(tg)
        );
  ...
  public void testSimpleType() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    List<String> xsds = buildXSD( 
     "<xsd:simpleType name=\"STest_Type\">",
     "  <xsd:restriction base=\"xsd:string\">",
     "    <xsd:minLength value=\"5\"/>",
     ...
     "<xsd:complexType name=\"CTest_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"entry\" type=\"STest_Type\"/>",
     "    <xsd:element name=\"entry2\" type=\"xsd:string\"/>",
     "  </xsd:sequence>",          
     "  </xsd:complexType>",                          
     "<xsd:element name=\"cTest\" type=\"CTest_Type\" />",      
    ...
    assertEquals("basePath.www.gip.com.CTest_Type\n"+
                 "         entry String\n"+
                 "         entry2 String\n"+
                 "basePath.www.gip.com.STest\n"+
                 "         sTest String\n",
        xmomTypesToString(tg)
        );
   
    GenerationParameter impParams = fillImportParameter(importParameterList, "generationOptions=namedSimpleTypes=true");
    tg = new TypeGeneration(impParams);
    tg.parseXSDs(xsds);
    tg.generateTypes();
   
    assertEquals("TypeInfo(Complex,http://www.gip.com,CTest_Type,root)\n"+
                 "         TypeInfoMember(entry,Element,type=TypeInfo(Simple,http://www.gip.com,STest_Type,root))\n"+
                 "         TypeInfoMember(entry2,Element,type=java_String)\n"+
                 "TypeInfo(Simple,http://www.gip.com,STest_Type,root)\n"+
                 "         TypeInfoMember(STest_Type,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.CTest_Type\n"+
                 "         entry basePath.www.gip.com.STest_Type\n"+
                 "         entry2 String\n"+
                 "basePath.www.gip.com.STest_Type\n"+
                 "         sTest_Type 'STest_Type' String\n",
        xmomTypesToString(tg)
        );
  }
  ...
  public void testDuplicateVar() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,DTest_Type,root)\n"+
                 "         TypeInfoMember(entry,Element,type=java_String)\n"+
                 "         TypeInfoMember(entry,Element,type=java_int)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testMoreDuplicates() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,Basic_Typ,root)\n"+
                 ...
                 "         TypeInfoMember(innen,Element,type=java_String)\n"+
                 "TypeInfo(Anonymous,http://www.gip.com,entry)\n"+
                 "         TypeInfoMember(innen,Element,type=java_int)\n",
  ...
  public void testMinMaxOccurs() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException { //FIXME
    List<String> xsds = buildXSD(
     ...
     "    <xsd:element name=\"llo\" type=\"List_Type\" minOccurs=\"0\" maxOccurs=\"unbounded\"/>",
     "  </xsd:sequence>",
     "</xsd:complexType>",
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,MMOTest_Type,root)\n"+
                 ...
                 "         TypeInfoMember(llo,optional List,type=TypeInfo(Complex,http://www.gip.com,List_Type))\n"+
                 "TypeInfo(Complex,http://www.gip.com,List_Type)\n"+
                 "         TypeInfoMember(em,Element,type=java_String)\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.MMOTest_Type\n"+
                 ...
                 "         lm4 List<String>\n"+
                 "         lo List<String>\n"+
                 "         llo List<basePath.www.gip.com.List_Type>\n"+
                 "basePath.www.gip.com.List_Type\n"+
                 "         em String\n",
    ...
    assertEquals("basePath.www.gip.com.MMOTest_Type\n"+
                 ...
                 "         llo 'llo (optional)' List<basePath.www.gip.com.List_Type>\n"+
                 "basePath.www.gip.com.List_Type\n"+
                 "         em String\n",
        xmomTypesToString(tg)
        );
  ...
  public void testSequenceParticle() throws FileNotFoundException, XSDParsingException, WSDLParsingException { //FIXME
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,SPTest_Type,root)\n"+
                 "         TypeInfoMember(entry,List,type=java_String)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testAnyType() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,AnyTest_Type,root)\n"+
                 ...
                 "         TypeInfoMember(any,Any,type=TypeInfo(Any,null,XSDAnyType,root))\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.AnyTest_Type\n"+
                 "         value String\n"+
                 "         any xfmg.xfctrl.datamodel.xsd.XSDAnyType\n",

        xmomTypesToString(tg)
        );
  }
  
  public void testAnyTypeDuplicate() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD( 
     "<xsd:complexType name=\"AnyTestA_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"valueA\" type=\"xsd:string\"/>",
     "    <xsd:element name=\"value2\" type=\"xsd:anyType\"/>",
     "  </xsd:sequence>",
     "</xsd:complexType>",
     "<xsd:complexType name=\"AnyTestB_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"valueB\" type=\"xsd:string\"/>",
     "    <xsd:element name=\"value2\" type=\"xsd:anyType\"/>",
     "  </xsd:sequence>",
     "</xsd:complexType>",
     "<xsd:element name=\"anyTestA\" type=\"AnyTestA_Type\" />",
     "<xsd:element name=\"anyTestB\" type=\"AnyTestB_Type\" />"
        );
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,AnyTestA_Type,root)\n"+
                 "         TypeInfoMember(valueA,Element,type=java_String)\n"+
                 "         TypeInfoMember(value2,Any,type=TypeInfo(Any,null,XSDAnyType))\n"+
                  "TypeInfo(Complex,http://www.gip.com,AnyTestB_Type,root)\n"+
                 "         TypeInfoMember(valueB,Element,type=java_String)\n"+
                 "         TypeInfoMember(value2,Any,type=TypeInfo(Any,null,XSDAnyType))\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.AnyTestA_Type\n"+
                 "         valueA String\n"+
                 "         value2 xfmg.xfctrl.datamodel.xsd.XSDAnyType\n"+
                 "basePath.www.gip.com.AnyTestB_Type\n"+
                 "         valueB String\n"+
                 "         value2 xfmg.xfctrl.datamodel.xsd.XSDAnyType\n",
        xmomTypesToString(tg)
        );
  ...
  public void testAnyType2() throws FileNotFoundException, XSDParsingException, WSDLParsingException {
    List<String> xsds = buildXSD( 
     "<xsd:complexType name=\"AnyTest_Type\">",
     "  <xsd:sequence>",
     "    <xsd:element name=\"valueA\" type=\"xsd:string\"/>",
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,valueB,root)\n"+
                 "         TypeInfoMember(el,Element,type=java_String)\n"+
                 "TypeInfo(Complex,http://www.gip.com,AnyTest_Type,root)\n"+
                 "         TypeInfoMember(valueA,Element,type=java_String)\n"+
                 "         TypeInfoMember(valueB,Any,type=TypeInfo(Any,null,XSDAnyType))\n",
        xsdTypesToString(tg)
        );
    assertEquals("basePath.www.gip.com.ValueB\n"+
                 "         el String\n"+
                 "basePath.www.gip.com.AnyTest_Type\n"+
                 "         valueA String\n"+
                 "         valueB xfmg.xfctrl.datamodel.xsd.XSDAnyType\n",
  ...
  public void testGlobalLocal_Qualified() throws FileNotFoundException, XSDParsingException, WSDLParsingException, XFMG_NoSuchRevision {
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,GLTest_Type,root)\n"+
                 ...
                 "         TypeInfoMember(global,Text,type=java_String)\n",
        xsdTypesToString(tg)
        );
  ...
  public void testChoiceWithCommonBase() throws FileNotFoundException, XSDParsingException, WSDLParsingException, StringParameterParsingException {
    ...
    assertEquals("TypeInfo(Complex,http://www.gip.com,Choice_Type,root)\n"+
                 ...
                 "         TypeInfoMember(d1val,Element,type=java_int)\n"+
    ...
    GenerationParameter impParams = fillImportParameter(importParameterList, "generationOptions=expandChoice=true");
    tg = new TypeGeneration(impParams);
    tg.parseXSDs(xsds);
    tg.generateTypes();
    assertEquals("TypeInfo(Complex,http://www.gip.com,Choice_Type,root)\n"+
                 "         TypeInfoMember(derived1,optional Element,type=TypeInfo(Complex,http://www.gip.com,Derived1_Type,base=TypeInfo(Complex,http://www.gip.com,Base_Type)))\n"+
                 "         TypeInfoMember(derived2,optional Element,type=TypeInfo(Complex,http://www.gip.com,Derived2_Type,base=TypeInfo(Complex,http://www.gip.com,Base_Type)))\n"+
                 "TypeInfo(Complex,http://www.gip.com,Derived1_Type,base=TypeInfo(Complex,http://www.gip.com,Base_Type))\n"+
                 "         TypeInfoMember(d1val,Element,type=java_int)\n"+
                 "TypeInfo(Complex,http://www.gip.com,Base_Type)\n"+
                 "         TypeInfoMember(value,Element,type=java_String)\n"+
  ...
  /**
   * TODO kann aufgrund der Beschr�nkungen von TypeMappingEntryHelper keine vergleichbaren Daten liefern
   * @param typeInfos
   */
  ...
  public static List<String> buildXSD(String ... rows) {
  ...
  public static List<String> buildXSDs(XSDGenerator ... xsds) {
    List<String> xsdFiles = new ArrayList<String>();
  ...
  public static List<String> buildXSDWithNamespace(String namespace, String ... rows) {
  ...
  private List<String> buildXSDWithNamespace(Pair<String,String> namespace, String ... rows) {
    XSDGenerator xsd = new XSDGenerator("TypeInfoGeneratorTest.xsd").namespace(namespace.getFirst(), namespace.getSecond()).rows(rows);
    List<String> xsdFiles = new ArrayList<String>();
    try {
      xsdFiles.add( xsd.save() );
    } catch( IOException e ) {
