...
public interface ClusterProviderMangementRMI extends ClusterManagementRMI {

  /**
   * remote persistencebuffer state
   * @return in millisekunden
   */
  public PersistenceProcessingState persistenceFinished() throws RemoteException;
